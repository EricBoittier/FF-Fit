...
def plot_energy_MSE(
    ...
    try:
        ...
        slope, intercept, r_value, p_value, std_err = np.nan, np.nan, 0, 0, 0
    ...
    # color points by MSE
    sc = ax.scatter(df[key1], df[key2], c=df[elec],
                    cmap=CMAP, alpha=0.5, s=1)
...
def plot_ff_fit(ff_pairs, ff_fit, ecol="ECOL_PC",
                EB=("sd", 3), suptitle=None):
    """
    ...
    for i in iis:
        ...
        titles = {'a)': "Pairs(model): $E_{PP}(r)$, $E_{ELEC}(r)$",
