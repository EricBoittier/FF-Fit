#!/bin/bash
#SBATCH --job-name=my_job_0.00001_4.0_8_2
#SBATCH --partition=long
#SBATCH --time=01:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=4G
#SBATCH --output=logs/methanol_perm_output_0.00001_4.0_8_2.log
#SBATCH --error=errors/methanol_perm_error_0.00001_4.0_8_2.log
