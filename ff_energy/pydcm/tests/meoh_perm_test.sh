...
alphas=(0.0 0.01 0.001 0.0001 0.00001 0.00001)
#alphas=(2.0 10.0 100.0)
l2s=(0.0 0.1 0.5 1.0 2.0 4.0)
n_factors=(6 8 10 12)
repeats=4
json="methanol_perm.json"
fname="methanol_perm"
    ...
    do
        ...
        do
            ...
            do
                ...
                output_log="logs/${fname}_output_${alpha}_${l2}_${n}_${repeat}.log"

                error_log="errors/${fname}_error_${alpha}_${l2}_${n}_${repeat}.log"
