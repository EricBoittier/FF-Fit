...
#SBATCH --job-name=g_water_b3lyp_pdz_57
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_57_water_b3lyp_pdz.com
export OUTFILE=gaussian_57_water_b3lyp_pdz.out
export CHKFILE=gaussian_57_water_b3lyp_pdz.chk
export FCKFILE=gaussian_57_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_57_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_57_water_b3lyp_pdz_esp.cube
