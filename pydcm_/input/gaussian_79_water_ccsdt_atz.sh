...
#SBATCH --job-name=g_water_ccsdt_atz_79
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_79_water_ccsdt_atz.com
export OUTFILE=gaussian_79_water_ccsdt_atz.out
export CHKFILE=gaussian_79_water_ccsdt_atz.chk
export FCKFILE=gaussian_79_water_ccsdt_atz.fchk
export DNSFILE=gaussian_79_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_79_water_ccsdt_atz_esp.cube
