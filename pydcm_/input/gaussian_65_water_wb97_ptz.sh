...
#SBATCH --job-name=g_water_wb97_ptz_65
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_65_water_wb97_ptz.com
export OUTFILE=gaussian_65_water_wb97_ptz.out
export CHKFILE=gaussian_65_water_wb97_ptz.chk
export FCKFILE=gaussian_65_water_wb97_ptz.fchk
export DNSFILE=gaussian_65_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_65_water_wb97_ptz_esp.cube
