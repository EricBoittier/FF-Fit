...
#SBATCH --job-name=g_water_hf_adz2_36
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_36_water_hf_adz2.com
export OUTFILE=gaussian_36_water_hf_adz2.out
export CHKFILE=gaussian_36_water_hf_adz2.chk
export FCKFILE=gaussian_36_water_hf_adz2.fchk
export DNSFILE=gaussian_36_water_hf_adz2_dens.cube
export ESPFILE=gaussian_36_water_hf_adz2_esp.cube
