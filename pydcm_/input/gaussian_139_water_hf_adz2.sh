...
#SBATCH --job-name=g_water_hf_adz2_139
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_139_water_hf_adz2.com
export OUTFILE=gaussian_139_water_hf_adz2.out
export CHKFILE=gaussian_139_water_hf_adz2.chk
export FCKFILE=gaussian_139_water_hf_adz2.fchk
export DNSFILE=gaussian_139_water_hf_adz2_dens.cube
export ESPFILE=gaussian_139_water_hf_adz2_esp.cube
