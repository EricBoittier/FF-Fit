...
#SBATCH --job-name=g_water_ccsdt_adz_151
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_151_water_ccsdt_adz.com
export OUTFILE=gaussian_151_water_ccsdt_adz.out
export CHKFILE=gaussian_151_water_ccsdt_adz.chk
export FCKFILE=gaussian_151_water_ccsdt_adz.fchk
export DNSFILE=gaussian_151_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_151_water_ccsdt_adz_esp.cube
