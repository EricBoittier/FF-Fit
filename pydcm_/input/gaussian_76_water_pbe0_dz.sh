...
#SBATCH --job-name=g_water_pbe0_dz_76
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_76_water_pbe0_dz.com
export OUTFILE=gaussian_76_water_pbe0_dz.out
export CHKFILE=gaussian_76_water_pbe0_dz.chk
export FCKFILE=gaussian_76_water_pbe0_dz.fchk
export DNSFILE=gaussian_76_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_76_water_pbe0_dz_esp.cube
