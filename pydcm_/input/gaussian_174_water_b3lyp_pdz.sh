...
#SBATCH --job-name=g_water_b3lyp_pdz_174
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_174_water_b3lyp_pdz.com
export OUTFILE=gaussian_174_water_b3lyp_pdz.out
export CHKFILE=gaussian_174_water_b3lyp_pdz.chk
export FCKFILE=gaussian_174_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_174_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_174_water_b3lyp_pdz_esp.cube
