...
#SBATCH --job-name=g_water_hf_pdz_68
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_68_water_hf_pdz.com
export OUTFILE=gaussian_68_water_hf_pdz.out
export CHKFILE=gaussian_68_water_hf_pdz.chk
export FCKFILE=gaussian_68_water_hf_pdz.fchk
export DNSFILE=gaussian_68_water_hf_pdz_dens.cube
export ESPFILE=gaussian_68_water_hf_pdz_esp.cube
