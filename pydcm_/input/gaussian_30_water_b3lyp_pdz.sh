...
#SBATCH --job-name=g_water_b3lyp_pdz_30
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_30_water_b3lyp_pdz.com
export OUTFILE=gaussian_30_water_b3lyp_pdz.out
export CHKFILE=gaussian_30_water_b3lyp_pdz.chk
export FCKFILE=gaussian_30_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_30_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_30_water_b3lyp_pdz_esp.cube
