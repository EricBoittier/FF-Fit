...
#SBATCH --job-name=g_water_pbe0_dz_117
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_117_water_pbe0_dz.com
export OUTFILE=gaussian_117_water_pbe0_dz.out
export CHKFILE=gaussian_117_water_pbe0_dz.chk
export FCKFILE=gaussian_117_water_pbe0_dz.fchk
export DNSFILE=gaussian_117_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_117_water_pbe0_dz_esp.cube
