...
#SBATCH --job-name=g_water_wb97_ptz_130
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_130_water_wb97_ptz.com
export OUTFILE=gaussian_130_water_wb97_ptz.out
export CHKFILE=gaussian_130_water_wb97_ptz.chk
export FCKFILE=gaussian_130_water_wb97_ptz.fchk
export DNSFILE=gaussian_130_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_130_water_wb97_ptz_esp.cube
