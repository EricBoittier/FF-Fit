...
#SBATCH --job-name=g_water_ccsdt_adz_35
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_35_water_ccsdt_adz.com
export OUTFILE=gaussian_35_water_ccsdt_adz.out
export CHKFILE=gaussian_35_water_ccsdt_adz.chk
export FCKFILE=gaussian_35_water_ccsdt_adz.fchk
export DNSFILE=gaussian_35_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_35_water_ccsdt_adz_esp.cube
