...
#SBATCH --job-name=g_water_hf_adz_98
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_98_water_hf_adz.com
export OUTFILE=gaussian_98_water_hf_adz.out
export CHKFILE=gaussian_98_water_hf_adz.chk
export FCKFILE=gaussian_98_water_hf_adz.fchk
export DNSFILE=gaussian_98_water_hf_adz_dens.cube
export ESPFILE=gaussian_98_water_hf_adz_esp.cube
