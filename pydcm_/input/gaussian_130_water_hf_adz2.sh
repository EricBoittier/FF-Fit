...
#SBATCH --job-name=g_water_hf_adz2_130
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_130_water_hf_adz2.com
export OUTFILE=gaussian_130_water_hf_adz2.out
export CHKFILE=gaussian_130_water_hf_adz2.chk
export FCKFILE=gaussian_130_water_hf_adz2.fchk
export DNSFILE=gaussian_130_water_hf_adz2_dens.cube
export ESPFILE=gaussian_130_water_hf_adz2_esp.cube
