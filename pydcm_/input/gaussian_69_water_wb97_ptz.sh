...
#SBATCH --job-name=g_water_wb97_ptz_69
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_69_water_wb97_ptz.com
export OUTFILE=gaussian_69_water_wb97_ptz.out
export CHKFILE=gaussian_69_water_wb97_ptz.chk
export FCKFILE=gaussian_69_water_wb97_ptz.fchk
export DNSFILE=gaussian_69_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_69_water_wb97_ptz_esp.cube
