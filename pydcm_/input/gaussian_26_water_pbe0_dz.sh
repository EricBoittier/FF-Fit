...
#SBATCH --job-name=g_water_pbe0_dz_26
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_26_water_pbe0_dz.com
export OUTFILE=gaussian_26_water_pbe0_dz.out
export CHKFILE=gaussian_26_water_pbe0_dz.chk
export FCKFILE=gaussian_26_water_pbe0_dz.fchk
export DNSFILE=gaussian_26_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_26_water_pbe0_dz_esp.cube
