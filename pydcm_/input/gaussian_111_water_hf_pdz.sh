...
#SBATCH --job-name=g_water_hf_pdz_111
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_111_water_hf_pdz.com
export OUTFILE=gaussian_111_water_hf_pdz.out
export CHKFILE=gaussian_111_water_hf_pdz.chk
export FCKFILE=gaussian_111_water_hf_pdz.fchk
export DNSFILE=gaussian_111_water_hf_pdz_dens.cube
export ESPFILE=gaussian_111_water_hf_pdz_esp.cube
