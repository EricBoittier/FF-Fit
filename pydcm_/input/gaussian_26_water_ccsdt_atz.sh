...
#SBATCH --job-name=g_water_ccsdt_atz_26
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_26_water_ccsdt_atz.com
export OUTFILE=gaussian_26_water_ccsdt_atz.out
export CHKFILE=gaussian_26_water_ccsdt_atz.chk
export FCKFILE=gaussian_26_water_ccsdt_atz.fchk
export DNSFILE=gaussian_26_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_26_water_ccsdt_atz_esp.cube
