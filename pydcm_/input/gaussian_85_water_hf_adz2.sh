...
#SBATCH --job-name=g_water_hf_adz2_85
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_85_water_hf_adz2.com
export OUTFILE=gaussian_85_water_hf_adz2.out
export CHKFILE=gaussian_85_water_hf_adz2.chk
export FCKFILE=gaussian_85_water_hf_adz2.fchk
export DNSFILE=gaussian_85_water_hf_adz2_dens.cube
export ESPFILE=gaussian_85_water_hf_adz2_esp.cube
