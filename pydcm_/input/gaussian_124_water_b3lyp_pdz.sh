...
#SBATCH --job-name=g_water_b3lyp_pdz_124
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_124_water_b3lyp_pdz.com
export OUTFILE=gaussian_124_water_b3lyp_pdz.out
export CHKFILE=gaussian_124_water_b3lyp_pdz.chk
export FCKFILE=gaussian_124_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_124_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_124_water_b3lyp_pdz_esp.cube
