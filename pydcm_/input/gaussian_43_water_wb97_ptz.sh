...
#SBATCH --job-name=g_water_wb97_ptz_43
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_43_water_wb97_ptz.com
export OUTFILE=gaussian_43_water_wb97_ptz.out
export CHKFILE=gaussian_43_water_wb97_ptz.chk
export FCKFILE=gaussian_43_water_wb97_ptz.fchk
export DNSFILE=gaussian_43_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_43_water_wb97_ptz_esp.cube
