...
#SBATCH --job-name=g_water_pbe0_dz_34
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_34_water_pbe0_dz.com
export OUTFILE=gaussian_34_water_pbe0_dz.out
export CHKFILE=gaussian_34_water_pbe0_dz.chk
export FCKFILE=gaussian_34_water_pbe0_dz.fchk
export DNSFILE=gaussian_34_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_34_water_pbe0_dz_esp.cube
