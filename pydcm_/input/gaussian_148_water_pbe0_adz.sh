...
#SBATCH --job-name=g_water_pbe0_adz_148
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_148_water_pbe0_adz.com
export OUTFILE=gaussian_148_water_pbe0_adz.out
export CHKFILE=gaussian_148_water_pbe0_adz.chk
export FCKFILE=gaussian_148_water_pbe0_adz.fchk
export DNSFILE=gaussian_148_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_148_water_pbe0_adz_esp.cube
