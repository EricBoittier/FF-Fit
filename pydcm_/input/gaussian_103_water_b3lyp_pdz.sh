...
#SBATCH --job-name=g_water_b3lyp_pdz_103
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_103_water_b3lyp_pdz.com
export OUTFILE=gaussian_103_water_b3lyp_pdz.out
export CHKFILE=gaussian_103_water_b3lyp_pdz.chk
export FCKFILE=gaussian_103_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_103_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_103_water_b3lyp_pdz_esp.cube
