...
#SBATCH --job-name=g_water_pbe0_dz_158
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_158_water_pbe0_dz.com
export OUTFILE=gaussian_158_water_pbe0_dz.out
export CHKFILE=gaussian_158_water_pbe0_dz.chk
export FCKFILE=gaussian_158_water_pbe0_dz.fchk
export DNSFILE=gaussian_158_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_158_water_pbe0_dz_esp.cube
