...
#SBATCH --job-name=g_water_hf_pdz_90
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_90_water_hf_pdz.com
export OUTFILE=gaussian_90_water_hf_pdz.out
export CHKFILE=gaussian_90_water_hf_pdz.chk
export FCKFILE=gaussian_90_water_hf_pdz.fchk
export DNSFILE=gaussian_90_water_hf_pdz_dens.cube
export ESPFILE=gaussian_90_water_hf_pdz_esp.cube
