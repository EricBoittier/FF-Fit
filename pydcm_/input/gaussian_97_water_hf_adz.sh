...
#SBATCH --job-name=g_water_hf_adz_97
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_97_water_hf_adz.com
export OUTFILE=gaussian_97_water_hf_adz.out
export CHKFILE=gaussian_97_water_hf_adz.chk
export FCKFILE=gaussian_97_water_hf_adz.fchk
export DNSFILE=gaussian_97_water_hf_adz_dens.cube
export ESPFILE=gaussian_97_water_hf_adz_esp.cube
