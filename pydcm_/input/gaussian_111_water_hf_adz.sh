...
#SBATCH --job-name=g_water_hf_adz_111
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_111_water_hf_adz.com
export OUTFILE=gaussian_111_water_hf_adz.out
export CHKFILE=gaussian_111_water_hf_adz.chk
export FCKFILE=gaussian_111_water_hf_adz.fchk
export DNSFILE=gaussian_111_water_hf_adz_dens.cube
export ESPFILE=gaussian_111_water_hf_adz_esp.cube
