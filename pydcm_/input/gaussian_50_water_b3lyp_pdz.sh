...
#SBATCH --job-name=g_water_b3lyp_pdz_50
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_50_water_b3lyp_pdz.com
export OUTFILE=gaussian_50_water_b3lyp_pdz.out
export CHKFILE=gaussian_50_water_b3lyp_pdz.chk
export FCKFILE=gaussian_50_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_50_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_50_water_b3lyp_pdz_esp.cube
