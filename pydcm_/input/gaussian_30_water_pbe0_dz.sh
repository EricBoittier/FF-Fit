...
#SBATCH --job-name=g_water_pbe0_dz_30
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_30_water_pbe0_dz.com
export OUTFILE=gaussian_30_water_pbe0_dz.out
export CHKFILE=gaussian_30_water_pbe0_dz.chk
export FCKFILE=gaussian_30_water_pbe0_dz.fchk
export DNSFILE=gaussian_30_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_30_water_pbe0_dz_esp.cube
