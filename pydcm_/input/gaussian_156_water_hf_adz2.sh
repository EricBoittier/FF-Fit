...
#SBATCH --job-name=g_water_hf_adz2_156
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_156_water_hf_adz2.com
export OUTFILE=gaussian_156_water_hf_adz2.out
export CHKFILE=gaussian_156_water_hf_adz2.chk
export FCKFILE=gaussian_156_water_hf_adz2.fchk
export DNSFILE=gaussian_156_water_hf_adz2_dens.cube
export ESPFILE=gaussian_156_water_hf_adz2_esp.cube
