...
#SBATCH --job-name=g_water_b3lyp_pdz_111
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_111_water_b3lyp_pdz.com
export OUTFILE=gaussian_111_water_b3lyp_pdz.out
export CHKFILE=gaussian_111_water_b3lyp_pdz.chk
export FCKFILE=gaussian_111_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_111_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_111_water_b3lyp_pdz_esp.cube
