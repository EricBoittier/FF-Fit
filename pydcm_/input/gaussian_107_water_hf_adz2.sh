...
#SBATCH --job-name=g_water_hf_adz2_107
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_107_water_hf_adz2.com
export OUTFILE=gaussian_107_water_hf_adz2.out
export CHKFILE=gaussian_107_water_hf_adz2.chk
export FCKFILE=gaussian_107_water_hf_adz2.fchk
export DNSFILE=gaussian_107_water_hf_adz2_dens.cube
export ESPFILE=gaussian_107_water_hf_adz2_esp.cube
