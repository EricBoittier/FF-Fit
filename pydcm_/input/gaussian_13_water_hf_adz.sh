...
#SBATCH --job-name=g_water_hf_adz_13
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_13_water_hf_adz.com
export OUTFILE=gaussian_13_water_hf_adz.out
export CHKFILE=gaussian_13_water_hf_adz.chk
export FCKFILE=gaussian_13_water_hf_adz.fchk
export DNSFILE=gaussian_13_water_hf_adz_dens.cube
export ESPFILE=gaussian_13_water_hf_adz_esp.cube
