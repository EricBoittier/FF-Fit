...
#SBATCH --job-name=g_water_pbe0_adz_43
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_43_water_pbe0_adz.com
export OUTFILE=gaussian_43_water_pbe0_adz.out
export CHKFILE=gaussian_43_water_pbe0_adz.chk
export FCKFILE=gaussian_43_water_pbe0_adz.fchk
export DNSFILE=gaussian_43_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_43_water_pbe0_adz_esp.cube
