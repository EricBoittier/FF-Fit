...
#SBATCH --job-name=g_water_pbe0_dz_33
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_33_water_pbe0_dz.com
export OUTFILE=gaussian_33_water_pbe0_dz.out
export CHKFILE=gaussian_33_water_pbe0_dz.chk
export FCKFILE=gaussian_33_water_pbe0_dz.fchk
export DNSFILE=gaussian_33_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_33_water_pbe0_dz_esp.cube
