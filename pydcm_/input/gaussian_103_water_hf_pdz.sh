...
#SBATCH --job-name=g_water_hf_pdz_103
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_103_water_hf_pdz.com
export OUTFILE=gaussian_103_water_hf_pdz.out
export CHKFILE=gaussian_103_water_hf_pdz.chk
export FCKFILE=gaussian_103_water_hf_pdz.fchk
export DNSFILE=gaussian_103_water_hf_pdz_dens.cube
export ESPFILE=gaussian_103_water_hf_pdz_esp.cube
