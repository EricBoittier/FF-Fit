...
#SBATCH --job-name=g_water_wb97_ptz_174
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_174_water_wb97_ptz.com
export OUTFILE=gaussian_174_water_wb97_ptz.out
export CHKFILE=gaussian_174_water_wb97_ptz.chk
export FCKFILE=gaussian_174_water_wb97_ptz.fchk
export DNSFILE=gaussian_174_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_174_water_wb97_ptz_esp.cube
