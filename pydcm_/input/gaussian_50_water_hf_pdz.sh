...
#SBATCH --job-name=g_water_hf_pdz_50
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_50_water_hf_pdz.com
export OUTFILE=gaussian_50_water_hf_pdz.out
export CHKFILE=gaussian_50_water_hf_pdz.chk
export FCKFILE=gaussian_50_water_hf_pdz.fchk
export DNSFILE=gaussian_50_water_hf_pdz_dens.cube
export ESPFILE=gaussian_50_water_hf_pdz_esp.cube
