...
#SBATCH --job-name=g_water_hf_adz_26
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_26_water_hf_adz.com
export OUTFILE=gaussian_26_water_hf_adz.out
export CHKFILE=gaussian_26_water_hf_adz.chk
export FCKFILE=gaussian_26_water_hf_adz.fchk
export DNSFILE=gaussian_26_water_hf_adz_dens.cube
export ESPFILE=gaussian_26_water_hf_adz_esp.cube
