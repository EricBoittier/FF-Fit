...
#SBATCH --job-name=g_water_ccsdt_atz_30
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_30_water_ccsdt_atz.com
export OUTFILE=gaussian_30_water_ccsdt_atz.out
export CHKFILE=gaussian_30_water_ccsdt_atz.chk
export FCKFILE=gaussian_30_water_ccsdt_atz.fchk
export DNSFILE=gaussian_30_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_30_water_ccsdt_atz_esp.cube
