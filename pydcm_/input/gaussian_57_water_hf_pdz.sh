...
#SBATCH --job-name=g_water_hf_pdz_57
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_57_water_hf_pdz.com
export OUTFILE=gaussian_57_water_hf_pdz.out
export CHKFILE=gaussian_57_water_hf_pdz.chk
export FCKFILE=gaussian_57_water_hf_pdz.fchk
export DNSFILE=gaussian_57_water_hf_pdz_dens.cube
export ESPFILE=gaussian_57_water_hf_pdz_esp.cube
