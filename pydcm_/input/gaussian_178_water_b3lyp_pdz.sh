...
#SBATCH --job-name=g_water_b3lyp_pdz_178
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_178_water_b3lyp_pdz.com
export OUTFILE=gaussian_178_water_b3lyp_pdz.out
export CHKFILE=gaussian_178_water_b3lyp_pdz.chk
export FCKFILE=gaussian_178_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_178_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_178_water_b3lyp_pdz_esp.cube
