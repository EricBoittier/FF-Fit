...
#SBATCH --job-name=g_water_pbe0_adz_16
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_16_water_pbe0_adz.com
export OUTFILE=gaussian_16_water_pbe0_adz.out
export CHKFILE=gaussian_16_water_pbe0_adz.chk
export FCKFILE=gaussian_16_water_pbe0_adz.fchk
export DNSFILE=gaussian_16_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_16_water_pbe0_adz_esp.cube
