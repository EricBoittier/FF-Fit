...
#SBATCH --job-name=g_water_hf_adz2_178
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_178_water_hf_adz2.com
export OUTFILE=gaussian_178_water_hf_adz2.out
export CHKFILE=gaussian_178_water_hf_adz2.chk
export FCKFILE=gaussian_178_water_hf_adz2.fchk
export DNSFILE=gaussian_178_water_hf_adz2_dens.cube
export ESPFILE=gaussian_178_water_hf_adz2_esp.cube
