...
#SBATCH --job-name=g_water_hf_adz_25
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_25_water_hf_adz.com
export OUTFILE=gaussian_25_water_hf_adz.out
export CHKFILE=gaussian_25_water_hf_adz.chk
export FCKFILE=gaussian_25_water_hf_adz.fchk
export DNSFILE=gaussian_25_water_hf_adz_dens.cube
export ESPFILE=gaussian_25_water_hf_adz_esp.cube
