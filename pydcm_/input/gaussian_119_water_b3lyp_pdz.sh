...
#SBATCH --job-name=g_water_b3lyp_pdz_119
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_119_water_b3lyp_pdz.com
export OUTFILE=gaussian_119_water_b3lyp_pdz.out
export CHKFILE=gaussian_119_water_b3lyp_pdz.chk
export FCKFILE=gaussian_119_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_119_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_119_water_b3lyp_pdz_esp.cube
