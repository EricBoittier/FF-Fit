...
#SBATCH --job-name=g_water_pbe0_dz_40
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_40_water_pbe0_dz.com
export OUTFILE=gaussian_40_water_pbe0_dz.out
export CHKFILE=gaussian_40_water_pbe0_dz.chk
export FCKFILE=gaussian_40_water_pbe0_dz.fchk
export DNSFILE=gaussian_40_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_40_water_pbe0_dz_esp.cube
