...
#SBATCH --job-name=g_water_ccsdt_atz_55
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_55_water_ccsdt_atz.com
export OUTFILE=gaussian_55_water_ccsdt_atz.out
export CHKFILE=gaussian_55_water_ccsdt_atz.chk
export FCKFILE=gaussian_55_water_ccsdt_atz.fchk
export DNSFILE=gaussian_55_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_55_water_ccsdt_atz_esp.cube
