...
#SBATCH --job-name=g_water_b3lyp_pdz_113
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_113_water_b3lyp_pdz.com
export OUTFILE=gaussian_113_water_b3lyp_pdz.out
export CHKFILE=gaussian_113_water_b3lyp_pdz.chk
export FCKFILE=gaussian_113_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_113_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_113_water_b3lyp_pdz_esp.cube
