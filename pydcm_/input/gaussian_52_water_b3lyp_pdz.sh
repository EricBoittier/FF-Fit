...
#SBATCH --job-name=g_water_b3lyp_pdz_52
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_52_water_b3lyp_pdz.com
export OUTFILE=gaussian_52_water_b3lyp_pdz.out
export CHKFILE=gaussian_52_water_b3lyp_pdz.chk
export FCKFILE=gaussian_52_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_52_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_52_water_b3lyp_pdz_esp.cube
