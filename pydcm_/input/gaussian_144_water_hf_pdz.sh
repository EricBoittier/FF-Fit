...
#SBATCH --job-name=g_water_hf_pdz_144
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_144_water_hf_pdz.com
export OUTFILE=gaussian_144_water_hf_pdz.out
export CHKFILE=gaussian_144_water_hf_pdz.chk
export FCKFILE=gaussian_144_water_hf_pdz.fchk
export DNSFILE=gaussian_144_water_hf_pdz_dens.cube
export ESPFILE=gaussian_144_water_hf_pdz_esp.cube
