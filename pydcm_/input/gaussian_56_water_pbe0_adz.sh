...
#SBATCH --job-name=g_water_pbe0_adz_56
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_56_water_pbe0_adz.com
export OUTFILE=gaussian_56_water_pbe0_adz.out
export CHKFILE=gaussian_56_water_pbe0_adz.chk
export FCKFILE=gaussian_56_water_pbe0_adz.fchk
export DNSFILE=gaussian_56_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_56_water_pbe0_adz_esp.cube
