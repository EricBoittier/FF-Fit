...
#SBATCH --job-name=g_water_pbe0_adz_132
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_132_water_pbe0_adz.com
export OUTFILE=gaussian_132_water_pbe0_adz.out
export CHKFILE=gaussian_132_water_pbe0_adz.chk
export FCKFILE=gaussian_132_water_pbe0_adz.fchk
export DNSFILE=gaussian_132_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_132_water_pbe0_adz_esp.cube
