...
#SBATCH --job-name=g_water_hf_adz2_65
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_65_water_hf_adz2.com
export OUTFILE=gaussian_65_water_hf_adz2.out
export CHKFILE=gaussian_65_water_hf_adz2.chk
export FCKFILE=gaussian_65_water_hf_adz2.fchk
export DNSFILE=gaussian_65_water_hf_adz2_dens.cube
export ESPFILE=gaussian_65_water_hf_adz2_esp.cube
