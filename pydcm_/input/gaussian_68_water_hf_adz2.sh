...
#SBATCH --job-name=g_water_hf_adz2_68
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_68_water_hf_adz2.com
export OUTFILE=gaussian_68_water_hf_adz2.out
export CHKFILE=gaussian_68_water_hf_adz2.chk
export FCKFILE=gaussian_68_water_hf_adz2.fchk
export DNSFILE=gaussian_68_water_hf_adz2_dens.cube
export ESPFILE=gaussian_68_water_hf_adz2_esp.cube
