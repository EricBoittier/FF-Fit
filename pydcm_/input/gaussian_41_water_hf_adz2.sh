...
#SBATCH --job-name=g_water_hf_adz2_41
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_41_water_hf_adz2.com
export OUTFILE=gaussian_41_water_hf_adz2.out
export CHKFILE=gaussian_41_water_hf_adz2.chk
export FCKFILE=gaussian_41_water_hf_adz2.fchk
export DNSFILE=gaussian_41_water_hf_adz2_dens.cube
export ESPFILE=gaussian_41_water_hf_adz2_esp.cube
