...
#SBATCH --job-name=g_water_pbe0_dz_77
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_77_water_pbe0_dz.com
export OUTFILE=gaussian_77_water_pbe0_dz.out
export CHKFILE=gaussian_77_water_pbe0_dz.chk
export FCKFILE=gaussian_77_water_pbe0_dz.fchk
export DNSFILE=gaussian_77_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_77_water_pbe0_dz_esp.cube
