...
#SBATCH --job-name=g_water_ccsdt_adz_173
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_173_water_ccsdt_adz.com
export OUTFILE=gaussian_173_water_ccsdt_adz.out
export CHKFILE=gaussian_173_water_ccsdt_adz.chk
export FCKFILE=gaussian_173_water_ccsdt_adz.fchk
export DNSFILE=gaussian_173_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_173_water_ccsdt_adz_esp.cube
