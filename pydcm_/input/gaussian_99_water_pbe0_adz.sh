...
#SBATCH --job-name=g_water_pbe0_adz_99
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_99_water_pbe0_adz.com
export OUTFILE=gaussian_99_water_pbe0_adz.out
export CHKFILE=gaussian_99_water_pbe0_adz.chk
export FCKFILE=gaussian_99_water_pbe0_adz.fchk
export DNSFILE=gaussian_99_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_99_water_pbe0_adz_esp.cube
