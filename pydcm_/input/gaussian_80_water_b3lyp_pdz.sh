...
#SBATCH --job-name=g_water_b3lyp_pdz_80
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_80_water_b3lyp_pdz.com
export OUTFILE=gaussian_80_water_b3lyp_pdz.out
export CHKFILE=gaussian_80_water_b3lyp_pdz.chk
export FCKFILE=gaussian_80_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_80_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_80_water_b3lyp_pdz_esp.cube
