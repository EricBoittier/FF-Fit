...
#SBATCH --job-name=g_water_wb97_ptz_109
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_109_water_wb97_ptz.com
export OUTFILE=gaussian_109_water_wb97_ptz.out
export CHKFILE=gaussian_109_water_wb97_ptz.chk
export FCKFILE=gaussian_109_water_wb97_ptz.fchk
export DNSFILE=gaussian_109_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_109_water_wb97_ptz_esp.cube
