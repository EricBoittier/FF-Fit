...
#SBATCH --job-name=g_water_pbe0_dz_126
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_126_water_pbe0_dz.com
export OUTFILE=gaussian_126_water_pbe0_dz.out
export CHKFILE=gaussian_126_water_pbe0_dz.chk
export FCKFILE=gaussian_126_water_pbe0_dz.fchk
export DNSFILE=gaussian_126_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_126_water_pbe0_dz_esp.cube
