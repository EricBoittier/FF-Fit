...
#SBATCH --job-name=g_water_b3lyp_pdz_46
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_46_water_b3lyp_pdz.com
export OUTFILE=gaussian_46_water_b3lyp_pdz.out
export CHKFILE=gaussian_46_water_b3lyp_pdz.chk
export FCKFILE=gaussian_46_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_46_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_46_water_b3lyp_pdz_esp.cube
