...
#SBATCH --job-name=g_water_wb97_ptz_165
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_165_water_wb97_ptz.com
export OUTFILE=gaussian_165_water_wb97_ptz.out
export CHKFILE=gaussian_165_water_wb97_ptz.chk
export FCKFILE=gaussian_165_water_wb97_ptz.fchk
export DNSFILE=gaussian_165_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_165_water_wb97_ptz_esp.cube
