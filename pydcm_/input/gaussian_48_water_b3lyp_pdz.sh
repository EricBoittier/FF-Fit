...
#SBATCH --job-name=g_water_b3lyp_pdz_48
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_48_water_b3lyp_pdz.com
export OUTFILE=gaussian_48_water_b3lyp_pdz.out
export CHKFILE=gaussian_48_water_b3lyp_pdz.chk
export FCKFILE=gaussian_48_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_48_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_48_water_b3lyp_pdz_esp.cube
