...
#SBATCH --job-name=g_water_pbe0_adz_32
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_32_water_pbe0_adz.com
export OUTFILE=gaussian_32_water_pbe0_adz.out
export CHKFILE=gaussian_32_water_pbe0_adz.chk
export FCKFILE=gaussian_32_water_pbe0_adz.fchk
export DNSFILE=gaussian_32_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_32_water_pbe0_adz_esp.cube
