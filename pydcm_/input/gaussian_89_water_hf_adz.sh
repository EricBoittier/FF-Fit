...
#SBATCH --job-name=g_water_hf_adz_89
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_89_water_hf_adz.com
export OUTFILE=gaussian_89_water_hf_adz.out
export CHKFILE=gaussian_89_water_hf_adz.chk
export FCKFILE=gaussian_89_water_hf_adz.fchk
export DNSFILE=gaussian_89_water_hf_adz_dens.cube
export ESPFILE=gaussian_89_water_hf_adz_esp.cube
