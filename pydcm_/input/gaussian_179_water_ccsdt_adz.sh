...
#SBATCH --job-name=g_water_ccsdt_adz_179
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_179_water_ccsdt_adz.com
export OUTFILE=gaussian_179_water_ccsdt_adz.out
export CHKFILE=gaussian_179_water_ccsdt_adz.chk
export FCKFILE=gaussian_179_water_ccsdt_adz.fchk
export DNSFILE=gaussian_179_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_179_water_ccsdt_adz_esp.cube
