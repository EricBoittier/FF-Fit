...
#SBATCH --job-name=g_water_wb97_ptz_169
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_169_water_wb97_ptz.com
export OUTFILE=gaussian_169_water_wb97_ptz.out
export CHKFILE=gaussian_169_water_wb97_ptz.chk
export FCKFILE=gaussian_169_water_wb97_ptz.fchk
export DNSFILE=gaussian_169_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_169_water_wb97_ptz_esp.cube
