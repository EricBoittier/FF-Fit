...
#SBATCH --job-name=g_water_ccsdt_atz_115
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_115_water_ccsdt_atz.com
export OUTFILE=gaussian_115_water_ccsdt_atz.out
export CHKFILE=gaussian_115_water_ccsdt_atz.chk
export FCKFILE=gaussian_115_water_ccsdt_atz.fchk
export DNSFILE=gaussian_115_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_115_water_ccsdt_atz_esp.cube
