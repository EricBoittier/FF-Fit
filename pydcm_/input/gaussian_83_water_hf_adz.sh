...
#SBATCH --job-name=g_water_hf_adz_83
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_83_water_hf_adz.com
export OUTFILE=gaussian_83_water_hf_adz.out
export CHKFILE=gaussian_83_water_hf_adz.chk
export FCKFILE=gaussian_83_water_hf_adz.fchk
export DNSFILE=gaussian_83_water_hf_adz_dens.cube
export ESPFILE=gaussian_83_water_hf_adz_esp.cube
