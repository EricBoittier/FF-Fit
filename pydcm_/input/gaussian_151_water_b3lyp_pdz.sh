...
#SBATCH --job-name=g_water_b3lyp_pdz_151
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_151_water_b3lyp_pdz.com
export OUTFILE=gaussian_151_water_b3lyp_pdz.out
export CHKFILE=gaussian_151_water_b3lyp_pdz.chk
export FCKFILE=gaussian_151_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_151_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_151_water_b3lyp_pdz_esp.cube
