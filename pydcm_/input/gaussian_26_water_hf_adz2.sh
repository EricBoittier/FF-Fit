...
#SBATCH --job-name=g_water_hf_adz2_26
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_26_water_hf_adz2.com
export OUTFILE=gaussian_26_water_hf_adz2.out
export CHKFILE=gaussian_26_water_hf_adz2.chk
export FCKFILE=gaussian_26_water_hf_adz2.fchk
export DNSFILE=gaussian_26_water_hf_adz2_dens.cube
export ESPFILE=gaussian_26_water_hf_adz2_esp.cube
