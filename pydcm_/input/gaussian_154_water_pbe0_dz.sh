...
#SBATCH --job-name=g_water_pbe0_dz_154
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_154_water_pbe0_dz.com
export OUTFILE=gaussian_154_water_pbe0_dz.out
export CHKFILE=gaussian_154_water_pbe0_dz.chk
export FCKFILE=gaussian_154_water_pbe0_dz.fchk
export DNSFILE=gaussian_154_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_154_water_pbe0_dz_esp.cube
