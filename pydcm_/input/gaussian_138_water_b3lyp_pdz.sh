...
#SBATCH --job-name=g_water_b3lyp_pdz_138
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_138_water_b3lyp_pdz.com
export OUTFILE=gaussian_138_water_b3lyp_pdz.out
export CHKFILE=gaussian_138_water_b3lyp_pdz.chk
export FCKFILE=gaussian_138_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_138_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_138_water_b3lyp_pdz_esp.cube
