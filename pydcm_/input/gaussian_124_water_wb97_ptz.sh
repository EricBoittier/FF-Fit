...
#SBATCH --job-name=g_water_wb97_ptz_124
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_124_water_wb97_ptz.com
export OUTFILE=gaussian_124_water_wb97_ptz.out
export CHKFILE=gaussian_124_water_wb97_ptz.chk
export FCKFILE=gaussian_124_water_wb97_ptz.fchk
export DNSFILE=gaussian_124_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_124_water_wb97_ptz_esp.cube
