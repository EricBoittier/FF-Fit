...
#SBATCH --job-name=g_water_hf_pdz_139
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_139_water_hf_pdz.com
export OUTFILE=gaussian_139_water_hf_pdz.out
export CHKFILE=gaussian_139_water_hf_pdz.chk
export FCKFILE=gaussian_139_water_hf_pdz.fchk
export DNSFILE=gaussian_139_water_hf_pdz_dens.cube
export ESPFILE=gaussian_139_water_hf_pdz_esp.cube
