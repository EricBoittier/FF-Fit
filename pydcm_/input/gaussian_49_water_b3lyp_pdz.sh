...
#SBATCH --job-name=g_water_b3lyp_pdz_49
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_49_water_b3lyp_pdz.com
export OUTFILE=gaussian_49_water_b3lyp_pdz.out
export CHKFILE=gaussian_49_water_b3lyp_pdz.chk
export FCKFILE=gaussian_49_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_49_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_49_water_b3lyp_pdz_esp.cube
