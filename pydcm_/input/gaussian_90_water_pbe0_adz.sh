...
#SBATCH --job-name=g_water_pbe0_adz_90
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_90_water_pbe0_adz.com
export OUTFILE=gaussian_90_water_pbe0_adz.out
export CHKFILE=gaussian_90_water_pbe0_adz.chk
export FCKFILE=gaussian_90_water_pbe0_adz.fchk
export DNSFILE=gaussian_90_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_90_water_pbe0_adz_esp.cube
