...
#SBATCH --job-name=g_water_wb97_ptz_88
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_88_water_wb97_ptz.com
export OUTFILE=gaussian_88_water_wb97_ptz.out
export CHKFILE=gaussian_88_water_wb97_ptz.chk
export FCKFILE=gaussian_88_water_wb97_ptz.fchk
export DNSFILE=gaussian_88_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_88_water_wb97_ptz_esp.cube
