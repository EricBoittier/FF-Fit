...
#SBATCH --job-name=g_water_pbe0_dz_24
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_24_water_pbe0_dz.com
export OUTFILE=gaussian_24_water_pbe0_dz.out
export CHKFILE=gaussian_24_water_pbe0_dz.chk
export FCKFILE=gaussian_24_water_pbe0_dz.fchk
export DNSFILE=gaussian_24_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_24_water_pbe0_dz_esp.cube
