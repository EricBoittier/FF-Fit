...
#SBATCH --job-name=g_water_ccsdt_atz_112
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_112_water_ccsdt_atz.com
export OUTFILE=gaussian_112_water_ccsdt_atz.out
export CHKFILE=gaussian_112_water_ccsdt_atz.chk
export FCKFILE=gaussian_112_water_ccsdt_atz.fchk
export DNSFILE=gaussian_112_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_112_water_ccsdt_atz_esp.cube
