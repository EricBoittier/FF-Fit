...
#SBATCH --job-name=g_water_ccsdt_adz_147
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_147_water_ccsdt_adz.com
export OUTFILE=gaussian_147_water_ccsdt_adz.out
export CHKFILE=gaussian_147_water_ccsdt_adz.chk
export FCKFILE=gaussian_147_water_ccsdt_adz.fchk
export DNSFILE=gaussian_147_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_147_water_ccsdt_adz_esp.cube
