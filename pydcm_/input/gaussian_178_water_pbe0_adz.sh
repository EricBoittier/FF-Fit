...
#SBATCH --job-name=g_water_pbe0_adz_178
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_178_water_pbe0_adz.com
export OUTFILE=gaussian_178_water_pbe0_adz.out
export CHKFILE=gaussian_178_water_pbe0_adz.chk
export FCKFILE=gaussian_178_water_pbe0_adz.fchk
export DNSFILE=gaussian_178_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_178_water_pbe0_adz_esp.cube
