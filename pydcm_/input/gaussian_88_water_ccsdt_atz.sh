...
#SBATCH --job-name=g_water_ccsdt_atz_88
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_88_water_ccsdt_atz.com
export OUTFILE=gaussian_88_water_ccsdt_atz.out
export CHKFILE=gaussian_88_water_ccsdt_atz.chk
export FCKFILE=gaussian_88_water_ccsdt_atz.fchk
export DNSFILE=gaussian_88_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_88_water_ccsdt_atz_esp.cube
