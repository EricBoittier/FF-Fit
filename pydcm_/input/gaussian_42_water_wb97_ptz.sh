...
#SBATCH --job-name=g_water_wb97_ptz_42
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_42_water_wb97_ptz.com
export OUTFILE=gaussian_42_water_wb97_ptz.out
export CHKFILE=gaussian_42_water_wb97_ptz.chk
export FCKFILE=gaussian_42_water_wb97_ptz.fchk
export DNSFILE=gaussian_42_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_42_water_wb97_ptz_esp.cube
