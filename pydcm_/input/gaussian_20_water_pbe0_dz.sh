...
#SBATCH --job-name=g_water_pbe0_dz_20
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_20_water_pbe0_dz.com
export OUTFILE=gaussian_20_water_pbe0_dz.out
export CHKFILE=gaussian_20_water_pbe0_dz.chk
export FCKFILE=gaussian_20_water_pbe0_dz.fchk
export DNSFILE=gaussian_20_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_20_water_pbe0_dz_esp.cube
