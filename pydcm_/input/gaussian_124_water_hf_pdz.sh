...
#SBATCH --job-name=g_water_hf_pdz_124
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_124_water_hf_pdz.com
export OUTFILE=gaussian_124_water_hf_pdz.out
export CHKFILE=gaussian_124_water_hf_pdz.chk
export FCKFILE=gaussian_124_water_hf_pdz.fchk
export DNSFILE=gaussian_124_water_hf_pdz_dens.cube
export ESPFILE=gaussian_124_water_hf_pdz_esp.cube
