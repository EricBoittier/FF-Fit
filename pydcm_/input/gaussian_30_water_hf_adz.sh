...
#SBATCH --job-name=g_water_hf_adz_30
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_30_water_hf_adz.com
export OUTFILE=gaussian_30_water_hf_adz.out
export CHKFILE=gaussian_30_water_hf_adz.chk
export FCKFILE=gaussian_30_water_hf_adz.fchk
export DNSFILE=gaussian_30_water_hf_adz_dens.cube
export ESPFILE=gaussian_30_water_hf_adz_esp.cube
