...
#SBATCH --job-name=g_water_ccsdt_atz_118
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_118_water_ccsdt_atz.com
export OUTFILE=gaussian_118_water_ccsdt_atz.out
export CHKFILE=gaussian_118_water_ccsdt_atz.chk
export FCKFILE=gaussian_118_water_ccsdt_atz.fchk
export DNSFILE=gaussian_118_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_118_water_ccsdt_atz_esp.cube
