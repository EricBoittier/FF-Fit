...
#SBATCH --job-name=g_water_hf_adz2_0
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_0_water_hf_adz2.com
export OUTFILE=gaussian_0_water_hf_adz2.out
export CHKFILE=gaussian_0_water_hf_adz2.chk
export FCKFILE=gaussian_0_water_hf_adz2.fchk
export DNSFILE=gaussian_0_water_hf_adz2_dens.cube
export ESPFILE=gaussian_0_water_hf_adz2_esp.cube
