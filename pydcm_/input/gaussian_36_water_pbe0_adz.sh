...
#SBATCH --job-name=g_water_pbe0_adz_36
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_36_water_pbe0_adz.com
export OUTFILE=gaussian_36_water_pbe0_adz.out
export CHKFILE=gaussian_36_water_pbe0_adz.chk
export FCKFILE=gaussian_36_water_pbe0_adz.fchk
export DNSFILE=gaussian_36_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_36_water_pbe0_adz_esp.cube
