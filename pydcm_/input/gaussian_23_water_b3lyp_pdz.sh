...
#SBATCH --job-name=g_water_b3lyp_pdz_23
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_23_water_b3lyp_pdz.com
export OUTFILE=gaussian_23_water_b3lyp_pdz.out
export CHKFILE=gaussian_23_water_b3lyp_pdz.chk
export FCKFILE=gaussian_23_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_23_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_23_water_b3lyp_pdz_esp.cube
