...
#SBATCH --job-name=g_water_pbe0_dz_124
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_124_water_pbe0_dz.com
export OUTFILE=gaussian_124_water_pbe0_dz.out
export CHKFILE=gaussian_124_water_pbe0_dz.chk
export FCKFILE=gaussian_124_water_pbe0_dz.fchk
export DNSFILE=gaussian_124_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_124_water_pbe0_dz_esp.cube
