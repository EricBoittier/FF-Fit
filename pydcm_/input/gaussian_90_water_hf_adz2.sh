...
#SBATCH --job-name=g_water_hf_adz2_90
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_90_water_hf_adz2.com
export OUTFILE=gaussian_90_water_hf_adz2.out
export CHKFILE=gaussian_90_water_hf_adz2.chk
export FCKFILE=gaussian_90_water_hf_adz2.fchk
export DNSFILE=gaussian_90_water_hf_adz2_dens.cube
export ESPFILE=gaussian_90_water_hf_adz2_esp.cube
