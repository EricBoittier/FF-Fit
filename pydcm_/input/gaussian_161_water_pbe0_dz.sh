...
#SBATCH --job-name=g_water_pbe0_dz_161
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_161_water_pbe0_dz.com
export OUTFILE=gaussian_161_water_pbe0_dz.out
export CHKFILE=gaussian_161_water_pbe0_dz.chk
export FCKFILE=gaussian_161_water_pbe0_dz.fchk
export DNSFILE=gaussian_161_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_161_water_pbe0_dz_esp.cube
