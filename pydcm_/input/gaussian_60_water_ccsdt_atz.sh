...
#SBATCH --job-name=g_water_ccsdt_atz_60
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_60_water_ccsdt_atz.com
export OUTFILE=gaussian_60_water_ccsdt_atz.out
export CHKFILE=gaussian_60_water_ccsdt_atz.chk
export FCKFILE=gaussian_60_water_ccsdt_atz.fchk
export DNSFILE=gaussian_60_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_60_water_ccsdt_atz_esp.cube
