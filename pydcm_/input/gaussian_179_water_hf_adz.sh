...
#SBATCH --job-name=g_water_hf_adz_179
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_179_water_hf_adz.com
export OUTFILE=gaussian_179_water_hf_adz.out
export CHKFILE=gaussian_179_water_hf_adz.chk
export FCKFILE=gaussian_179_water_hf_adz.fchk
export DNSFILE=gaussian_179_water_hf_adz_dens.cube
export ESPFILE=gaussian_179_water_hf_adz_esp.cube
