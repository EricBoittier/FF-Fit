...
#SBATCH --job-name=g_water_pbe0_adz_71
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_71_water_pbe0_adz.com
export OUTFILE=gaussian_71_water_pbe0_adz.out
export CHKFILE=gaussian_71_water_pbe0_adz.chk
export FCKFILE=gaussian_71_water_pbe0_adz.fchk
export DNSFILE=gaussian_71_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_71_water_pbe0_adz_esp.cube
