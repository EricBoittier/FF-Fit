...
#SBATCH --job-name=g_water_b3lyp_pdz_17
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_17_water_b3lyp_pdz.com
export OUTFILE=gaussian_17_water_b3lyp_pdz.out
export CHKFILE=gaussian_17_water_b3lyp_pdz.chk
export FCKFILE=gaussian_17_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_17_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_17_water_b3lyp_pdz_esp.cube
