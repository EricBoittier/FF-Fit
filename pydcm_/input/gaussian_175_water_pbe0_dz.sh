...
#SBATCH --job-name=g_water_pbe0_dz_175
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_175_water_pbe0_dz.com
export OUTFILE=gaussian_175_water_pbe0_dz.out
export CHKFILE=gaussian_175_water_pbe0_dz.chk
export FCKFILE=gaussian_175_water_pbe0_dz.fchk
export DNSFILE=gaussian_175_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_175_water_pbe0_dz_esp.cube
