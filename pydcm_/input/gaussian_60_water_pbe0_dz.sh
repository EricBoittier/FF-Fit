...
#SBATCH --job-name=g_water_pbe0_dz_60
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_60_water_pbe0_dz.com
export OUTFILE=gaussian_60_water_pbe0_dz.out
export CHKFILE=gaussian_60_water_pbe0_dz.chk
export FCKFILE=gaussian_60_water_pbe0_dz.fchk
export DNSFILE=gaussian_60_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_60_water_pbe0_dz_esp.cube
