...
#SBATCH --job-name=g_water_hf_adz_169
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_169_water_hf_adz.com
export OUTFILE=gaussian_169_water_hf_adz.out
export CHKFILE=gaussian_169_water_hf_adz.chk
export FCKFILE=gaussian_169_water_hf_adz.fchk
export DNSFILE=gaussian_169_water_hf_adz_dens.cube
export ESPFILE=gaussian_169_water_hf_adz_esp.cube
