...
#SBATCH --job-name=g_water_wb97_ptz_120
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_120_water_wb97_ptz.com
export OUTFILE=gaussian_120_water_wb97_ptz.out
export CHKFILE=gaussian_120_water_wb97_ptz.chk
export FCKFILE=gaussian_120_water_wb97_ptz.fchk
export DNSFILE=gaussian_120_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_120_water_wb97_ptz_esp.cube
