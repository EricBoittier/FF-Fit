...
#SBATCH --job-name=g_water_ccsdt_atz_20
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_20_water_ccsdt_atz.com
export OUTFILE=gaussian_20_water_ccsdt_atz.out
export CHKFILE=gaussian_20_water_ccsdt_atz.chk
export FCKFILE=gaussian_20_water_ccsdt_atz.fchk
export DNSFILE=gaussian_20_water_ccsdt_atz_dens.cube
export ESPFILE=gaussian_20_water_ccsdt_atz_esp.cube
