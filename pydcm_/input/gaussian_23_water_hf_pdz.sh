...
#SBATCH --job-name=g_water_hf_pdz_23
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_23_water_hf_pdz.com
export OUTFILE=gaussian_23_water_hf_pdz.out
export CHKFILE=gaussian_23_water_hf_pdz.chk
export FCKFILE=gaussian_23_water_hf_pdz.fchk
export DNSFILE=gaussian_23_water_hf_pdz_dens.cube
export ESPFILE=gaussian_23_water_hf_pdz_esp.cube
