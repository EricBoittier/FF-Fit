...
#SBATCH --job-name=g_water_hf_adz2_124
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_124_water_hf_adz2.com
export OUTFILE=gaussian_124_water_hf_adz2.out
export CHKFILE=gaussian_124_water_hf_adz2.chk
export FCKFILE=gaussian_124_water_hf_adz2.fchk
export DNSFILE=gaussian_124_water_hf_adz2_dens.cube
export ESPFILE=gaussian_124_water_hf_adz2_esp.cube
