...
#SBATCH --job-name=g_water_wb97_ptz_114
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_114_water_wb97_ptz.com
export OUTFILE=gaussian_114_water_wb97_ptz.out
export CHKFILE=gaussian_114_water_wb97_ptz.chk
export FCKFILE=gaussian_114_water_wb97_ptz.fchk
export DNSFILE=gaussian_114_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_114_water_wb97_ptz_esp.cube
