...
#SBATCH --job-name=g_water_pbe0_adz_60
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_60_water_pbe0_adz.com
export OUTFILE=gaussian_60_water_pbe0_adz.out
export CHKFILE=gaussian_60_water_pbe0_adz.chk
export FCKFILE=gaussian_60_water_pbe0_adz.fchk
export DNSFILE=gaussian_60_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_60_water_pbe0_adz_esp.cube
