...
#SBATCH --job-name=g_water_pbe0_dz_28
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_28_water_pbe0_dz.com
export OUTFILE=gaussian_28_water_pbe0_dz.out
export CHKFILE=gaussian_28_water_pbe0_dz.chk
export FCKFILE=gaussian_28_water_pbe0_dz.fchk
export DNSFILE=gaussian_28_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_28_water_pbe0_dz_esp.cube
