...
#SBATCH --job-name=g_water_pbe0_adz_30
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_30_water_pbe0_adz.com
export OUTFILE=gaussian_30_water_pbe0_adz.out
export CHKFILE=gaussian_30_water_pbe0_adz.chk
export FCKFILE=gaussian_30_water_pbe0_adz.fchk
export DNSFILE=gaussian_30_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_30_water_pbe0_adz_esp.cube
