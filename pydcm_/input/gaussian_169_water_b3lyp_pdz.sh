...
#SBATCH --job-name=g_water_b3lyp_pdz_169
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_169_water_b3lyp_pdz.com
export OUTFILE=gaussian_169_water_b3lyp_pdz.out
export CHKFILE=gaussian_169_water_b3lyp_pdz.chk
export FCKFILE=gaussian_169_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_169_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_169_water_b3lyp_pdz_esp.cube
