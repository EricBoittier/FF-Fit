...
#SBATCH --job-name=g_water_hf_adz_144
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_144_water_hf_adz.com
export OUTFILE=gaussian_144_water_hf_adz.out
export CHKFILE=gaussian_144_water_hf_adz.chk
export FCKFILE=gaussian_144_water_hf_adz.fchk
export DNSFILE=gaussian_144_water_hf_adz_dens.cube
export ESPFILE=gaussian_144_water_hf_adz_esp.cube
