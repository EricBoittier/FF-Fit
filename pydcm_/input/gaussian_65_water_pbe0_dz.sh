...
#SBATCH --job-name=g_water_pbe0_dz_65
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_65_water_pbe0_dz.com
export OUTFILE=gaussian_65_water_pbe0_dz.out
export CHKFILE=gaussian_65_water_pbe0_dz.chk
export FCKFILE=gaussian_65_water_pbe0_dz.fchk
export DNSFILE=gaussian_65_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_65_water_pbe0_dz_esp.cube
