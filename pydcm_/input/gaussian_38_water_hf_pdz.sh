...
#SBATCH --job-name=g_water_hf_pdz_38
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_38_water_hf_pdz.com
export OUTFILE=gaussian_38_water_hf_pdz.out
export CHKFILE=gaussian_38_water_hf_pdz.chk
export FCKFILE=gaussian_38_water_hf_pdz.fchk
export DNSFILE=gaussian_38_water_hf_pdz_dens.cube
export ESPFILE=gaussian_38_water_hf_pdz_esp.cube
