...
#SBATCH --job-name=g_water_b3lyp_pdz_94
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_94_water_b3lyp_pdz.com
export OUTFILE=gaussian_94_water_b3lyp_pdz.out
export CHKFILE=gaussian_94_water_b3lyp_pdz.chk
export FCKFILE=gaussian_94_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_94_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_94_water_b3lyp_pdz_esp.cube
