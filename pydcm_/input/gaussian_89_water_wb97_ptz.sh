...
#SBATCH --job-name=g_water_wb97_ptz_89
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_89_water_wb97_ptz.com
export OUTFILE=gaussian_89_water_wb97_ptz.out
export CHKFILE=gaussian_89_water_wb97_ptz.chk
export FCKFILE=gaussian_89_water_wb97_ptz.fchk
export DNSFILE=gaussian_89_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_89_water_wb97_ptz_esp.cube
