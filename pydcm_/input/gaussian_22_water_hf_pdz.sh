...
#SBATCH --job-name=g_water_hf_pdz_22
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_22_water_hf_pdz.com
export OUTFILE=gaussian_22_water_hf_pdz.out
export CHKFILE=gaussian_22_water_hf_pdz.chk
export FCKFILE=gaussian_22_water_hf_pdz.fchk
export DNSFILE=gaussian_22_water_hf_pdz_dens.cube
export ESPFILE=gaussian_22_water_hf_pdz_esp.cube
