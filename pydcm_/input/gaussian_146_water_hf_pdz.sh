...
#SBATCH --job-name=g_water_hf_pdz_146
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_146_water_hf_pdz.com
export OUTFILE=gaussian_146_water_hf_pdz.out
export CHKFILE=gaussian_146_water_hf_pdz.chk
export FCKFILE=gaussian_146_water_hf_pdz.fchk
export DNSFILE=gaussian_146_water_hf_pdz_dens.cube
export ESPFILE=gaussian_146_water_hf_pdz_esp.cube
