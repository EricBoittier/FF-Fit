...
#SBATCH --job-name=g_water_pbe0_dz_41
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_41_water_pbe0_dz.com
export OUTFILE=gaussian_41_water_pbe0_dz.out
export CHKFILE=gaussian_41_water_pbe0_dz.chk
export FCKFILE=gaussian_41_water_pbe0_dz.fchk
export DNSFILE=gaussian_41_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_41_water_pbe0_dz_esp.cube
