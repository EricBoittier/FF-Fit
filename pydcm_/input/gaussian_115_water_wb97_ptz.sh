...
#SBATCH --job-name=g_water_wb97_ptz_115
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_115_water_wb97_ptz.com
export OUTFILE=gaussian_115_water_wb97_ptz.out
export CHKFILE=gaussian_115_water_wb97_ptz.chk
export FCKFILE=gaussian_115_water_wb97_ptz.fchk
export DNSFILE=gaussian_115_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_115_water_wb97_ptz_esp.cube
