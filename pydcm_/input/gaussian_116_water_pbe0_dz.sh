...
#SBATCH --job-name=g_water_pbe0_dz_116
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_116_water_pbe0_dz.com
export OUTFILE=gaussian_116_water_pbe0_dz.out
export CHKFILE=gaussian_116_water_pbe0_dz.chk
export FCKFILE=gaussian_116_water_pbe0_dz.fchk
export DNSFILE=gaussian_116_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_116_water_pbe0_dz_esp.cube
