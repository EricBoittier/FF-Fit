...
#SBATCH --job-name=g_water_hf_pdz_145
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_145_water_hf_pdz.com
export OUTFILE=gaussian_145_water_hf_pdz.out
export CHKFILE=gaussian_145_water_hf_pdz.chk
export FCKFILE=gaussian_145_water_hf_pdz.fchk
export DNSFILE=gaussian_145_water_hf_pdz_dens.cube
export ESPFILE=gaussian_145_water_hf_pdz_esp.cube
