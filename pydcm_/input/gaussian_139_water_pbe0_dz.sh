...
#SBATCH --job-name=g_water_pbe0_dz_139
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_139_water_pbe0_dz.com
export OUTFILE=gaussian_139_water_pbe0_dz.out
export CHKFILE=gaussian_139_water_pbe0_dz.chk
export FCKFILE=gaussian_139_water_pbe0_dz.fchk
export DNSFILE=gaussian_139_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_139_water_pbe0_dz_esp.cube
