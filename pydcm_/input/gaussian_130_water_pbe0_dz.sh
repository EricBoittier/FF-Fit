...
#SBATCH --job-name=g_water_pbe0_dz_130
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_130_water_pbe0_dz.com
export OUTFILE=gaussian_130_water_pbe0_dz.out
export CHKFILE=gaussian_130_water_pbe0_dz.chk
export FCKFILE=gaussian_130_water_pbe0_dz.fchk
export DNSFILE=gaussian_130_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_130_water_pbe0_dz_esp.cube
