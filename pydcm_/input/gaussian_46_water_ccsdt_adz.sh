...
#SBATCH --job-name=g_water_ccsdt_adz_46
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_46_water_ccsdt_adz.com
export OUTFILE=gaussian_46_water_ccsdt_adz.out
export CHKFILE=gaussian_46_water_ccsdt_adz.chk
export FCKFILE=gaussian_46_water_ccsdt_adz.fchk
export DNSFILE=gaussian_46_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_46_water_ccsdt_adz_esp.cube
