...
#SBATCH --job-name=g_water_pbe0_dz_104
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_104_water_pbe0_dz.com
export OUTFILE=gaussian_104_water_pbe0_dz.out
export CHKFILE=gaussian_104_water_pbe0_dz.chk
export FCKFILE=gaussian_104_water_pbe0_dz.fchk
export DNSFILE=gaussian_104_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_104_water_pbe0_dz_esp.cube
