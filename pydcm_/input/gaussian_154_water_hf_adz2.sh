...
#SBATCH --job-name=g_water_hf_adz2_154
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_154_water_hf_adz2.com
export OUTFILE=gaussian_154_water_hf_adz2.out
export CHKFILE=gaussian_154_water_hf_adz2.chk
export FCKFILE=gaussian_154_water_hf_adz2.fchk
export DNSFILE=gaussian_154_water_hf_adz2_dens.cube
export ESPFILE=gaussian_154_water_hf_adz2_esp.cube
