...
#SBATCH --job-name=g_water_hf_adz2_148
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_148_water_hf_adz2.com
export OUTFILE=gaussian_148_water_hf_adz2.out
export CHKFILE=gaussian_148_water_hf_adz2.chk
export FCKFILE=gaussian_148_water_hf_adz2.fchk
export DNSFILE=gaussian_148_water_hf_adz2_dens.cube
export ESPFILE=gaussian_148_water_hf_adz2_esp.cube
