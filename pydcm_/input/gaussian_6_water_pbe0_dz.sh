...
#SBATCH --job-name=g_water_pbe0_dz_6
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_6_water_pbe0_dz.com
export OUTFILE=gaussian_6_water_pbe0_dz.out
export CHKFILE=gaussian_6_water_pbe0_dz.chk
export FCKFILE=gaussian_6_water_pbe0_dz.fchk
export DNSFILE=gaussian_6_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_6_water_pbe0_dz_esp.cube
