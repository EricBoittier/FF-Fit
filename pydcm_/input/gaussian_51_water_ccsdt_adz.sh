...
#SBATCH --job-name=g_water_ccsdt_adz_51
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_51_water_ccsdt_adz.com
export OUTFILE=gaussian_51_water_ccsdt_adz.out
export CHKFILE=gaussian_51_water_ccsdt_adz.chk
export FCKFILE=gaussian_51_water_ccsdt_adz.fchk
export DNSFILE=gaussian_51_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_51_water_ccsdt_adz_esp.cube
