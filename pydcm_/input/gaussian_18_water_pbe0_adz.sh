...
#SBATCH --job-name=g_water_pbe0_adz_18
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_18_water_pbe0_adz.com
export OUTFILE=gaussian_18_water_pbe0_adz.out
export CHKFILE=gaussian_18_water_pbe0_adz.chk
export FCKFILE=gaussian_18_water_pbe0_adz.fchk
export DNSFILE=gaussian_18_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_18_water_pbe0_adz_esp.cube
