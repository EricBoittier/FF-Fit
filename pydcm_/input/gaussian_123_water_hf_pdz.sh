...
#SBATCH --job-name=g_water_hf_pdz_123
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_123_water_hf_pdz.com
export OUTFILE=gaussian_123_water_hf_pdz.out
export CHKFILE=gaussian_123_water_hf_pdz.chk
export FCKFILE=gaussian_123_water_hf_pdz.fchk
export DNSFILE=gaussian_123_water_hf_pdz_dens.cube
export ESPFILE=gaussian_123_water_hf_pdz_esp.cube
