...
#SBATCH --job-name=g_water_pbe0_dz_23
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_23_water_pbe0_dz.com
export OUTFILE=gaussian_23_water_pbe0_dz.out
export CHKFILE=gaussian_23_water_pbe0_dz.chk
export FCKFILE=gaussian_23_water_pbe0_dz.fchk
export DNSFILE=gaussian_23_water_pbe0_dz_dens.cube
export ESPFILE=gaussian_23_water_pbe0_dz_esp.cube
