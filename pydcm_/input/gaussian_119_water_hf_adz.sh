...
#SBATCH --job-name=g_water_hf_adz_119
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_119_water_hf_adz.com
export OUTFILE=gaussian_119_water_hf_adz.out
export CHKFILE=gaussian_119_water_hf_adz.chk
export FCKFILE=gaussian_119_water_hf_adz.fchk
export DNSFILE=gaussian_119_water_hf_adz_dens.cube
export ESPFILE=gaussian_119_water_hf_adz_esp.cube
