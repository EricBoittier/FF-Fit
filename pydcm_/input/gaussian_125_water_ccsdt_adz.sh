...
#SBATCH --job-name=g_water_ccsdt_adz_125
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_125_water_ccsdt_adz.com
export OUTFILE=gaussian_125_water_ccsdt_adz.out
export CHKFILE=gaussian_125_water_ccsdt_adz.chk
export FCKFILE=gaussian_125_water_ccsdt_adz.fchk
export DNSFILE=gaussian_125_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_125_water_ccsdt_adz_esp.cube
