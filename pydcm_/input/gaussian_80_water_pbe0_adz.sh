...
#SBATCH --job-name=g_water_pbe0_adz_80
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_80_water_pbe0_adz.com
export OUTFILE=gaussian_80_water_pbe0_adz.out
export CHKFILE=gaussian_80_water_pbe0_adz.chk
export FCKFILE=gaussian_80_water_pbe0_adz.fchk
export DNSFILE=gaussian_80_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_80_water_pbe0_adz_esp.cube
