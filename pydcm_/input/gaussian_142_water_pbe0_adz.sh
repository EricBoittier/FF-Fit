...
#SBATCH --job-name=g_water_pbe0_adz_142
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_142_water_pbe0_adz.com
export OUTFILE=gaussian_142_water_pbe0_adz.out
export CHKFILE=gaussian_142_water_pbe0_adz.chk
export FCKFILE=gaussian_142_water_pbe0_adz.fchk
export DNSFILE=gaussian_142_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_142_water_pbe0_adz_esp.cube
