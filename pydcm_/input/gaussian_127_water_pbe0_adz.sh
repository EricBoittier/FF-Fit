...
#SBATCH --job-name=g_water_pbe0_adz_127
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_127_water_pbe0_adz.com
export OUTFILE=gaussian_127_water_pbe0_adz.out
export CHKFILE=gaussian_127_water_pbe0_adz.chk
export FCKFILE=gaussian_127_water_pbe0_adz.fchk
export DNSFILE=gaussian_127_water_pbe0_adz_dens.cube
export ESPFILE=gaussian_127_water_pbe0_adz_esp.cube
