...
#SBATCH --job-name=g_water_hf_pdz_143
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_143_water_hf_pdz.com
export OUTFILE=gaussian_143_water_hf_pdz.out
export CHKFILE=gaussian_143_water_hf_pdz.chk
export FCKFILE=gaussian_143_water_hf_pdz.fchk
export DNSFILE=gaussian_143_water_hf_pdz_dens.cube
export ESPFILE=gaussian_143_water_hf_pdz_esp.cube
