...
#SBATCH --job-name=g_water_b3lyp_pdz_136
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_136_water_b3lyp_pdz.com
export OUTFILE=gaussian_136_water_b3lyp_pdz.out
export CHKFILE=gaussian_136_water_b3lyp_pdz.chk
export FCKFILE=gaussian_136_water_b3lyp_pdz.fchk
export DNSFILE=gaussian_136_water_b3lyp_pdz_dens.cube
export ESPFILE=gaussian_136_water_b3lyp_pdz_esp.cube
