...
#SBATCH --job-name=g_water_hf_adz2_150
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_150_water_hf_adz2.com
export OUTFILE=gaussian_150_water_hf_adz2.out
export CHKFILE=gaussian_150_water_hf_adz2.chk
export FCKFILE=gaussian_150_water_hf_adz2.fchk
export DNSFILE=gaussian_150_water_hf_adz2_dens.cube
export ESPFILE=gaussian_150_water_hf_adz2_esp.cube
