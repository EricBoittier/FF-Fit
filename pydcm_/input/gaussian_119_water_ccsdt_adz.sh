...
#SBATCH --job-name=g_water_ccsdt_adz_119
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_119_water_ccsdt_adz.com
export OUTFILE=gaussian_119_water_ccsdt_adz.out
export CHKFILE=gaussian_119_water_ccsdt_adz.chk
export FCKFILE=gaussian_119_water_ccsdt_adz.fchk
export DNSFILE=gaussian_119_water_ccsdt_adz_dens.cube
export ESPFILE=gaussian_119_water_ccsdt_adz_esp.cube
