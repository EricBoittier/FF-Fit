...
#SBATCH --job-name=g_water_hf_adz2_138
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_138_water_hf_adz2.com
export OUTFILE=gaussian_138_water_hf_adz2.out
export CHKFILE=gaussian_138_water_hf_adz2.chk
export FCKFILE=gaussian_138_water_hf_adz2.fchk
export DNSFILE=gaussian_138_water_hf_adz2_dens.cube
export ESPFILE=gaussian_138_water_hf_adz2_esp.cube
