...
#SBATCH --job-name=g_water_wb97_ptz_50
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
export INPFILE=gaussian_50_water_wb97_ptz.com
export OUTFILE=gaussian_50_water_wb97_ptz.out
export CHKFILE=gaussian_50_water_wb97_ptz.chk
export FCKFILE=gaussian_50_water_wb97_ptz.fchk
export DNSFILE=gaussian_50_water_wb97_ptz_dens.cube
export ESPFILE=gaussian_50_water_wb97_ptz_esp.cube
