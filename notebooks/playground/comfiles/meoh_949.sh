...
export INPFILE=meoh_949.com
export OUTFILE=meoh_949.out
export CHKFILE=meoh_949.chk
export FCKFILE=meoh_949.fchk
export DNSFILE=meoh_949.d.cube
export ESPFILE=meoh_949.p.cube
