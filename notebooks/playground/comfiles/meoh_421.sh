...
export INPFILE=meoh_421.com
export OUTFILE=meoh_421.out
export CHKFILE=meoh_421.chk
export FCKFILE=meoh_421.fchk
export DNSFILE=meoh_421.d.cube
export ESPFILE=meoh_421.p.cube
