...
export INPFILE=meoh_588.com
export OUTFILE=meoh_588.out
export CHKFILE=meoh_588.chk
export FCKFILE=meoh_588.fchk
export DNSFILE=meoh_588.d.cube
export ESPFILE=meoh_588.p.cube
