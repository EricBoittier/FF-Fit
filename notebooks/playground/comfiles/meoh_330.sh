...
export INPFILE=meoh_330.com
export OUTFILE=meoh_330.out
export CHKFILE=meoh_330.chk
export FCKFILE=meoh_330.fchk
export DNSFILE=meoh_330.d.cube
export ESPFILE=meoh_330.p.cube
