...
export INPFILE=meoh_335.com
export OUTFILE=meoh_335.out
export CHKFILE=meoh_335.chk
export FCKFILE=meoh_335.fchk
export DNSFILE=meoh_335.d.cube
export ESPFILE=meoh_335.p.cube
