...
export INPFILE=meoh_261.com
export OUTFILE=meoh_261.out
export CHKFILE=meoh_261.chk
export FCKFILE=meoh_261.fchk
export DNSFILE=meoh_261.d.cube
export ESPFILE=meoh_261.p.cube
