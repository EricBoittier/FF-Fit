...
export INPFILE=meoh_535.com
export OUTFILE=meoh_535.out
export CHKFILE=meoh_535.chk
export FCKFILE=meoh_535.fchk
export DNSFILE=meoh_535.d.cube
export ESPFILE=meoh_535.p.cube
