...
export INPFILE=meoh_423.com
export OUTFILE=meoh_423.out
export CHKFILE=meoh_423.chk
export FCKFILE=meoh_423.fchk
export DNSFILE=meoh_423.d.cube
export ESPFILE=meoh_423.p.cube
