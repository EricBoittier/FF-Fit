...
export INPFILE=meoh_144.com
export OUTFILE=meoh_144.out
export CHKFILE=meoh_144.chk
export FCKFILE=meoh_144.fchk
export DNSFILE=meoh_144.d.cube
export ESPFILE=meoh_144.p.cube
