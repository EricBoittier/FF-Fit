...
export INPFILE=meoh_52.com
export OUTFILE=meoh_52.out
export CHKFILE=meoh_52.chk
export FCKFILE=meoh_52.fchk
export DNSFILE=meoh_52.d.cube
export ESPFILE=meoh_52.p.cube
