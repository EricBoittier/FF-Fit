...
export INPFILE=meoh_62.com
export OUTFILE=meoh_62.out
export CHKFILE=meoh_62.chk
export FCKFILE=meoh_62.fchk
export DNSFILE=meoh_62.d.cube
export ESPFILE=meoh_62.p.cube
