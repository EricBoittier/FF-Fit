...
export INPFILE=meoh_378.com
export OUTFILE=meoh_378.out
export CHKFILE=meoh_378.chk
export FCKFILE=meoh_378.fchk
export DNSFILE=meoh_378.d.cube
export ESPFILE=meoh_378.p.cube
