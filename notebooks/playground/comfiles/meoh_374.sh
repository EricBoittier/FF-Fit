...
export INPFILE=meoh_374.com
export OUTFILE=meoh_374.out
export CHKFILE=meoh_374.chk
export FCKFILE=meoh_374.fchk
export DNSFILE=meoh_374.d.cube
export ESPFILE=meoh_374.p.cube
