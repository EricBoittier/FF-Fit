...
export INPFILE=meoh_606.com
export OUTFILE=meoh_606.out
export CHKFILE=meoh_606.chk
export FCKFILE=meoh_606.fchk
export DNSFILE=meoh_606.d.cube
export ESPFILE=meoh_606.p.cube
