...
export INPFILE=meoh_763.com
export OUTFILE=meoh_763.out
export CHKFILE=meoh_763.chk
export FCKFILE=meoh_763.fchk
export DNSFILE=meoh_763.d.cube
export ESPFILE=meoh_763.p.cube
