...
export INPFILE=meoh_107.com
export OUTFILE=meoh_107.out
export CHKFILE=meoh_107.chk
export FCKFILE=meoh_107.fchk
export DNSFILE=meoh_107.d.cube
export ESPFILE=meoh_107.p.cube
