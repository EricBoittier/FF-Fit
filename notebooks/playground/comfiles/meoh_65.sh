...
export INPFILE=meoh_65.com
export OUTFILE=meoh_65.out
export CHKFILE=meoh_65.chk
export FCKFILE=meoh_65.fchk
export DNSFILE=meoh_65.d.cube
export ESPFILE=meoh_65.p.cube
