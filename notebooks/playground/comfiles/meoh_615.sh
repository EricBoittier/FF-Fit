...
export INPFILE=meoh_615.com
export OUTFILE=meoh_615.out
export CHKFILE=meoh_615.chk
export FCKFILE=meoh_615.fchk
export DNSFILE=meoh_615.d.cube
export ESPFILE=meoh_615.p.cube
