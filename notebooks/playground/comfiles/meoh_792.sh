...
export INPFILE=meoh_792.com
export OUTFILE=meoh_792.out
export CHKFILE=meoh_792.chk
export FCKFILE=meoh_792.fchk
export DNSFILE=meoh_792.d.cube
export ESPFILE=meoh_792.p.cube
