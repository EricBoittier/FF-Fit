...
export INPFILE=meoh_890.com
export OUTFILE=meoh_890.out
export CHKFILE=meoh_890.chk
export FCKFILE=meoh_890.fchk
export DNSFILE=meoh_890.d.cube
export ESPFILE=meoh_890.p.cube
