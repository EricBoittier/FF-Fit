...
export INPFILE=meoh_329.com
export OUTFILE=meoh_329.out
export CHKFILE=meoh_329.chk
export FCKFILE=meoh_329.fchk
export DNSFILE=meoh_329.d.cube
export ESPFILE=meoh_329.p.cube
