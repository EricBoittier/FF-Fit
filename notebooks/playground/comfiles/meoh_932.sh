...
export INPFILE=meoh_932.com
export OUTFILE=meoh_932.out
export CHKFILE=meoh_932.chk
export FCKFILE=meoh_932.fchk
export DNSFILE=meoh_932.d.cube
export ESPFILE=meoh_932.p.cube
