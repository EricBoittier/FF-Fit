...
export INPFILE=meoh_691.com
export OUTFILE=meoh_691.out
export CHKFILE=meoh_691.chk
export FCKFILE=meoh_691.fchk
export DNSFILE=meoh_691.d.cube
export ESPFILE=meoh_691.p.cube
