...
export INPFILE=meoh_450.com
export OUTFILE=meoh_450.out
export CHKFILE=meoh_450.chk
export FCKFILE=meoh_450.fchk
export DNSFILE=meoh_450.d.cube
export ESPFILE=meoh_450.p.cube
