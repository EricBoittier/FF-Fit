...
export INPFILE=meoh_540.com
export OUTFILE=meoh_540.out
export CHKFILE=meoh_540.chk
export FCKFILE=meoh_540.fchk
export DNSFILE=meoh_540.d.cube
export ESPFILE=meoh_540.p.cube
