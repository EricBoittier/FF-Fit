...
export INPFILE=meoh_326.com
export OUTFILE=meoh_326.out
export CHKFILE=meoh_326.chk
export FCKFILE=meoh_326.fchk
export DNSFILE=meoh_326.d.cube
export ESPFILE=meoh_326.p.cube
