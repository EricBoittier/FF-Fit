...
export INPFILE=meoh_243.com
export OUTFILE=meoh_243.out
export CHKFILE=meoh_243.chk
export FCKFILE=meoh_243.fchk
export DNSFILE=meoh_243.d.cube
export ESPFILE=meoh_243.p.cube
