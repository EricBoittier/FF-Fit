...
export INPFILE=meoh_735.com
export OUTFILE=meoh_735.out
export CHKFILE=meoh_735.chk
export FCKFILE=meoh_735.fchk
export DNSFILE=meoh_735.d.cube
export ESPFILE=meoh_735.p.cube
