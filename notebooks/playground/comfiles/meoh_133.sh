...
export INPFILE=meoh_133.com
export OUTFILE=meoh_133.out
export CHKFILE=meoh_133.chk
export FCKFILE=meoh_133.fchk
export DNSFILE=meoh_133.d.cube
export ESPFILE=meoh_133.p.cube
