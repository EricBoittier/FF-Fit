...
export INPFILE=meoh_37.com
export OUTFILE=meoh_37.out
export CHKFILE=meoh_37.chk
export FCKFILE=meoh_37.fchk
export DNSFILE=meoh_37.d.cube
export ESPFILE=meoh_37.p.cube
