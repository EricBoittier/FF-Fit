...
export INPFILE=meoh_48.com
export OUTFILE=meoh_48.out
export CHKFILE=meoh_48.chk
export FCKFILE=meoh_48.fchk
export DNSFILE=meoh_48.d.cube
export ESPFILE=meoh_48.p.cube
