...
export INPFILE=meoh_746.com
export OUTFILE=meoh_746.out
export CHKFILE=meoh_746.chk
export FCKFILE=meoh_746.fchk
export DNSFILE=meoh_746.d.cube
export ESPFILE=meoh_746.p.cube
