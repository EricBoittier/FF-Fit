...
export INPFILE=meoh_712.com
export OUTFILE=meoh_712.out
export CHKFILE=meoh_712.chk
export FCKFILE=meoh_712.fchk
export DNSFILE=meoh_712.d.cube
export ESPFILE=meoh_712.p.cube
