...
export INPFILE=meoh_254.com
export OUTFILE=meoh_254.out
export CHKFILE=meoh_254.chk
export FCKFILE=meoh_254.fchk
export DNSFILE=meoh_254.d.cube
export ESPFILE=meoh_254.p.cube
