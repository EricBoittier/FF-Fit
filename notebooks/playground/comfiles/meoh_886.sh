...
export INPFILE=meoh_886.com
export OUTFILE=meoh_886.out
export CHKFILE=meoh_886.chk
export FCKFILE=meoh_886.fchk
export DNSFILE=meoh_886.d.cube
export ESPFILE=meoh_886.p.cube
