...
export INPFILE=meoh_74.com
export OUTFILE=meoh_74.out
export CHKFILE=meoh_74.chk
export FCKFILE=meoh_74.fchk
export DNSFILE=meoh_74.d.cube
export ESPFILE=meoh_74.p.cube
