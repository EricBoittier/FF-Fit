...
export INPFILE=meoh_704.com
export OUTFILE=meoh_704.out
export CHKFILE=meoh_704.chk
export FCKFILE=meoh_704.fchk
export DNSFILE=meoh_704.d.cube
export ESPFILE=meoh_704.p.cube
