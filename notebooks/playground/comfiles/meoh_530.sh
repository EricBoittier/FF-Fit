...
export INPFILE=meoh_530.com
export OUTFILE=meoh_530.out
export CHKFILE=meoh_530.chk
export FCKFILE=meoh_530.fchk
export DNSFILE=meoh_530.d.cube
export ESPFILE=meoh_530.p.cube
