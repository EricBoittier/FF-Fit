...
export INPFILE=meoh_622.com
export OUTFILE=meoh_622.out
export CHKFILE=meoh_622.chk
export FCKFILE=meoh_622.fchk
export DNSFILE=meoh_622.d.cube
export ESPFILE=meoh_622.p.cube
