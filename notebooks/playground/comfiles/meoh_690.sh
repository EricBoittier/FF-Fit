...
export INPFILE=meoh_690.com
export OUTFILE=meoh_690.out
export CHKFILE=meoh_690.chk
export FCKFILE=meoh_690.fchk
export DNSFILE=meoh_690.d.cube
export ESPFILE=meoh_690.p.cube
