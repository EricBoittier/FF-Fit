...
export INPFILE=meoh_187.com
export OUTFILE=meoh_187.out
export CHKFILE=meoh_187.chk
export FCKFILE=meoh_187.fchk
export DNSFILE=meoh_187.d.cube
export ESPFILE=meoh_187.p.cube
