...
export INPFILE=meoh_620.com
export OUTFILE=meoh_620.out
export CHKFILE=meoh_620.chk
export FCKFILE=meoh_620.fchk
export DNSFILE=meoh_620.d.cube
export ESPFILE=meoh_620.p.cube
