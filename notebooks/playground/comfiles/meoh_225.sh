...
export INPFILE=meoh_225.com
export OUTFILE=meoh_225.out
export CHKFILE=meoh_225.chk
export FCKFILE=meoh_225.fchk
export DNSFILE=meoh_225.d.cube
export ESPFILE=meoh_225.p.cube
