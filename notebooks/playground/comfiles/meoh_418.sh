...
export INPFILE=meoh_418.com
export OUTFILE=meoh_418.out
export CHKFILE=meoh_418.chk
export FCKFILE=meoh_418.fchk
export DNSFILE=meoh_418.d.cube
export ESPFILE=meoh_418.p.cube
