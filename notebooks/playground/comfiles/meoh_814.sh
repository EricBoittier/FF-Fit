...
export INPFILE=meoh_814.com
export OUTFILE=meoh_814.out
export CHKFILE=meoh_814.chk
export FCKFILE=meoh_814.fchk
export DNSFILE=meoh_814.d.cube
export ESPFILE=meoh_814.p.cube
