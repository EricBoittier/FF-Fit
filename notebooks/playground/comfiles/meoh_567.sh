...
export INPFILE=meoh_567.com
export OUTFILE=meoh_567.out
export CHKFILE=meoh_567.chk
export FCKFILE=meoh_567.fchk
export DNSFILE=meoh_567.d.cube
export ESPFILE=meoh_567.p.cube
