...
export INPFILE=meoh_381.com
export OUTFILE=meoh_381.out
export CHKFILE=meoh_381.chk
export FCKFILE=meoh_381.fchk
export DNSFILE=meoh_381.d.cube
export ESPFILE=meoh_381.p.cube
