...
export INPFILE=meoh_621.com
export OUTFILE=meoh_621.out
export CHKFILE=meoh_621.chk
export FCKFILE=meoh_621.fchk
export DNSFILE=meoh_621.d.cube
export ESPFILE=meoh_621.p.cube
