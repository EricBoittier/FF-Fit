...
export INPFILE=meoh_681.com
export OUTFILE=meoh_681.out
export CHKFILE=meoh_681.chk
export FCKFILE=meoh_681.fchk
export DNSFILE=meoh_681.d.cube
export ESPFILE=meoh_681.p.cube
