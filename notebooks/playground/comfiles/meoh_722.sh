...
export INPFILE=meoh_722.com
export OUTFILE=meoh_722.out
export CHKFILE=meoh_722.chk
export FCKFILE=meoh_722.fchk
export DNSFILE=meoh_722.d.cube
export ESPFILE=meoh_722.p.cube
