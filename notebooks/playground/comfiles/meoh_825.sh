...
export INPFILE=meoh_825.com
export OUTFILE=meoh_825.out
export CHKFILE=meoh_825.chk
export FCKFILE=meoh_825.fchk
export DNSFILE=meoh_825.d.cube
export ESPFILE=meoh_825.p.cube
