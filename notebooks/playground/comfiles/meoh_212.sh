...
export INPFILE=meoh_212.com
export OUTFILE=meoh_212.out
export CHKFILE=meoh_212.chk
export FCKFILE=meoh_212.fchk
export DNSFILE=meoh_212.d.cube
export ESPFILE=meoh_212.p.cube
