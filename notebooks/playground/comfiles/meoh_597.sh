...
export INPFILE=meoh_597.com
export OUTFILE=meoh_597.out
export CHKFILE=meoh_597.chk
export FCKFILE=meoh_597.fchk
export DNSFILE=meoh_597.d.cube
export ESPFILE=meoh_597.p.cube
