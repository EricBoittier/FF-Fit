...
export INPFILE=meoh_779.com
export OUTFILE=meoh_779.out
export CHKFILE=meoh_779.chk
export FCKFILE=meoh_779.fchk
export DNSFILE=meoh_779.d.cube
export ESPFILE=meoh_779.p.cube
