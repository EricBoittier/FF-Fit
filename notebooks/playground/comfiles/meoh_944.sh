...
export INPFILE=meoh_944.com
export OUTFILE=meoh_944.out
export CHKFILE=meoh_944.chk
export FCKFILE=meoh_944.fchk
export DNSFILE=meoh_944.d.cube
export ESPFILE=meoh_944.p.cube
