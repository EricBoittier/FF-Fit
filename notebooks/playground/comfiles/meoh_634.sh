...
export INPFILE=meoh_634.com
export OUTFILE=meoh_634.out
export CHKFILE=meoh_634.chk
export FCKFILE=meoh_634.fchk
export DNSFILE=meoh_634.d.cube
export ESPFILE=meoh_634.p.cube
