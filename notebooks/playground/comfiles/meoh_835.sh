...
export INPFILE=meoh_835.com
export OUTFILE=meoh_835.out
export CHKFILE=meoh_835.chk
export FCKFILE=meoh_835.fchk
export DNSFILE=meoh_835.d.cube
export ESPFILE=meoh_835.p.cube
