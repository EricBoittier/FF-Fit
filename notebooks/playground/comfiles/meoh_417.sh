...
export INPFILE=meoh_417.com
export OUTFILE=meoh_417.out
export CHKFILE=meoh_417.chk
export FCKFILE=meoh_417.fchk
export DNSFILE=meoh_417.d.cube
export ESPFILE=meoh_417.p.cube
