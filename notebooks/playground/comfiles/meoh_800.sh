...
export INPFILE=meoh_800.com
export OUTFILE=meoh_800.out
export CHKFILE=meoh_800.chk
export FCKFILE=meoh_800.fchk
export DNSFILE=meoh_800.d.cube
export ESPFILE=meoh_800.p.cube
