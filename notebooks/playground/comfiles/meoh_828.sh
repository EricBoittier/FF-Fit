...
export INPFILE=meoh_828.com
export OUTFILE=meoh_828.out
export CHKFILE=meoh_828.chk
export FCKFILE=meoh_828.fchk
export DNSFILE=meoh_828.d.cube
export ESPFILE=meoh_828.p.cube
