...
export INPFILE=meoh_452.com
export OUTFILE=meoh_452.out
export CHKFILE=meoh_452.chk
export FCKFILE=meoh_452.fchk
export DNSFILE=meoh_452.d.cube
export ESPFILE=meoh_452.p.cube
