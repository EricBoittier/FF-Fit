...
export INPFILE=meoh_64.com
export OUTFILE=meoh_64.out
export CHKFILE=meoh_64.chk
export FCKFILE=meoh_64.fchk
export DNSFILE=meoh_64.d.cube
export ESPFILE=meoh_64.p.cube
