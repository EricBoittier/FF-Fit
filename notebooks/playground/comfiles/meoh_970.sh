...
export INPFILE=meoh_970.com
export OUTFILE=meoh_970.out
export CHKFILE=meoh_970.chk
export FCKFILE=meoh_970.fchk
export DNSFILE=meoh_970.d.cube
export ESPFILE=meoh_970.p.cube
