...
export INPFILE=meoh_698.com
export OUTFILE=meoh_698.out
export CHKFILE=meoh_698.chk
export FCKFILE=meoh_698.fchk
export DNSFILE=meoh_698.d.cube
export ESPFILE=meoh_698.p.cube
