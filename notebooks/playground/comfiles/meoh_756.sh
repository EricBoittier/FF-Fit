...
export INPFILE=meoh_756.com
export OUTFILE=meoh_756.out
export CHKFILE=meoh_756.chk
export FCKFILE=meoh_756.fchk
export DNSFILE=meoh_756.d.cube
export ESPFILE=meoh_756.p.cube
