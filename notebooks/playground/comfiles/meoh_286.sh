...
export INPFILE=meoh_286.com
export OUTFILE=meoh_286.out
export CHKFILE=meoh_286.chk
export FCKFILE=meoh_286.fchk
export DNSFILE=meoh_286.d.cube
export ESPFILE=meoh_286.p.cube
