...
export INPFILE=meoh_783.com
export OUTFILE=meoh_783.out
export CHKFILE=meoh_783.chk
export FCKFILE=meoh_783.fchk
export DNSFILE=meoh_783.d.cube
export ESPFILE=meoh_783.p.cube
