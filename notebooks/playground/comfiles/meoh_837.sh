...
export INPFILE=meoh_837.com
export OUTFILE=meoh_837.out
export CHKFILE=meoh_837.chk
export FCKFILE=meoh_837.fchk
export DNSFILE=meoh_837.d.cube
export ESPFILE=meoh_837.p.cube
