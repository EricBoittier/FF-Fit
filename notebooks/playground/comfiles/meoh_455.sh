...
export INPFILE=meoh_455.com
export OUTFILE=meoh_455.out
export CHKFILE=meoh_455.chk
export FCKFILE=meoh_455.fchk
export DNSFILE=meoh_455.d.cube
export ESPFILE=meoh_455.p.cube
