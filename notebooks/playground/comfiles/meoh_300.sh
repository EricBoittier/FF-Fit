...
export INPFILE=meoh_300.com
export OUTFILE=meoh_300.out
export CHKFILE=meoh_300.chk
export FCKFILE=meoh_300.fchk
export DNSFILE=meoh_300.d.cube
export ESPFILE=meoh_300.p.cube
