...
export INPFILE=meoh_863.com
export OUTFILE=meoh_863.out
export CHKFILE=meoh_863.chk
export FCKFILE=meoh_863.fchk
export DNSFILE=meoh_863.d.cube
export ESPFILE=meoh_863.p.cube
