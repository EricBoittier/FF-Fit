...
export INPFILE=meoh_143.com
export OUTFILE=meoh_143.out
export CHKFILE=meoh_143.chk
export FCKFILE=meoh_143.fchk
export DNSFILE=meoh_143.d.cube
export ESPFILE=meoh_143.p.cube
