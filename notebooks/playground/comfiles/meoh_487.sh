...
export INPFILE=meoh_487.com
export OUTFILE=meoh_487.out
export CHKFILE=meoh_487.chk
export FCKFILE=meoh_487.fchk
export DNSFILE=meoh_487.d.cube
export ESPFILE=meoh_487.p.cube
