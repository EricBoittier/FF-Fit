...
export INPFILE=meoh_70.com
export OUTFILE=meoh_70.out
export CHKFILE=meoh_70.chk
export FCKFILE=meoh_70.fchk
export DNSFILE=meoh_70.d.cube
export ESPFILE=meoh_70.p.cube
