...
export INPFILE=meoh_270.com
export OUTFILE=meoh_270.out
export CHKFILE=meoh_270.chk
export FCKFILE=meoh_270.fchk
export DNSFILE=meoh_270.d.cube
export ESPFILE=meoh_270.p.cube
