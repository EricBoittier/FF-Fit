...
export INPFILE=meoh_905.com
export OUTFILE=meoh_905.out
export CHKFILE=meoh_905.chk
export FCKFILE=meoh_905.fchk
export DNSFILE=meoh_905.d.cube
export ESPFILE=meoh_905.p.cube
