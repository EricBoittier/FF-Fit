...
export INPFILE=meoh_481.com
export OUTFILE=meoh_481.out
export CHKFILE=meoh_481.chk
export FCKFILE=meoh_481.fchk
export DNSFILE=meoh_481.d.cube
export ESPFILE=meoh_481.p.cube
