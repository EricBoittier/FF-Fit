...
export INPFILE=meoh_867.com
export OUTFILE=meoh_867.out
export CHKFILE=meoh_867.chk
export FCKFILE=meoh_867.fchk
export DNSFILE=meoh_867.d.cube
export ESPFILE=meoh_867.p.cube
