...
export INPFILE=meoh_290.com
export OUTFILE=meoh_290.out
export CHKFILE=meoh_290.chk
export FCKFILE=meoh_290.fchk
export DNSFILE=meoh_290.d.cube
export ESPFILE=meoh_290.p.cube
