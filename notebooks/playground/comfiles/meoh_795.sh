...
export INPFILE=meoh_795.com
export OUTFILE=meoh_795.out
export CHKFILE=meoh_795.chk
export FCKFILE=meoh_795.fchk
export DNSFILE=meoh_795.d.cube
export ESPFILE=meoh_795.p.cube
