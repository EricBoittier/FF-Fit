...
export INPFILE=meoh_96.com
export OUTFILE=meoh_96.out
export CHKFILE=meoh_96.chk
export FCKFILE=meoh_96.fchk
export DNSFILE=meoh_96.d.cube
export ESPFILE=meoh_96.p.cube
