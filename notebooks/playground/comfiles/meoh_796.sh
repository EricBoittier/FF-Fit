...
export INPFILE=meoh_796.com
export OUTFILE=meoh_796.out
export CHKFILE=meoh_796.chk
export FCKFILE=meoh_796.fchk
export DNSFILE=meoh_796.d.cube
export ESPFILE=meoh_796.p.cube
