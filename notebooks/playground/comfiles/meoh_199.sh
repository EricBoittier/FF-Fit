...
export INPFILE=meoh_199.com
export OUTFILE=meoh_199.out
export CHKFILE=meoh_199.chk
export FCKFILE=meoh_199.fchk
export DNSFILE=meoh_199.d.cube
export ESPFILE=meoh_199.p.cube
