...
export INPFILE=meoh_153.com
export OUTFILE=meoh_153.out
export CHKFILE=meoh_153.chk
export FCKFILE=meoh_153.fchk
export DNSFILE=meoh_153.d.cube
export ESPFILE=meoh_153.p.cube
