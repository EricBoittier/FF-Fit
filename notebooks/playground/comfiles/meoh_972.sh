...
export INPFILE=meoh_972.com
export OUTFILE=meoh_972.out
export CHKFILE=meoh_972.chk
export FCKFILE=meoh_972.fchk
export DNSFILE=meoh_972.d.cube
export ESPFILE=meoh_972.p.cube
