...
export INPFILE=meoh_93.com
export OUTFILE=meoh_93.out
export CHKFILE=meoh_93.chk
export FCKFILE=meoh_93.fchk
export DNSFILE=meoh_93.d.cube
export ESPFILE=meoh_93.p.cube
