...
export INPFILE=meoh_331.com
export OUTFILE=meoh_331.out
export CHKFILE=meoh_331.chk
export FCKFILE=meoh_331.fchk
export DNSFILE=meoh_331.d.cube
export ESPFILE=meoh_331.p.cube
