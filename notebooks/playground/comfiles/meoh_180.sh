...
export INPFILE=meoh_180.com
export OUTFILE=meoh_180.out
export CHKFILE=meoh_180.chk
export FCKFILE=meoh_180.fchk
export DNSFILE=meoh_180.d.cube
export ESPFILE=meoh_180.p.cube
