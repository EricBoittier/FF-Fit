...
export INPFILE=meoh_370.com
export OUTFILE=meoh_370.out
export CHKFILE=meoh_370.chk
export FCKFILE=meoh_370.fchk
export DNSFILE=meoh_370.d.cube
export ESPFILE=meoh_370.p.cube
