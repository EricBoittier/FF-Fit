...
export INPFILE=meoh_348.com
export OUTFILE=meoh_348.out
export CHKFILE=meoh_348.chk
export FCKFILE=meoh_348.fchk
export DNSFILE=meoh_348.d.cube
export ESPFILE=meoh_348.p.cube
