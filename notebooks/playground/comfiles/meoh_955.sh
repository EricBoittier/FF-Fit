...
export INPFILE=meoh_955.com
export OUTFILE=meoh_955.out
export CHKFILE=meoh_955.chk
export FCKFILE=meoh_955.fchk
export DNSFILE=meoh_955.d.cube
export ESPFILE=meoh_955.p.cube
