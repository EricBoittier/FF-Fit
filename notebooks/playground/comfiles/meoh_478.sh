...
export INPFILE=meoh_478.com
export OUTFILE=meoh_478.out
export CHKFILE=meoh_478.chk
export FCKFILE=meoh_478.fchk
export DNSFILE=meoh_478.d.cube
export ESPFILE=meoh_478.p.cube
