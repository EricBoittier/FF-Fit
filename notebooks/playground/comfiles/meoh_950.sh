...
export INPFILE=meoh_950.com
export OUTFILE=meoh_950.out
export CHKFILE=meoh_950.chk
export FCKFILE=meoh_950.fchk
export DNSFILE=meoh_950.d.cube
export ESPFILE=meoh_950.p.cube
