...
export INPFILE=meoh_61.com
export OUTFILE=meoh_61.out
export CHKFILE=meoh_61.chk
export FCKFILE=meoh_61.fchk
export DNSFILE=meoh_61.d.cube
export ESPFILE=meoh_61.p.cube
