...
export INPFILE=meoh_843.com
export OUTFILE=meoh_843.out
export CHKFILE=meoh_843.chk
export FCKFILE=meoh_843.fchk
export DNSFILE=meoh_843.d.cube
export ESPFILE=meoh_843.p.cube
