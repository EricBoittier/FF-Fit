...
export INPFILE=meoh_838.com
export OUTFILE=meoh_838.out
export CHKFILE=meoh_838.chk
export FCKFILE=meoh_838.fchk
export DNSFILE=meoh_838.d.cube
export ESPFILE=meoh_838.p.cube
