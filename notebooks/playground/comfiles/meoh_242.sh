...
export INPFILE=meoh_242.com
export OUTFILE=meoh_242.out
export CHKFILE=meoh_242.chk
export FCKFILE=meoh_242.fchk
export DNSFILE=meoh_242.d.cube
export ESPFILE=meoh_242.p.cube
