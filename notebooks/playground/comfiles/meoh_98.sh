...
export INPFILE=meoh_98.com
export OUTFILE=meoh_98.out
export CHKFILE=meoh_98.chk
export FCKFILE=meoh_98.fchk
export DNSFILE=meoh_98.d.cube
export ESPFILE=meoh_98.p.cube
