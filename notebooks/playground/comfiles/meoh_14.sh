...
export INPFILE=meoh_14.com
export OUTFILE=meoh_14.out
export CHKFILE=meoh_14.chk
export FCKFILE=meoh_14.fchk
export DNSFILE=meoh_14.d.cube
export ESPFILE=meoh_14.p.cube
