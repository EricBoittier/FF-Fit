...
export INPFILE=meoh_875.com
export OUTFILE=meoh_875.out
export CHKFILE=meoh_875.chk
export FCKFILE=meoh_875.fchk
export DNSFILE=meoh_875.d.cube
export ESPFILE=meoh_875.p.cube
