...
export INPFILE=meoh_82.com
export OUTFILE=meoh_82.out
export CHKFILE=meoh_82.chk
export FCKFILE=meoh_82.fchk
export DNSFILE=meoh_82.d.cube
export ESPFILE=meoh_82.p.cube
