...
export INPFILE=meoh_399.com
export OUTFILE=meoh_399.out
export CHKFILE=meoh_399.chk
export FCKFILE=meoh_399.fchk
export DNSFILE=meoh_399.d.cube
export ESPFILE=meoh_399.p.cube
