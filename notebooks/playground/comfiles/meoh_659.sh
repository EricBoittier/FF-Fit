...
export INPFILE=meoh_659.com
export OUTFILE=meoh_659.out
export CHKFILE=meoh_659.chk
export FCKFILE=meoh_659.fchk
export DNSFILE=meoh_659.d.cube
export ESPFILE=meoh_659.p.cube
