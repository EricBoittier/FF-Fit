...
export INPFILE=meoh_282.com
export OUTFILE=meoh_282.out
export CHKFILE=meoh_282.chk
export FCKFILE=meoh_282.fchk
export DNSFILE=meoh_282.d.cube
export ESPFILE=meoh_282.p.cube
