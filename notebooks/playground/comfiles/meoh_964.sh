...
export INPFILE=meoh_964.com
export OUTFILE=meoh_964.out
export CHKFILE=meoh_964.chk
export FCKFILE=meoh_964.fchk
export DNSFILE=meoh_964.d.cube
export ESPFILE=meoh_964.p.cube
