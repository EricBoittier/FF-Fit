...
export INPFILE=meoh_578.com
export OUTFILE=meoh_578.out
export CHKFILE=meoh_578.chk
export FCKFILE=meoh_578.fchk
export DNSFILE=meoh_578.d.cube
export ESPFILE=meoh_578.p.cube
