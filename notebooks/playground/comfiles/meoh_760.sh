...
export INPFILE=meoh_760.com
export OUTFILE=meoh_760.out
export CHKFILE=meoh_760.chk
export FCKFILE=meoh_760.fchk
export DNSFILE=meoh_760.d.cube
export ESPFILE=meoh_760.p.cube
