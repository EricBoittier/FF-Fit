...
export INPFILE=meoh_471.com
export OUTFILE=meoh_471.out
export CHKFILE=meoh_471.chk
export FCKFILE=meoh_471.fchk
export DNSFILE=meoh_471.d.cube
export ESPFILE=meoh_471.p.cube
