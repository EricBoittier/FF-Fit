...
export INPFILE=meoh_40.com
export OUTFILE=meoh_40.out
export CHKFILE=meoh_40.chk
export FCKFILE=meoh_40.fchk
export DNSFILE=meoh_40.d.cube
export ESPFILE=meoh_40.p.cube
