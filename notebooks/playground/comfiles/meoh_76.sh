...
export INPFILE=meoh_76.com
export OUTFILE=meoh_76.out
export CHKFILE=meoh_76.chk
export FCKFILE=meoh_76.fchk
export DNSFILE=meoh_76.d.cube
export ESPFILE=meoh_76.p.cube
