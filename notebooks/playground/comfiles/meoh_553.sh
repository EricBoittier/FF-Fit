...
export INPFILE=meoh_553.com
export OUTFILE=meoh_553.out
export CHKFILE=meoh_553.chk
export FCKFILE=meoh_553.fchk
export DNSFILE=meoh_553.d.cube
export ESPFILE=meoh_553.p.cube
