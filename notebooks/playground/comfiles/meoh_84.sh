...
export INPFILE=meoh_84.com
export OUTFILE=meoh_84.out
export CHKFILE=meoh_84.chk
export FCKFILE=meoh_84.fchk
export DNSFILE=meoh_84.d.cube
export ESPFILE=meoh_84.p.cube
