...
export INPFILE=meoh_9.com
export OUTFILE=meoh_9.out
export CHKFILE=meoh_9.chk
export FCKFILE=meoh_9.fchk
export DNSFILE=meoh_9.d.cube
export ESPFILE=meoh_9.p.cube
