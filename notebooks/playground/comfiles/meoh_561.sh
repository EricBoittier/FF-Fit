...
export INPFILE=meoh_561.com
export OUTFILE=meoh_561.out
export CHKFILE=meoh_561.chk
export FCKFILE=meoh_561.fchk
export DNSFILE=meoh_561.d.cube
export ESPFILE=meoh_561.p.cube
