...
export INPFILE=meoh_493.com
export OUTFILE=meoh_493.out
export CHKFILE=meoh_493.chk
export FCKFILE=meoh_493.fchk
export DNSFILE=meoh_493.d.cube
export ESPFILE=meoh_493.p.cube
