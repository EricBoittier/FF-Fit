...
export INPFILE=meoh_749.com
export OUTFILE=meoh_749.out
export CHKFILE=meoh_749.chk
export FCKFILE=meoh_749.fchk
export DNSFILE=meoh_749.d.cube
export ESPFILE=meoh_749.p.cube
