...
export INPFILE=meoh_216.com
export OUTFILE=meoh_216.out
export CHKFILE=meoh_216.chk
export FCKFILE=meoh_216.fchk
export DNSFILE=meoh_216.d.cube
export ESPFILE=meoh_216.p.cube
