...
export INPFILE=meoh_617.com
export OUTFILE=meoh_617.out
export CHKFILE=meoh_617.chk
export FCKFILE=meoh_617.fchk
export DNSFILE=meoh_617.d.cube
export ESPFILE=meoh_617.p.cube
