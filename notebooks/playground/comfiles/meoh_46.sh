...
export INPFILE=meoh_46.com
export OUTFILE=meoh_46.out
export CHKFILE=meoh_46.chk
export FCKFILE=meoh_46.fchk
export DNSFILE=meoh_46.d.cube
export ESPFILE=meoh_46.p.cube
