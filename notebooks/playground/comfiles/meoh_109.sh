...
export INPFILE=meoh_109.com
export OUTFILE=meoh_109.out
export CHKFILE=meoh_109.chk
export FCKFILE=meoh_109.fchk
export DNSFILE=meoh_109.d.cube
export ESPFILE=meoh_109.p.cube
