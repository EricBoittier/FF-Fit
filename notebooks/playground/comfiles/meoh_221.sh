...
export INPFILE=meoh_221.com
export OUTFILE=meoh_221.out
export CHKFILE=meoh_221.chk
export FCKFILE=meoh_221.fchk
export DNSFILE=meoh_221.d.cube
export ESPFILE=meoh_221.p.cube
