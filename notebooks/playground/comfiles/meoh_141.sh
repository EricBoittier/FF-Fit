...
export INPFILE=meoh_141.com
export OUTFILE=meoh_141.out
export CHKFILE=meoh_141.chk
export FCKFILE=meoh_141.fchk
export DNSFILE=meoh_141.d.cube
export ESPFILE=meoh_141.p.cube
