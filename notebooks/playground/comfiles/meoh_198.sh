...
export INPFILE=meoh_198.com
export OUTFILE=meoh_198.out
export CHKFILE=meoh_198.chk
export FCKFILE=meoh_198.fchk
export DNSFILE=meoh_198.d.cube
export ESPFILE=meoh_198.p.cube
