...
export INPFILE=meoh_523.com
export OUTFILE=meoh_523.out
export CHKFILE=meoh_523.chk
export FCKFILE=meoh_523.fchk
export DNSFILE=meoh_523.d.cube
export ESPFILE=meoh_523.p.cube
