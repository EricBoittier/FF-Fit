...
export INPFILE=meoh_917.com
export OUTFILE=meoh_917.out
export CHKFILE=meoh_917.chk
export FCKFILE=meoh_917.fchk
export DNSFILE=meoh_917.d.cube
export ESPFILE=meoh_917.p.cube
