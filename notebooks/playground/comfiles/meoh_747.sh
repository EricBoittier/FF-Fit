...
export INPFILE=meoh_747.com
export OUTFILE=meoh_747.out
export CHKFILE=meoh_747.chk
export FCKFILE=meoh_747.fchk
export DNSFILE=meoh_747.d.cube
export ESPFILE=meoh_747.p.cube
