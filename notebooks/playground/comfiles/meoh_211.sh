...
export INPFILE=meoh_211.com
export OUTFILE=meoh_211.out
export CHKFILE=meoh_211.chk
export FCKFILE=meoh_211.fchk
export DNSFILE=meoh_211.d.cube
export ESPFILE=meoh_211.p.cube
