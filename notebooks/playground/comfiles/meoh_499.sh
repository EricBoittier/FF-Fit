...
export INPFILE=meoh_499.com
export OUTFILE=meoh_499.out
export CHKFILE=meoh_499.chk
export FCKFILE=meoh_499.fchk
export DNSFILE=meoh_499.d.cube
export ESPFILE=meoh_499.p.cube
