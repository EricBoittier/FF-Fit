...
export INPFILE=meoh_571.com
export OUTFILE=meoh_571.out
export CHKFILE=meoh_571.chk
export FCKFILE=meoh_571.fchk
export DNSFILE=meoh_571.d.cube
export ESPFILE=meoh_571.p.cube
