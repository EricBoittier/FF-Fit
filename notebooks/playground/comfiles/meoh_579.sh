...
export INPFILE=meoh_579.com
export OUTFILE=meoh_579.out
export CHKFILE=meoh_579.chk
export FCKFILE=meoh_579.fchk
export DNSFILE=meoh_579.d.cube
export ESPFILE=meoh_579.p.cube
