...
export INPFILE=meoh_128.com
export OUTFILE=meoh_128.out
export CHKFILE=meoh_128.chk
export FCKFILE=meoh_128.fchk
export DNSFILE=meoh_128.d.cube
export ESPFILE=meoh_128.p.cube
