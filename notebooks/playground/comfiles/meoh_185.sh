...
export INPFILE=meoh_185.com
export OUTFILE=meoh_185.out
export CHKFILE=meoh_185.chk
export FCKFILE=meoh_185.fchk
export DNSFILE=meoh_185.d.cube
export ESPFILE=meoh_185.p.cube
