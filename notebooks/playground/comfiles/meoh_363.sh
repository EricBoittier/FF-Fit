...
export INPFILE=meoh_363.com
export OUTFILE=meoh_363.out
export CHKFILE=meoh_363.chk
export FCKFILE=meoh_363.fchk
export DNSFILE=meoh_363.d.cube
export ESPFILE=meoh_363.p.cube
