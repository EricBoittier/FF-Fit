...
export INPFILE=meoh_387.com
export OUTFILE=meoh_387.out
export CHKFILE=meoh_387.chk
export FCKFILE=meoh_387.fchk
export DNSFILE=meoh_387.d.cube
export ESPFILE=meoh_387.p.cube
