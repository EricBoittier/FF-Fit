...
export INPFILE=meoh_420.com
export OUTFILE=meoh_420.out
export CHKFILE=meoh_420.chk
export FCKFILE=meoh_420.fchk
export DNSFILE=meoh_420.d.cube
export ESPFILE=meoh_420.p.cube
