...
export INPFILE=meoh_203.com
export OUTFILE=meoh_203.out
export CHKFILE=meoh_203.chk
export FCKFILE=meoh_203.fchk
export DNSFILE=meoh_203.d.cube
export ESPFILE=meoh_203.p.cube
