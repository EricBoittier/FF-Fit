...
export INPFILE=meoh_333.com
export OUTFILE=meoh_333.out
export CHKFILE=meoh_333.chk
export FCKFILE=meoh_333.fchk
export DNSFILE=meoh_333.d.cube
export ESPFILE=meoh_333.p.cube
