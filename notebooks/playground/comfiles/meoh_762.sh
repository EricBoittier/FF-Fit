...
export INPFILE=meoh_762.com
export OUTFILE=meoh_762.out
export CHKFILE=meoh_762.chk
export FCKFILE=meoh_762.fchk
export DNSFILE=meoh_762.d.cube
export ESPFILE=meoh_762.p.cube
