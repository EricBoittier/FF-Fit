...
export INPFILE=meoh_707.com
export OUTFILE=meoh_707.out
export CHKFILE=meoh_707.chk
export FCKFILE=meoh_707.fchk
export DNSFILE=meoh_707.d.cube
export ESPFILE=meoh_707.p.cube
