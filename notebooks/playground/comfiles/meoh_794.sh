...
export INPFILE=meoh_794.com
export OUTFILE=meoh_794.out
export CHKFILE=meoh_794.chk
export FCKFILE=meoh_794.fchk
export DNSFILE=meoh_794.d.cube
export ESPFILE=meoh_794.p.cube
