...
export INPFILE=meoh_319.com
export OUTFILE=meoh_319.out
export CHKFILE=meoh_319.chk
export FCKFILE=meoh_319.fchk
export DNSFILE=meoh_319.d.cube
export ESPFILE=meoh_319.p.cube
