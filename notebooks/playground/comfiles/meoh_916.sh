...
export INPFILE=meoh_916.com
export OUTFILE=meoh_916.out
export CHKFILE=meoh_916.chk
export FCKFILE=meoh_916.fchk
export DNSFILE=meoh_916.d.cube
export ESPFILE=meoh_916.p.cube
