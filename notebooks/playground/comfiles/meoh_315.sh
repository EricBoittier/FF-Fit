...
export INPFILE=meoh_315.com
export OUTFILE=meoh_315.out
export CHKFILE=meoh_315.chk
export FCKFILE=meoh_315.fchk
export DNSFILE=meoh_315.d.cube
export ESPFILE=meoh_315.p.cube
