...
export INPFILE=meoh_373.com
export OUTFILE=meoh_373.out
export CHKFILE=meoh_373.chk
export FCKFILE=meoh_373.fchk
export DNSFILE=meoh_373.d.cube
export ESPFILE=meoh_373.p.cube
