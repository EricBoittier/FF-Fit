...
export INPFILE=meoh_866.com
export OUTFILE=meoh_866.out
export CHKFILE=meoh_866.chk
export FCKFILE=meoh_866.fchk
export DNSFILE=meoh_866.d.cube
export ESPFILE=meoh_866.p.cube
