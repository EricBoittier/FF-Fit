...
export INPFILE=meoh_168.com
export OUTFILE=meoh_168.out
export CHKFILE=meoh_168.chk
export FCKFILE=meoh_168.fchk
export DNSFILE=meoh_168.d.cube
export ESPFILE=meoh_168.p.cube
