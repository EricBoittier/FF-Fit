...
export INPFILE=meoh_532.com
export OUTFILE=meoh_532.out
export CHKFILE=meoh_532.chk
export FCKFILE=meoh_532.fchk
export DNSFILE=meoh_532.d.cube
export ESPFILE=meoh_532.p.cube
