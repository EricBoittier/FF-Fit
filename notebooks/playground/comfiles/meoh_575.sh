...
export INPFILE=meoh_575.com
export OUTFILE=meoh_575.out
export CHKFILE=meoh_575.chk
export FCKFILE=meoh_575.fchk
export DNSFILE=meoh_575.d.cube
export ESPFILE=meoh_575.p.cube
