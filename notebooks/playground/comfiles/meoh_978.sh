...
export INPFILE=meoh_978.com
export OUTFILE=meoh_978.out
export CHKFILE=meoh_978.chk
export FCKFILE=meoh_978.fchk
export DNSFILE=meoh_978.d.cube
export ESPFILE=meoh_978.p.cube
