...
export INPFILE=meoh_894.com
export OUTFILE=meoh_894.out
export CHKFILE=meoh_894.chk
export FCKFILE=meoh_894.fchk
export DNSFILE=meoh_894.d.cube
export ESPFILE=meoh_894.p.cube
