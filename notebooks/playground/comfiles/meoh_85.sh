...
export INPFILE=meoh_85.com
export OUTFILE=meoh_85.out
export CHKFILE=meoh_85.chk
export FCKFILE=meoh_85.fchk
export DNSFILE=meoh_85.d.cube
export ESPFILE=meoh_85.p.cube
