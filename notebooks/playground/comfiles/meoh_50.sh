...
export INPFILE=meoh_50.com
export OUTFILE=meoh_50.out
export CHKFILE=meoh_50.chk
export FCKFILE=meoh_50.fchk
export DNSFILE=meoh_50.d.cube
export ESPFILE=meoh_50.p.cube
