...
export INPFILE=meoh_123.com
export OUTFILE=meoh_123.out
export CHKFILE=meoh_123.chk
export FCKFILE=meoh_123.fchk
export DNSFILE=meoh_123.d.cube
export ESPFILE=meoh_123.p.cube
