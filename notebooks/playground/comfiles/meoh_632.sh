...
export INPFILE=meoh_632.com
export OUTFILE=meoh_632.out
export CHKFILE=meoh_632.chk
export FCKFILE=meoh_632.fchk
export DNSFILE=meoh_632.d.cube
export ESPFILE=meoh_632.p.cube
