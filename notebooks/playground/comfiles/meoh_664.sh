...
export INPFILE=meoh_664.com
export OUTFILE=meoh_664.out
export CHKFILE=meoh_664.chk
export FCKFILE=meoh_664.fchk
export DNSFILE=meoh_664.d.cube
export ESPFILE=meoh_664.p.cube
