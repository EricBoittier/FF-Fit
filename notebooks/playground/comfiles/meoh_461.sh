...
export INPFILE=meoh_461.com
export OUTFILE=meoh_461.out
export CHKFILE=meoh_461.chk
export FCKFILE=meoh_461.fchk
export DNSFILE=meoh_461.d.cube
export ESPFILE=meoh_461.p.cube
