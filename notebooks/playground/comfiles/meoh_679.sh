...
export INPFILE=meoh_679.com
export OUTFILE=meoh_679.out
export CHKFILE=meoh_679.chk
export FCKFILE=meoh_679.fchk
export DNSFILE=meoh_679.d.cube
export ESPFILE=meoh_679.p.cube
