...
export INPFILE=meoh_129.com
export OUTFILE=meoh_129.out
export CHKFILE=meoh_129.chk
export FCKFILE=meoh_129.fchk
export DNSFILE=meoh_129.d.cube
export ESPFILE=meoh_129.p.cube
