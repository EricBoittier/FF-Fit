...
export INPFILE=meoh_494.com
export OUTFILE=meoh_494.out
export CHKFILE=meoh_494.chk
export FCKFILE=meoh_494.fchk
export DNSFILE=meoh_494.d.cube
export ESPFILE=meoh_494.p.cube
