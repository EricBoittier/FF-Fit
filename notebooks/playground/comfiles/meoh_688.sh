...
export INPFILE=meoh_688.com
export OUTFILE=meoh_688.out
export CHKFILE=meoh_688.chk
export FCKFILE=meoh_688.fchk
export DNSFILE=meoh_688.d.cube
export ESPFILE=meoh_688.p.cube
