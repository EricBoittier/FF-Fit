...
export INPFILE=meoh_163.com
export OUTFILE=meoh_163.out
export CHKFILE=meoh_163.chk
export FCKFILE=meoh_163.fchk
export DNSFILE=meoh_163.d.cube
export ESPFILE=meoh_163.p.cube
