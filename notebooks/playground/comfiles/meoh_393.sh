...
export INPFILE=meoh_393.com
export OUTFILE=meoh_393.out
export CHKFILE=meoh_393.chk
export FCKFILE=meoh_393.fchk
export DNSFILE=meoh_393.d.cube
export ESPFILE=meoh_393.p.cube
