...
export INPFILE=meoh_258.com
export OUTFILE=meoh_258.out
export CHKFILE=meoh_258.chk
export FCKFILE=meoh_258.fchk
export DNSFILE=meoh_258.d.cube
export ESPFILE=meoh_258.p.cube
