...
export INPFILE=meoh_924.com
export OUTFILE=meoh_924.out
export CHKFILE=meoh_924.chk
export FCKFILE=meoh_924.fchk
export DNSFILE=meoh_924.d.cube
export ESPFILE=meoh_924.p.cube
