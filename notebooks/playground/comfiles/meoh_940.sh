...
export INPFILE=meoh_940.com
export OUTFILE=meoh_940.out
export CHKFILE=meoh_940.chk
export FCKFILE=meoh_940.fchk
export DNSFILE=meoh_940.d.cube
export ESPFILE=meoh_940.p.cube
