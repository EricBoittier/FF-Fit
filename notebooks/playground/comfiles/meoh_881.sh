...
export INPFILE=meoh_881.com
export OUTFILE=meoh_881.out
export CHKFILE=meoh_881.chk
export FCKFILE=meoh_881.fchk
export DNSFILE=meoh_881.d.cube
export ESPFILE=meoh_881.p.cube
