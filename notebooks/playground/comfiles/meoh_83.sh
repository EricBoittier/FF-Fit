...
export INPFILE=meoh_83.com
export OUTFILE=meoh_83.out
export CHKFILE=meoh_83.chk
export FCKFILE=meoh_83.fchk
export DNSFILE=meoh_83.d.cube
export ESPFILE=meoh_83.p.cube
