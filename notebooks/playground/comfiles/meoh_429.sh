...
export INPFILE=meoh_429.com
export OUTFILE=meoh_429.out
export CHKFILE=meoh_429.chk
export FCKFILE=meoh_429.fchk
export DNSFILE=meoh_429.d.cube
export ESPFILE=meoh_429.p.cube
