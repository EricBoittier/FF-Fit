...
export INPFILE=meoh_780.com
export OUTFILE=meoh_780.out
export CHKFILE=meoh_780.chk
export FCKFILE=meoh_780.fchk
export DNSFILE=meoh_780.d.cube
export ESPFILE=meoh_780.p.cube
