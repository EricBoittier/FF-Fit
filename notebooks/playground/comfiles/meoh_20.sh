...
export INPFILE=meoh_20.com
export OUTFILE=meoh_20.out
export CHKFILE=meoh_20.chk
export FCKFILE=meoh_20.fchk
export DNSFILE=meoh_20.d.cube
export ESPFILE=meoh_20.p.cube
