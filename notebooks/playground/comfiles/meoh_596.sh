...
export INPFILE=meoh_596.com
export OUTFILE=meoh_596.out
export CHKFILE=meoh_596.chk
export FCKFILE=meoh_596.fchk
export DNSFILE=meoh_596.d.cube
export ESPFILE=meoh_596.p.cube
