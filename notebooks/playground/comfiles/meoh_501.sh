...
export INPFILE=meoh_501.com
export OUTFILE=meoh_501.out
export CHKFILE=meoh_501.chk
export FCKFILE=meoh_501.fchk
export DNSFILE=meoh_501.d.cube
export ESPFILE=meoh_501.p.cube
