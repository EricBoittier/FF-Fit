...
export INPFILE=meoh_670.com
export OUTFILE=meoh_670.out
export CHKFILE=meoh_670.chk
export FCKFILE=meoh_670.fchk
export DNSFILE=meoh_670.d.cube
export ESPFILE=meoh_670.p.cube
