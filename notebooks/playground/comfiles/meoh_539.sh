...
export INPFILE=meoh_539.com
export OUTFILE=meoh_539.out
export CHKFILE=meoh_539.chk
export FCKFILE=meoh_539.fchk
export DNSFILE=meoh_539.d.cube
export ESPFILE=meoh_539.p.cube
