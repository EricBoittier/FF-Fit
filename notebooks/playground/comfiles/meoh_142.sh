...
export INPFILE=meoh_142.com
export OUTFILE=meoh_142.out
export CHKFILE=meoh_142.chk
export FCKFILE=meoh_142.fchk
export DNSFILE=meoh_142.d.cube
export ESPFILE=meoh_142.p.cube
