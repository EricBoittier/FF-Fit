...
export INPFILE=meoh_409.com
export OUTFILE=meoh_409.out
export CHKFILE=meoh_409.chk
export FCKFILE=meoh_409.fchk
export DNSFILE=meoh_409.d.cube
export ESPFILE=meoh_409.p.cube
