...
export INPFILE=meoh_989.com
export OUTFILE=meoh_989.out
export CHKFILE=meoh_989.chk
export FCKFILE=meoh_989.fchk
export DNSFILE=meoh_989.d.cube
export ESPFILE=meoh_989.p.cube
