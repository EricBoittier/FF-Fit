...
export INPFILE=meoh_238.com
export OUTFILE=meoh_238.out
export CHKFILE=meoh_238.chk
export FCKFILE=meoh_238.fchk
export DNSFILE=meoh_238.d.cube
export ESPFILE=meoh_238.p.cube
