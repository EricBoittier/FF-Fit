...
export INPFILE=meoh_484.com
export OUTFILE=meoh_484.out
export CHKFILE=meoh_484.chk
export FCKFILE=meoh_484.fchk
export DNSFILE=meoh_484.d.cube
export ESPFILE=meoh_484.p.cube
