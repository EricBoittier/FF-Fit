...
export INPFILE=meoh_340.com
export OUTFILE=meoh_340.out
export CHKFILE=meoh_340.chk
export FCKFILE=meoh_340.fchk
export DNSFILE=meoh_340.d.cube
export ESPFILE=meoh_340.p.cube
