...
export INPFILE=meoh_902.com
export OUTFILE=meoh_902.out
export CHKFILE=meoh_902.chk
export FCKFILE=meoh_902.fchk
export DNSFILE=meoh_902.d.cube
export ESPFILE=meoh_902.p.cube
