...
export INPFILE=meoh_410.com
export OUTFILE=meoh_410.out
export CHKFILE=meoh_410.chk
export FCKFILE=meoh_410.fchk
export DNSFILE=meoh_410.d.cube
export ESPFILE=meoh_410.p.cube
