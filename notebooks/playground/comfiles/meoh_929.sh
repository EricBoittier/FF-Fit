...
export INPFILE=meoh_929.com
export OUTFILE=meoh_929.out
export CHKFILE=meoh_929.chk
export FCKFILE=meoh_929.fchk
export DNSFILE=meoh_929.d.cube
export ESPFILE=meoh_929.p.cube
