...
export INPFILE=meoh_269.com
export OUTFILE=meoh_269.out
export CHKFILE=meoh_269.chk
export FCKFILE=meoh_269.fchk
export DNSFILE=meoh_269.d.cube
export ESPFILE=meoh_269.p.cube
