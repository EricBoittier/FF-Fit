...
export INPFILE=meoh_727.com
export OUTFILE=meoh_727.out
export CHKFILE=meoh_727.chk
export FCKFILE=meoh_727.fchk
export DNSFILE=meoh_727.d.cube
export ESPFILE=meoh_727.p.cube
