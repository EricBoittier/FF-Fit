...
export INPFILE=meoh_870.com
export OUTFILE=meoh_870.out
export CHKFILE=meoh_870.chk
export FCKFILE=meoh_870.fchk
export DNSFILE=meoh_870.d.cube
export ESPFILE=meoh_870.p.cube
