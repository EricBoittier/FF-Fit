...
export INPFILE=meoh_271.com
export OUTFILE=meoh_271.out
export CHKFILE=meoh_271.chk
export FCKFILE=meoh_271.fchk
export DNSFILE=meoh_271.d.cube
export ESPFILE=meoh_271.p.cube
