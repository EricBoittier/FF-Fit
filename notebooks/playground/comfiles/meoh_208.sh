...
export INPFILE=meoh_208.com
export OUTFILE=meoh_208.out
export CHKFILE=meoh_208.chk
export FCKFILE=meoh_208.fchk
export DNSFILE=meoh_208.d.cube
export ESPFILE=meoh_208.p.cube
