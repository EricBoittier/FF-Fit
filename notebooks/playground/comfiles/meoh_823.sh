...
export INPFILE=meoh_823.com
export OUTFILE=meoh_823.out
export CHKFILE=meoh_823.chk
export FCKFILE=meoh_823.fchk
export DNSFILE=meoh_823.d.cube
export ESPFILE=meoh_823.p.cube
