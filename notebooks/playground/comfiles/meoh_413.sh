...
export INPFILE=meoh_413.com
export OUTFILE=meoh_413.out
export CHKFILE=meoh_413.chk
export FCKFILE=meoh_413.fchk
export DNSFILE=meoh_413.d.cube
export ESPFILE=meoh_413.p.cube
