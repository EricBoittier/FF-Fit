...
export INPFILE=meoh_201.com
export OUTFILE=meoh_201.out
export CHKFILE=meoh_201.chk
export FCKFILE=meoh_201.fchk
export DNSFILE=meoh_201.d.cube
export ESPFILE=meoh_201.p.cube
