...
export INPFILE=meoh_625.com
export OUTFILE=meoh_625.out
export CHKFILE=meoh_625.chk
export FCKFILE=meoh_625.fchk
export DNSFILE=meoh_625.d.cube
export ESPFILE=meoh_625.p.cube
