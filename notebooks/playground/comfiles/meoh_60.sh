...
export INPFILE=meoh_60.com
export OUTFILE=meoh_60.out
export CHKFILE=meoh_60.chk
export FCKFILE=meoh_60.fchk
export DNSFILE=meoh_60.d.cube
export ESPFILE=meoh_60.p.cube
