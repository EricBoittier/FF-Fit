...
export INPFILE=meoh_332.com
export OUTFILE=meoh_332.out
export CHKFILE=meoh_332.chk
export FCKFILE=meoh_332.fchk
export DNSFILE=meoh_332.d.cube
export ESPFILE=meoh_332.p.cube
