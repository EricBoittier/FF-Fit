...
export INPFILE=meoh_889.com
export OUTFILE=meoh_889.out
export CHKFILE=meoh_889.chk
export FCKFILE=meoh_889.fchk
export DNSFILE=meoh_889.d.cube
export ESPFILE=meoh_889.p.cube
