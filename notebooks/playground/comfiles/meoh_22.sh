...
export INPFILE=meoh_22.com
export OUTFILE=meoh_22.out
export CHKFILE=meoh_22.chk
export FCKFILE=meoh_22.fchk
export DNSFILE=meoh_22.d.cube
export ESPFILE=meoh_22.p.cube
