...
export INPFILE=meoh_962.com
export OUTFILE=meoh_962.out
export CHKFILE=meoh_962.chk
export FCKFILE=meoh_962.fchk
export DNSFILE=meoh_962.d.cube
export ESPFILE=meoh_962.p.cube
