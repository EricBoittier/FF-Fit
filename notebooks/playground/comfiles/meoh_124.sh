...
export INPFILE=meoh_124.com
export OUTFILE=meoh_124.out
export CHKFILE=meoh_124.chk
export FCKFILE=meoh_124.fchk
export DNSFILE=meoh_124.d.cube
export ESPFILE=meoh_124.p.cube
