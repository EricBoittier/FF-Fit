...
export INPFILE=meoh_119.com
export OUTFILE=meoh_119.out
export CHKFILE=meoh_119.chk
export FCKFILE=meoh_119.fchk
export DNSFILE=meoh_119.d.cube
export ESPFILE=meoh_119.p.cube
