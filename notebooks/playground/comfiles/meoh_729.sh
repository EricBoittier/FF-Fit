...
export INPFILE=meoh_729.com
export OUTFILE=meoh_729.out
export CHKFILE=meoh_729.chk
export FCKFILE=meoh_729.fchk
export DNSFILE=meoh_729.d.cube
export ESPFILE=meoh_729.p.cube
