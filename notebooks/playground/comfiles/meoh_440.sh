...
export INPFILE=meoh_440.com
export OUTFILE=meoh_440.out
export CHKFILE=meoh_440.chk
export FCKFILE=meoh_440.fchk
export DNSFILE=meoh_440.d.cube
export ESPFILE=meoh_440.p.cube
