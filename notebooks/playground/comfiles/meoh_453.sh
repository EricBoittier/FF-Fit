...
export INPFILE=meoh_453.com
export OUTFILE=meoh_453.out
export CHKFILE=meoh_453.chk
export FCKFILE=meoh_453.fchk
export DNSFILE=meoh_453.d.cube
export ESPFILE=meoh_453.p.cube
