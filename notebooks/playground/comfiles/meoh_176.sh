...
export INPFILE=meoh_176.com
export OUTFILE=meoh_176.out
export CHKFILE=meoh_176.chk
export FCKFILE=meoh_176.fchk
export DNSFILE=meoh_176.d.cube
export ESPFILE=meoh_176.p.cube
