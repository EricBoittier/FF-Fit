...
export INPFILE=meoh_127.com
export OUTFILE=meoh_127.out
export CHKFILE=meoh_127.chk
export FCKFILE=meoh_127.fchk
export DNSFILE=meoh_127.d.cube
export ESPFILE=meoh_127.p.cube
