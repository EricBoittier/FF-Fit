...
export INPFILE=meoh_627.com
export OUTFILE=meoh_627.out
export CHKFILE=meoh_627.chk
export FCKFILE=meoh_627.fchk
export DNSFILE=meoh_627.d.cube
export ESPFILE=meoh_627.p.cube
