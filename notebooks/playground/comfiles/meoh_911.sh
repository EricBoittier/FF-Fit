...
export INPFILE=meoh_911.com
export OUTFILE=meoh_911.out
export CHKFILE=meoh_911.chk
export FCKFILE=meoh_911.fchk
export DNSFILE=meoh_911.d.cube
export ESPFILE=meoh_911.p.cube
