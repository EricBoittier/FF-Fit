...
export INPFILE=meoh_587.com
export OUTFILE=meoh_587.out
export CHKFILE=meoh_587.chk
export FCKFILE=meoh_587.fchk
export DNSFILE=meoh_587.d.cube
export ESPFILE=meoh_587.p.cube
