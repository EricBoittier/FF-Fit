...
export INPFILE=meoh_251.com
export OUTFILE=meoh_251.out
export CHKFILE=meoh_251.chk
export FCKFILE=meoh_251.fchk
export DNSFILE=meoh_251.d.cube
export ESPFILE=meoh_251.p.cube
