...
export INPFILE=meoh_899.com
export OUTFILE=meoh_899.out
export CHKFILE=meoh_899.chk
export FCKFILE=meoh_899.fchk
export DNSFILE=meoh_899.d.cube
export ESPFILE=meoh_899.p.cube
