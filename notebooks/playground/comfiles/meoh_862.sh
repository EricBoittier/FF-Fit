...
export INPFILE=meoh_862.com
export OUTFILE=meoh_862.out
export CHKFILE=meoh_862.chk
export FCKFILE=meoh_862.fchk
export DNSFILE=meoh_862.d.cube
export ESPFILE=meoh_862.p.cube
