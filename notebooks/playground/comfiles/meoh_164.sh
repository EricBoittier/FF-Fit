...
export INPFILE=meoh_164.com
export OUTFILE=meoh_164.out
export CHKFILE=meoh_164.chk
export FCKFILE=meoh_164.fchk
export DNSFILE=meoh_164.d.cube
export ESPFILE=meoh_164.p.cube
