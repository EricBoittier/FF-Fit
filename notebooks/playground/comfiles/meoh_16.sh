...
export INPFILE=meoh_16.com
export OUTFILE=meoh_16.out
export CHKFILE=meoh_16.chk
export FCKFILE=meoh_16.fchk
export DNSFILE=meoh_16.d.cube
export ESPFILE=meoh_16.p.cube
