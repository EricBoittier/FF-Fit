...
export INPFILE=meoh_546.com
export OUTFILE=meoh_546.out
export CHKFILE=meoh_546.chk
export FCKFILE=meoh_546.fchk
export DNSFILE=meoh_546.d.cube
export ESPFILE=meoh_546.p.cube
