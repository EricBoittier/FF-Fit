...
export INPFILE=meoh_807.com
export OUTFILE=meoh_807.out
export CHKFILE=meoh_807.chk
export FCKFILE=meoh_807.fchk
export DNSFILE=meoh_807.d.cube
export ESPFILE=meoh_807.p.cube
