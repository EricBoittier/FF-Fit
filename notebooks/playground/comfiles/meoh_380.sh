...
export INPFILE=meoh_380.com
export OUTFILE=meoh_380.out
export CHKFILE=meoh_380.chk
export FCKFILE=meoh_380.fchk
export DNSFILE=meoh_380.d.cube
export ESPFILE=meoh_380.p.cube
