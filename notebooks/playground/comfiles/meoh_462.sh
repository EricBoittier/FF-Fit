...
export INPFILE=meoh_462.com
export OUTFILE=meoh_462.out
export CHKFILE=meoh_462.chk
export FCKFILE=meoh_462.fchk
export DNSFILE=meoh_462.d.cube
export ESPFILE=meoh_462.p.cube
