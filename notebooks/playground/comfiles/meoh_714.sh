...
export INPFILE=meoh_714.com
export OUTFILE=meoh_714.out
export CHKFILE=meoh_714.chk
export FCKFILE=meoh_714.fchk
export DNSFILE=meoh_714.d.cube
export ESPFILE=meoh_714.p.cube
