...
export INPFILE=meoh_977.com
export OUTFILE=meoh_977.out
export CHKFILE=meoh_977.chk
export FCKFILE=meoh_977.fchk
export DNSFILE=meoh_977.d.cube
export ESPFILE=meoh_977.p.cube
