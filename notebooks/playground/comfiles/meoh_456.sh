...
export INPFILE=meoh_456.com
export OUTFILE=meoh_456.out
export CHKFILE=meoh_456.chk
export FCKFILE=meoh_456.fchk
export DNSFILE=meoh_456.d.cube
export ESPFILE=meoh_456.p.cube
