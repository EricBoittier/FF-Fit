...
export INPFILE=meoh_72.com
export OUTFILE=meoh_72.out
export CHKFILE=meoh_72.chk
export FCKFILE=meoh_72.fchk
export DNSFILE=meoh_72.d.cube
export ESPFILE=meoh_72.p.cube
