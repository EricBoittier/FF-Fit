...
export INPFILE=meoh_470.com
export OUTFILE=meoh_470.out
export CHKFILE=meoh_470.chk
export FCKFILE=meoh_470.fchk
export DNSFILE=meoh_470.d.cube
export ESPFILE=meoh_470.p.cube
