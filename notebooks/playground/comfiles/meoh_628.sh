...
export INPFILE=meoh_628.com
export OUTFILE=meoh_628.out
export CHKFILE=meoh_628.chk
export FCKFILE=meoh_628.fchk
export DNSFILE=meoh_628.d.cube
export ESPFILE=meoh_628.p.cube
