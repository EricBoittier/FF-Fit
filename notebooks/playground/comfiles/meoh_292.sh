...
export INPFILE=meoh_292.com
export OUTFILE=meoh_292.out
export CHKFILE=meoh_292.chk
export FCKFILE=meoh_292.fchk
export DNSFILE=meoh_292.d.cube
export ESPFILE=meoh_292.p.cube
