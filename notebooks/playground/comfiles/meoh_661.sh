...
export INPFILE=meoh_661.com
export OUTFILE=meoh_661.out
export CHKFILE=meoh_661.chk
export FCKFILE=meoh_661.fchk
export DNSFILE=meoh_661.d.cube
export ESPFILE=meoh_661.p.cube
