...
export INPFILE=meoh_135.com
export OUTFILE=meoh_135.out
export CHKFILE=meoh_135.chk
export FCKFILE=meoh_135.fchk
export DNSFILE=meoh_135.d.cube
export ESPFILE=meoh_135.p.cube
