...
export INPFILE=meoh_528.com
export OUTFILE=meoh_528.out
export CHKFILE=meoh_528.chk
export FCKFILE=meoh_528.fchk
export DNSFILE=meoh_528.d.cube
export ESPFILE=meoh_528.p.cube
