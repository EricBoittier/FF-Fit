...
export INPFILE=meoh_741.com
export OUTFILE=meoh_741.out
export CHKFILE=meoh_741.chk
export FCKFILE=meoh_741.fchk
export DNSFILE=meoh_741.d.cube
export ESPFILE=meoh_741.p.cube
