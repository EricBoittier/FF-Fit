...
export INPFILE=meoh_454.com
export OUTFILE=meoh_454.out
export CHKFILE=meoh_454.chk
export FCKFILE=meoh_454.fchk
export DNSFILE=meoh_454.d.cube
export ESPFILE=meoh_454.p.cube
