...
export INPFILE=meoh_937.com
export OUTFILE=meoh_937.out
export CHKFILE=meoh_937.chk
export FCKFILE=meoh_937.fchk
export DNSFILE=meoh_937.d.cube
export ESPFILE=meoh_937.p.cube
