...
export INPFILE=meoh_818.com
export OUTFILE=meoh_818.out
export CHKFILE=meoh_818.chk
export FCKFILE=meoh_818.fchk
export DNSFILE=meoh_818.d.cube
export ESPFILE=meoh_818.p.cube
