...
export INPFILE=meoh_88.com
export OUTFILE=meoh_88.out
export CHKFILE=meoh_88.chk
export FCKFILE=meoh_88.fchk
export DNSFILE=meoh_88.d.cube
export ESPFILE=meoh_88.p.cube
