...
export INPFILE=meoh_847.com
export OUTFILE=meoh_847.out
export CHKFILE=meoh_847.chk
export FCKFILE=meoh_847.fchk
export DNSFILE=meoh_847.d.cube
export ESPFILE=meoh_847.p.cube
