...
export INPFILE=meoh_111.com
export OUTFILE=meoh_111.out
export CHKFILE=meoh_111.chk
export FCKFILE=meoh_111.fchk
export DNSFILE=meoh_111.d.cube
export ESPFILE=meoh_111.p.cube
