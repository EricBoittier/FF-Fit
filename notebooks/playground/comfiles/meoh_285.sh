...
export INPFILE=meoh_285.com
export OUTFILE=meoh_285.out
export CHKFILE=meoh_285.chk
export FCKFILE=meoh_285.fchk
export DNSFILE=meoh_285.d.cube
export ESPFILE=meoh_285.p.cube
