...
export INPFILE=meoh_140.com
export OUTFILE=meoh_140.out
export CHKFILE=meoh_140.chk
export FCKFILE=meoh_140.fchk
export DNSFILE=meoh_140.d.cube
export ESPFILE=meoh_140.p.cube
