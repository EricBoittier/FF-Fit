...
export INPFILE=meoh_541.com
export OUTFILE=meoh_541.out
export CHKFILE=meoh_541.chk
export FCKFILE=meoh_541.fchk
export DNSFILE=meoh_541.d.cube
export ESPFILE=meoh_541.p.cube
