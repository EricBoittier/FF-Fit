...
export INPFILE=meoh_181.com
export OUTFILE=meoh_181.out
export CHKFILE=meoh_181.chk
export FCKFILE=meoh_181.fchk
export DNSFILE=meoh_181.d.cube
export ESPFILE=meoh_181.p.cube
