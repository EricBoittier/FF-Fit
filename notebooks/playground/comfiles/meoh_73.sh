...
export INPFILE=meoh_73.com
export OUTFILE=meoh_73.out
export CHKFILE=meoh_73.chk
export FCKFILE=meoh_73.fchk
export DNSFILE=meoh_73.d.cube
export ESPFILE=meoh_73.p.cube
