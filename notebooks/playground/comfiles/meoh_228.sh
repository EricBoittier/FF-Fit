...
export INPFILE=meoh_228.com
export OUTFILE=meoh_228.out
export CHKFILE=meoh_228.chk
export FCKFILE=meoh_228.fchk
export DNSFILE=meoh_228.d.cube
export ESPFILE=meoh_228.p.cube
