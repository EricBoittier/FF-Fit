...
export INPFILE=meoh_586.com
export OUTFILE=meoh_586.out
export CHKFILE=meoh_586.chk
export FCKFILE=meoh_586.fchk
export DNSFILE=meoh_586.d.cube
export ESPFILE=meoh_586.p.cube
