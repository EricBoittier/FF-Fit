...
export INPFILE=meoh_694.com
export OUTFILE=meoh_694.out
export CHKFILE=meoh_694.chk
export FCKFILE=meoh_694.fchk
export DNSFILE=meoh_694.d.cube
export ESPFILE=meoh_694.p.cube
