...
export INPFILE=meoh_922.com
export OUTFILE=meoh_922.out
export CHKFILE=meoh_922.chk
export FCKFILE=meoh_922.fchk
export DNSFILE=meoh_922.d.cube
export ESPFILE=meoh_922.p.cube
