...
export INPFILE=meoh_230.com
export OUTFILE=meoh_230.out
export CHKFILE=meoh_230.chk
export FCKFILE=meoh_230.fchk
export DNSFILE=meoh_230.d.cube
export ESPFILE=meoh_230.p.cube
