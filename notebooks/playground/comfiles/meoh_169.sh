...
export INPFILE=meoh_169.com
export OUTFILE=meoh_169.out
export CHKFILE=meoh_169.chk
export FCKFILE=meoh_169.fchk
export DNSFILE=meoh_169.d.cube
export ESPFILE=meoh_169.p.cube
