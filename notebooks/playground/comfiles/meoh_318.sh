...
export INPFILE=meoh_318.com
export OUTFILE=meoh_318.out
export CHKFILE=meoh_318.chk
export FCKFILE=meoh_318.fchk
export DNSFILE=meoh_318.d.cube
export ESPFILE=meoh_318.p.cube
