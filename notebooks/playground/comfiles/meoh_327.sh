...
export INPFILE=meoh_327.com
export OUTFILE=meoh_327.out
export CHKFILE=meoh_327.chk
export FCKFILE=meoh_327.fchk
export DNSFILE=meoh_327.d.cube
export ESPFILE=meoh_327.p.cube
