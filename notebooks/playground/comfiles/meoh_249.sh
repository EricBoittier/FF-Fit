...
export INPFILE=meoh_249.com
export OUTFILE=meoh_249.out
export CHKFILE=meoh_249.chk
export FCKFILE=meoh_249.fchk
export DNSFILE=meoh_249.d.cube
export ESPFILE=meoh_249.p.cube
