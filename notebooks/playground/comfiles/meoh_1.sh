...
export INPFILE=meoh_1.com
export OUTFILE=meoh_1.out
export CHKFILE=meoh_1.chk
export FCKFILE=meoh_1.fchk
export DNSFILE=meoh_1.d.cube
export ESPFILE=meoh_1.p.cube
