...
export INPFILE=meoh_971.com
export OUTFILE=meoh_971.out
export CHKFILE=meoh_971.chk
export FCKFILE=meoh_971.fchk
export DNSFILE=meoh_971.d.cube
export ESPFILE=meoh_971.p.cube
