...
export INPFILE=meoh_66.com
export OUTFILE=meoh_66.out
export CHKFILE=meoh_66.chk
export FCKFILE=meoh_66.fchk
export DNSFILE=meoh_66.d.cube
export ESPFILE=meoh_66.p.cube
