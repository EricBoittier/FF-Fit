...
export INPFILE=meoh_8.com
export OUTFILE=meoh_8.out
export CHKFILE=meoh_8.chk
export FCKFILE=meoh_8.fchk
export DNSFILE=meoh_8.d.cube
export ESPFILE=meoh_8.p.cube
