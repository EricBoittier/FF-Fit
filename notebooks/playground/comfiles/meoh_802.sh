...
export INPFILE=meoh_802.com
export OUTFILE=meoh_802.out
export CHKFILE=meoh_802.chk
export FCKFILE=meoh_802.fchk
export DNSFILE=meoh_802.d.cube
export ESPFILE=meoh_802.p.cube
