...
export INPFILE=meoh_671.com
export OUTFILE=meoh_671.out
export CHKFILE=meoh_671.chk
export FCKFILE=meoh_671.fchk
export DNSFILE=meoh_671.d.cube
export ESPFILE=meoh_671.p.cube
