...
export INPFILE=meoh_472.com
export OUTFILE=meoh_472.out
export CHKFILE=meoh_472.chk
export FCKFILE=meoh_472.fchk
export DNSFILE=meoh_472.d.cube
export ESPFILE=meoh_472.p.cube
