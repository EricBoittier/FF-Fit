...
export INPFILE=meoh_280.com
export OUTFILE=meoh_280.out
export CHKFILE=meoh_280.chk
export FCKFILE=meoh_280.fchk
export DNSFILE=meoh_280.d.cube
export ESPFILE=meoh_280.p.cube
