...
export INPFILE=meoh_544.com
export OUTFILE=meoh_544.out
export CHKFILE=meoh_544.chk
export FCKFILE=meoh_544.fchk
export DNSFILE=meoh_544.d.cube
export ESPFILE=meoh_544.p.cube
