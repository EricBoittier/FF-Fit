...
export INPFILE=meoh_954.com
export OUTFILE=meoh_954.out
export CHKFILE=meoh_954.chk
export FCKFILE=meoh_954.fchk
export DNSFILE=meoh_954.d.cube
export ESPFILE=meoh_954.p.cube
