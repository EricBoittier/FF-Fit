...
export INPFILE=meoh_612.com
export OUTFILE=meoh_612.out
export CHKFILE=meoh_612.chk
export FCKFILE=meoh_612.fchk
export DNSFILE=meoh_612.d.cube
export ESPFILE=meoh_612.p.cube
