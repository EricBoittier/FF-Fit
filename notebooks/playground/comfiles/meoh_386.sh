...
export INPFILE=meoh_386.com
export OUTFILE=meoh_386.out
export CHKFILE=meoh_386.chk
export FCKFILE=meoh_386.fchk
export DNSFILE=meoh_386.d.cube
export ESPFILE=meoh_386.p.cube
