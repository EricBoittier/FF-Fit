...
export INPFILE=meoh_31.com
export OUTFILE=meoh_31.out
export CHKFILE=meoh_31.chk
export FCKFILE=meoh_31.fchk
export DNSFILE=meoh_31.d.cube
export ESPFILE=meoh_31.p.cube
