...
export INPFILE=meoh_150.com
export OUTFILE=meoh_150.out
export CHKFILE=meoh_150.chk
export FCKFILE=meoh_150.fchk
export DNSFILE=meoh_150.d.cube
export ESPFILE=meoh_150.p.cube
