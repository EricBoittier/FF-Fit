...
export INPFILE=meoh_248.com
export OUTFILE=meoh_248.out
export CHKFILE=meoh_248.chk
export FCKFILE=meoh_248.fchk
export DNSFILE=meoh_248.d.cube
export ESPFILE=meoh_248.p.cube
