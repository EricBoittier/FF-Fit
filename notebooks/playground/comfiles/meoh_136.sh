...
export INPFILE=meoh_136.com
export OUTFILE=meoh_136.out
export CHKFILE=meoh_136.chk
export FCKFILE=meoh_136.fchk
export DNSFILE=meoh_136.d.cube
export ESPFILE=meoh_136.p.cube
