...
export INPFILE=meoh_706.com
export OUTFILE=meoh_706.out
export CHKFILE=meoh_706.chk
export FCKFILE=meoh_706.fchk
export DNSFILE=meoh_706.d.cube
export ESPFILE=meoh_706.p.cube
