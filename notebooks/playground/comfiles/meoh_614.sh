...
export INPFILE=meoh_614.com
export OUTFILE=meoh_614.out
export CHKFILE=meoh_614.chk
export FCKFILE=meoh_614.fchk
export DNSFILE=meoh_614.d.cube
export ESPFILE=meoh_614.p.cube
