...
export INPFILE=meoh_401.com
export OUTFILE=meoh_401.out
export CHKFILE=meoh_401.chk
export FCKFILE=meoh_401.fchk
export DNSFILE=meoh_401.d.cube
export ESPFILE=meoh_401.p.cube
