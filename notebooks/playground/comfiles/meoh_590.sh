...
export INPFILE=meoh_590.com
export OUTFILE=meoh_590.out
export CHKFILE=meoh_590.chk
export FCKFILE=meoh_590.fchk
export DNSFILE=meoh_590.d.cube
export ESPFILE=meoh_590.p.cube
