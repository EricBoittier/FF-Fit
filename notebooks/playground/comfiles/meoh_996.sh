...
export INPFILE=meoh_996.com
export OUTFILE=meoh_996.out
export CHKFILE=meoh_996.chk
export FCKFILE=meoh_996.fchk
export DNSFILE=meoh_996.d.cube
export ESPFILE=meoh_996.p.cube
