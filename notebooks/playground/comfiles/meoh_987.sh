...
export INPFILE=meoh_987.com
export OUTFILE=meoh_987.out
export CHKFILE=meoh_987.chk
export FCKFILE=meoh_987.fchk
export DNSFILE=meoh_987.d.cube
export ESPFILE=meoh_987.p.cube
