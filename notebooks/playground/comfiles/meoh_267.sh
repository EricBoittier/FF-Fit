...
export INPFILE=meoh_267.com
export OUTFILE=meoh_267.out
export CHKFILE=meoh_267.chk
export FCKFILE=meoh_267.fchk
export DNSFILE=meoh_267.d.cube
export ESPFILE=meoh_267.p.cube
