...
export INPFILE=meoh_134.com
export OUTFILE=meoh_134.out
export CHKFILE=meoh_134.chk
export FCKFILE=meoh_134.fchk
export DNSFILE=meoh_134.d.cube
export ESPFILE=meoh_134.p.cube
