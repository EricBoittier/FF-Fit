...
export INPFILE=meoh_10.com
export OUTFILE=meoh_10.out
export CHKFILE=meoh_10.chk
export FCKFILE=meoh_10.fchk
export DNSFILE=meoh_10.d.cube
export ESPFILE=meoh_10.p.cube
