...
export INPFILE=meoh_388.com
export OUTFILE=meoh_388.out
export CHKFILE=meoh_388.chk
export FCKFILE=meoh_388.fchk
export DNSFILE=meoh_388.d.cube
export ESPFILE=meoh_388.p.cube
