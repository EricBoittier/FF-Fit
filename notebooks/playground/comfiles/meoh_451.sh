...
export INPFILE=meoh_451.com
export OUTFILE=meoh_451.out
export CHKFILE=meoh_451.chk
export FCKFILE=meoh_451.fchk
export DNSFILE=meoh_451.d.cube
export ESPFILE=meoh_451.p.cube
