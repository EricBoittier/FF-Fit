...
export INPFILE=meoh_194.com
export OUTFILE=meoh_194.out
export CHKFILE=meoh_194.chk
export FCKFILE=meoh_194.fchk
export DNSFILE=meoh_194.d.cube
export ESPFILE=meoh_194.p.cube
