...
export INPFILE=meoh_973.com
export OUTFILE=meoh_973.out
export CHKFILE=meoh_973.chk
export FCKFILE=meoh_973.fchk
export DNSFILE=meoh_973.d.cube
export ESPFILE=meoh_973.p.cube
