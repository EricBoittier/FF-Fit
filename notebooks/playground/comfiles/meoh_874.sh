...
export INPFILE=meoh_874.com
export OUTFILE=meoh_874.out
export CHKFILE=meoh_874.chk
export FCKFILE=meoh_874.fchk
export DNSFILE=meoh_874.d.cube
export ESPFILE=meoh_874.p.cube
