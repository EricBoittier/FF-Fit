...
export INPFILE=meoh_5.com
export OUTFILE=meoh_5.out
export CHKFILE=meoh_5.chk
export FCKFILE=meoh_5.fchk
export DNSFILE=meoh_5.d.cube
export ESPFILE=meoh_5.p.cube
