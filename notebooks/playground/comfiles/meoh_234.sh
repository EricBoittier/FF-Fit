...
export INPFILE=meoh_234.com
export OUTFILE=meoh_234.out
export CHKFILE=meoh_234.chk
export FCKFILE=meoh_234.fchk
export DNSFILE=meoh_234.d.cube
export ESPFILE=meoh_234.p.cube
