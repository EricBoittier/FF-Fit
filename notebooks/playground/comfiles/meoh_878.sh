...
export INPFILE=meoh_878.com
export OUTFILE=meoh_878.out
export CHKFILE=meoh_878.chk
export FCKFILE=meoh_878.fchk
export DNSFILE=meoh_878.d.cube
export ESPFILE=meoh_878.p.cube
