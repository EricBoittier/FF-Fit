...
export INPFILE=meoh_268.com
export OUTFILE=meoh_268.out
export CHKFILE=meoh_268.chk
export FCKFILE=meoh_268.fchk
export DNSFILE=meoh_268.d.cube
export ESPFILE=meoh_268.p.cube
