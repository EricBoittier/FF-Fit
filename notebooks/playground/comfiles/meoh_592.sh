...
export INPFILE=meoh_592.com
export OUTFILE=meoh_592.out
export CHKFILE=meoh_592.chk
export FCKFILE=meoh_592.fchk
export DNSFILE=meoh_592.d.cube
export ESPFILE=meoh_592.p.cube
