...
export INPFILE=meoh_512.com
export OUTFILE=meoh_512.out
export CHKFILE=meoh_512.chk
export FCKFILE=meoh_512.fchk
export DNSFILE=meoh_512.d.cube
export ESPFILE=meoh_512.p.cube
