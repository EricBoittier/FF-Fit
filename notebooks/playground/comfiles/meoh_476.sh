...
export INPFILE=meoh_476.com
export OUTFILE=meoh_476.out
export CHKFILE=meoh_476.chk
export FCKFILE=meoh_476.fchk
export DNSFILE=meoh_476.d.cube
export ESPFILE=meoh_476.p.cube
