...
export INPFILE=meoh_755.com
export OUTFILE=meoh_755.out
export CHKFILE=meoh_755.chk
export FCKFILE=meoh_755.fchk
export DNSFILE=meoh_755.d.cube
export ESPFILE=meoh_755.p.cube
