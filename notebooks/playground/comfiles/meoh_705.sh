...
export INPFILE=meoh_705.com
export OUTFILE=meoh_705.out
export CHKFILE=meoh_705.chk
export FCKFILE=meoh_705.fchk
export DNSFILE=meoh_705.d.cube
export ESPFILE=meoh_705.p.cube
