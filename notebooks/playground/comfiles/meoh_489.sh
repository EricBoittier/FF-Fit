...
export INPFILE=meoh_489.com
export OUTFILE=meoh_489.out
export CHKFILE=meoh_489.chk
export FCKFILE=meoh_489.fchk
export DNSFILE=meoh_489.d.cube
export ESPFILE=meoh_489.p.cube
