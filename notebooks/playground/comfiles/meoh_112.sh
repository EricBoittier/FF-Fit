...
export INPFILE=meoh_112.com
export OUTFILE=meoh_112.out
export CHKFILE=meoh_112.chk
export FCKFILE=meoh_112.fchk
export DNSFILE=meoh_112.d.cube
export ESPFILE=meoh_112.p.cube
