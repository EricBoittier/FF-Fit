...
export INPFILE=meoh_787.com
export OUTFILE=meoh_787.out
export CHKFILE=meoh_787.chk
export FCKFILE=meoh_787.fchk
export DNSFILE=meoh_787.d.cube
export ESPFILE=meoh_787.p.cube
