...
export INPFILE=meoh_15.com
export OUTFILE=meoh_15.out
export CHKFILE=meoh_15.chk
export FCKFILE=meoh_15.fchk
export DNSFILE=meoh_15.d.cube
export ESPFILE=meoh_15.p.cube
