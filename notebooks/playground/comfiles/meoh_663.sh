...
export INPFILE=meoh_663.com
export OUTFILE=meoh_663.out
export CHKFILE=meoh_663.chk
export FCKFILE=meoh_663.fchk
export DNSFILE=meoh_663.d.cube
export ESPFILE=meoh_663.p.cube
