...
export INPFILE=meoh_296.com
export OUTFILE=meoh_296.out
export CHKFILE=meoh_296.chk
export FCKFILE=meoh_296.fchk
export DNSFILE=meoh_296.d.cube
export ESPFILE=meoh_296.p.cube
