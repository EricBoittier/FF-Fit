...
export INPFILE=meoh_383.com
export OUTFILE=meoh_383.out
export CHKFILE=meoh_383.chk
export FCKFILE=meoh_383.fchk
export DNSFILE=meoh_383.d.cube
export ESPFILE=meoh_383.p.cube
