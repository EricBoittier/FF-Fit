...
export INPFILE=meoh_171.com
export OUTFILE=meoh_171.out
export CHKFILE=meoh_171.chk
export FCKFILE=meoh_171.fchk
export DNSFILE=meoh_171.d.cube
export ESPFILE=meoh_171.p.cube
