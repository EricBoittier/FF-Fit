...
export INPFILE=meoh_110.com
export OUTFILE=meoh_110.out
export CHKFILE=meoh_110.chk
export FCKFILE=meoh_110.fchk
export DNSFILE=meoh_110.d.cube
export ESPFILE=meoh_110.p.cube
