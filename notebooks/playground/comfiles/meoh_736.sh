...
export INPFILE=meoh_736.com
export OUTFILE=meoh_736.out
export CHKFILE=meoh_736.chk
export FCKFILE=meoh_736.fchk
export DNSFILE=meoh_736.d.cube
export ESPFILE=meoh_736.p.cube
