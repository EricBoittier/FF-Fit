...
export INPFILE=meoh_726.com
export OUTFILE=meoh_726.out
export CHKFILE=meoh_726.chk
export FCKFILE=meoh_726.fchk
export DNSFILE=meoh_726.d.cube
export ESPFILE=meoh_726.p.cube
