...
export INPFILE=meoh_193.com
export OUTFILE=meoh_193.out
export CHKFILE=meoh_193.chk
export FCKFILE=meoh_193.fchk
export DNSFILE=meoh_193.d.cube
export ESPFILE=meoh_193.p.cube
