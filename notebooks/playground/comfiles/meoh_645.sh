...
export INPFILE=meoh_645.com
export OUTFILE=meoh_645.out
export CHKFILE=meoh_645.chk
export FCKFILE=meoh_645.fchk
export DNSFILE=meoh_645.d.cube
export ESPFILE=meoh_645.p.cube
