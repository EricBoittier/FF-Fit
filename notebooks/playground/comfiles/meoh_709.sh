...
export INPFILE=meoh_709.com
export OUTFILE=meoh_709.out
export CHKFILE=meoh_709.chk
export FCKFILE=meoh_709.fchk
export DNSFILE=meoh_709.d.cube
export ESPFILE=meoh_709.p.cube
