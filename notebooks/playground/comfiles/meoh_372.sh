...
export INPFILE=meoh_372.com
export OUTFILE=meoh_372.out
export CHKFILE=meoh_372.chk
export FCKFILE=meoh_372.fchk
export DNSFILE=meoh_372.d.cube
export ESPFILE=meoh_372.p.cube
