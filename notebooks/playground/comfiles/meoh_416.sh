...
export INPFILE=meoh_416.com
export OUTFILE=meoh_416.out
export CHKFILE=meoh_416.chk
export FCKFILE=meoh_416.fchk
export DNSFILE=meoh_416.d.cube
export ESPFILE=meoh_416.p.cube
