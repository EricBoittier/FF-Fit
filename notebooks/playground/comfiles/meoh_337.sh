...
export INPFILE=meoh_337.com
export OUTFILE=meoh_337.out
export CHKFILE=meoh_337.chk
export FCKFILE=meoh_337.fchk
export DNSFILE=meoh_337.d.cube
export ESPFILE=meoh_337.p.cube
