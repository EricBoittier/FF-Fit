...
export INPFILE=meoh_178.com
export OUTFILE=meoh_178.out
export CHKFILE=meoh_178.chk
export FCKFILE=meoh_178.fchk
export DNSFILE=meoh_178.d.cube
export ESPFILE=meoh_178.p.cube
