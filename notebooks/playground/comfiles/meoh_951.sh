...
export INPFILE=meoh_951.com
export OUTFILE=meoh_951.out
export CHKFILE=meoh_951.chk
export FCKFILE=meoh_951.fchk
export DNSFILE=meoh_951.d.cube
export ESPFILE=meoh_951.p.cube
