...
export INPFILE=meoh_206.com
export OUTFILE=meoh_206.out
export CHKFILE=meoh_206.chk
export FCKFILE=meoh_206.fchk
export DNSFILE=meoh_206.d.cube
export ESPFILE=meoh_206.p.cube
