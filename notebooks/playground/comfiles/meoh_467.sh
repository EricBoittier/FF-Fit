...
export INPFILE=meoh_467.com
export OUTFILE=meoh_467.out
export CHKFILE=meoh_467.chk
export FCKFILE=meoh_467.fchk
export DNSFILE=meoh_467.d.cube
export ESPFILE=meoh_467.p.cube
