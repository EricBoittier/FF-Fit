...
export INPFILE=meoh_477.com
export OUTFILE=meoh_477.out
export CHKFILE=meoh_477.chk
export FCKFILE=meoh_477.fchk
export DNSFILE=meoh_477.d.cube
export ESPFILE=meoh_477.p.cube
