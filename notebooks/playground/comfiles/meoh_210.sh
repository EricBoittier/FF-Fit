...
export INPFILE=meoh_210.com
export OUTFILE=meoh_210.out
export CHKFILE=meoh_210.chk
export FCKFILE=meoh_210.fchk
export DNSFILE=meoh_210.d.cube
export ESPFILE=meoh_210.p.cube
