...
export INPFILE=meoh_364.com
export OUTFILE=meoh_364.out
export CHKFILE=meoh_364.chk
export FCKFILE=meoh_364.fchk
export DNSFILE=meoh_364.d.cube
export ESPFILE=meoh_364.p.cube
