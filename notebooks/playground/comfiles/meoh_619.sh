...
export INPFILE=meoh_619.com
export OUTFILE=meoh_619.out
export CHKFILE=meoh_619.chk
export FCKFILE=meoh_619.fchk
export DNSFILE=meoh_619.d.cube
export ESPFILE=meoh_619.p.cube
