...
export INPFILE=meoh_864.com
export OUTFILE=meoh_864.out
export CHKFILE=meoh_864.chk
export FCKFILE=meoh_864.fchk
export DNSFILE=meoh_864.d.cube
export ESPFILE=meoh_864.p.cube
