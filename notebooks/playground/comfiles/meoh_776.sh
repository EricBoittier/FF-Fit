...
export INPFILE=meoh_776.com
export OUTFILE=meoh_776.out
export CHKFILE=meoh_776.chk
export FCKFILE=meoh_776.fchk
export DNSFILE=meoh_776.d.cube
export ESPFILE=meoh_776.p.cube
