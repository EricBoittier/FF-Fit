...
export INPFILE=meoh_345.com
export OUTFILE=meoh_345.out
export CHKFILE=meoh_345.chk
export FCKFILE=meoh_345.fchk
export DNSFILE=meoh_345.d.cube
export ESPFILE=meoh_345.p.cube
