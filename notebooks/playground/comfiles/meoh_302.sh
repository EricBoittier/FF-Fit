...
export INPFILE=meoh_302.com
export OUTFILE=meoh_302.out
export CHKFILE=meoh_302.chk
export FCKFILE=meoh_302.fchk
export DNSFILE=meoh_302.d.cube
export ESPFILE=meoh_302.p.cube
