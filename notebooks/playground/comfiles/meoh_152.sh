...
export INPFILE=meoh_152.com
export OUTFILE=meoh_152.out
export CHKFILE=meoh_152.chk
export FCKFILE=meoh_152.fchk
export DNSFILE=meoh_152.d.cube
export ESPFILE=meoh_152.p.cube
