...
export INPFILE=meoh_495.com
export OUTFILE=meoh_495.out
export CHKFILE=meoh_495.chk
export FCKFILE=meoh_495.fchk
export DNSFILE=meoh_495.d.cube
export ESPFILE=meoh_495.p.cube
