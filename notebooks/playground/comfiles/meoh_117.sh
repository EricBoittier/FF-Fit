...
export INPFILE=meoh_117.com
export OUTFILE=meoh_117.out
export CHKFILE=meoh_117.chk
export FCKFILE=meoh_117.fchk
export DNSFILE=meoh_117.d.cube
export ESPFILE=meoh_117.p.cube
