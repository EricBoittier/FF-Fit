...
export INPFILE=meoh_893.com
export OUTFILE=meoh_893.out
export CHKFILE=meoh_893.chk
export FCKFILE=meoh_893.fchk
export DNSFILE=meoh_893.d.cube
export ESPFILE=meoh_893.p.cube
