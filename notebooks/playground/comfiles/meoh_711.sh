...
export INPFILE=meoh_711.com
export OUTFILE=meoh_711.out
export CHKFILE=meoh_711.chk
export FCKFILE=meoh_711.fchk
export DNSFILE=meoh_711.d.cube
export ESPFILE=meoh_711.p.cube
