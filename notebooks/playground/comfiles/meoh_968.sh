...
export INPFILE=meoh_968.com
export OUTFILE=meoh_968.out
export CHKFILE=meoh_968.chk
export FCKFILE=meoh_968.fchk
export DNSFILE=meoh_968.d.cube
export ESPFILE=meoh_968.p.cube
