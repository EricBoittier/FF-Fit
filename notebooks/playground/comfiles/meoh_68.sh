...
export INPFILE=meoh_68.com
export OUTFILE=meoh_68.out
export CHKFILE=meoh_68.chk
export FCKFILE=meoh_68.fchk
export DNSFILE=meoh_68.d.cube
export ESPFILE=meoh_68.p.cube
