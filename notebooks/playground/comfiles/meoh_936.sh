...
export INPFILE=meoh_936.com
export OUTFILE=meoh_936.out
export CHKFILE=meoh_936.chk
export FCKFILE=meoh_936.fchk
export DNSFILE=meoh_936.d.cube
export ESPFILE=meoh_936.p.cube
