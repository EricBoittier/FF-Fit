...
export INPFILE=meoh_63.com
export OUTFILE=meoh_63.out
export CHKFILE=meoh_63.chk
export FCKFILE=meoh_63.fchk
export DNSFILE=meoh_63.d.cube
export ESPFILE=meoh_63.p.cube
