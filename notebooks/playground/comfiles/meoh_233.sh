...
export INPFILE=meoh_233.com
export OUTFILE=meoh_233.out
export CHKFILE=meoh_233.chk
export FCKFILE=meoh_233.fchk
export DNSFILE=meoh_233.d.cube
export ESPFILE=meoh_233.p.cube
