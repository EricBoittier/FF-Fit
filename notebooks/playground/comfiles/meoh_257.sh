...
export INPFILE=meoh_257.com
export OUTFILE=meoh_257.out
export CHKFILE=meoh_257.chk
export FCKFILE=meoh_257.fchk
export DNSFILE=meoh_257.d.cube
export ESPFILE=meoh_257.p.cube
