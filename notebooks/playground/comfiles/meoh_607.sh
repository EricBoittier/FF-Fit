...
export INPFILE=meoh_607.com
export OUTFILE=meoh_607.out
export CHKFILE=meoh_607.chk
export FCKFILE=meoh_607.fchk
export DNSFILE=meoh_607.d.cube
export ESPFILE=meoh_607.p.cube
