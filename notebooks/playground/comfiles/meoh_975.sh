...
export INPFILE=meoh_975.com
export OUTFILE=meoh_975.out
export CHKFILE=meoh_975.chk
export FCKFILE=meoh_975.fchk
export DNSFILE=meoh_975.d.cube
export ESPFILE=meoh_975.p.cube
