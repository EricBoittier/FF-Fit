...
export INPFILE=meoh_90.com
export OUTFILE=meoh_90.out
export CHKFILE=meoh_90.chk
export FCKFILE=meoh_90.fchk
export DNSFILE=meoh_90.d.cube
export ESPFILE=meoh_90.p.cube
