...
export INPFILE=meoh_981.com
export OUTFILE=meoh_981.out
export CHKFILE=meoh_981.chk
export FCKFILE=meoh_981.fchk
export DNSFILE=meoh_981.d.cube
export ESPFILE=meoh_981.p.cube
