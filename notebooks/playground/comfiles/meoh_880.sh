...
export INPFILE=meoh_880.com
export OUTFILE=meoh_880.out
export CHKFILE=meoh_880.chk
export FCKFILE=meoh_880.fchk
export DNSFILE=meoh_880.d.cube
export ESPFILE=meoh_880.p.cube
