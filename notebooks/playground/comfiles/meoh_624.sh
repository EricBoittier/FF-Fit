...
export INPFILE=meoh_624.com
export OUTFILE=meoh_624.out
export CHKFILE=meoh_624.chk
export FCKFILE=meoh_624.fchk
export DNSFILE=meoh_624.d.cube
export ESPFILE=meoh_624.p.cube
