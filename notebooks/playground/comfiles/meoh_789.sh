...
export INPFILE=meoh_789.com
export OUTFILE=meoh_789.out
export CHKFILE=meoh_789.chk
export FCKFILE=meoh_789.fchk
export DNSFILE=meoh_789.d.cube
export ESPFILE=meoh_789.p.cube
