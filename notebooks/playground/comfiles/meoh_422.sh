...
export INPFILE=meoh_422.com
export OUTFILE=meoh_422.out
export CHKFILE=meoh_422.chk
export FCKFILE=meoh_422.fchk
export DNSFILE=meoh_422.d.cube
export ESPFILE=meoh_422.p.cube
