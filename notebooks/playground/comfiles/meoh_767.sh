...
export INPFILE=meoh_767.com
export OUTFILE=meoh_767.out
export CHKFILE=meoh_767.chk
export FCKFILE=meoh_767.fchk
export DNSFILE=meoh_767.d.cube
export ESPFILE=meoh_767.p.cube
