...
export INPFILE=meoh_446.com
export OUTFILE=meoh_446.out
export CHKFILE=meoh_446.chk
export FCKFILE=meoh_446.fchk
export DNSFILE=meoh_446.d.cube
export ESPFILE=meoh_446.p.cube
