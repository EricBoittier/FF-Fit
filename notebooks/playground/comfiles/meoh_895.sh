...
export INPFILE=meoh_895.com
export OUTFILE=meoh_895.out
export CHKFILE=meoh_895.chk
export FCKFILE=meoh_895.fchk
export DNSFILE=meoh_895.d.cube
export ESPFILE=meoh_895.p.cube
