...
export INPFILE=meoh_576.com
export OUTFILE=meoh_576.out
export CHKFILE=meoh_576.chk
export FCKFILE=meoh_576.fchk
export DNSFILE=meoh_576.d.cube
export ESPFILE=meoh_576.p.cube
