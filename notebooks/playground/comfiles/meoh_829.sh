...
export INPFILE=meoh_829.com
export OUTFILE=meoh_829.out
export CHKFILE=meoh_829.chk
export FCKFILE=meoh_829.fchk
export DNSFILE=meoh_829.d.cube
export ESPFILE=meoh_829.p.cube
