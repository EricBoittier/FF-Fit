...
export INPFILE=meoh_207.com
export OUTFILE=meoh_207.out
export CHKFILE=meoh_207.chk
export FCKFILE=meoh_207.fchk
export DNSFILE=meoh_207.d.cube
export ESPFILE=meoh_207.p.cube
