...
export INPFILE=meoh_432.com
export OUTFILE=meoh_432.out
export CHKFILE=meoh_432.chk
export FCKFILE=meoh_432.fchk
export DNSFILE=meoh_432.d.cube
export ESPFILE=meoh_432.p.cube
