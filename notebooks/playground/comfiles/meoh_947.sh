...
export INPFILE=meoh_947.com
export OUTFILE=meoh_947.out
export CHKFILE=meoh_947.chk
export FCKFILE=meoh_947.fchk
export DNSFILE=meoh_947.d.cube
export ESPFILE=meoh_947.p.cube
