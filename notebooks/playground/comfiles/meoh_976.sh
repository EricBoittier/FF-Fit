...
export INPFILE=meoh_976.com
export OUTFILE=meoh_976.out
export CHKFILE=meoh_976.chk
export FCKFILE=meoh_976.fchk
export DNSFILE=meoh_976.d.cube
export ESPFILE=meoh_976.p.cube
