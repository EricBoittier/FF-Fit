...
export INPFILE=meoh_630.com
export OUTFILE=meoh_630.out
export CHKFILE=meoh_630.chk
export FCKFILE=meoh_630.fchk
export DNSFILE=meoh_630.d.cube
export ESPFILE=meoh_630.p.cube
