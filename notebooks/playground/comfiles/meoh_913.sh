...
export INPFILE=meoh_913.com
export OUTFILE=meoh_913.out
export CHKFILE=meoh_913.chk
export FCKFILE=meoh_913.fchk
export DNSFILE=meoh_913.d.cube
export ESPFILE=meoh_913.p.cube
