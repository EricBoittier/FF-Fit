...
export INPFILE=meoh_797.com
export OUTFILE=meoh_797.out
export CHKFILE=meoh_797.chk
export FCKFILE=meoh_797.fchk
export DNSFILE=meoh_797.d.cube
export ESPFILE=meoh_797.p.cube
