...
export INPFILE=meoh_231.com
export OUTFILE=meoh_231.out
export CHKFILE=meoh_231.chk
export FCKFILE=meoh_231.fchk
export DNSFILE=meoh_231.d.cube
export ESPFILE=meoh_231.p.cube
