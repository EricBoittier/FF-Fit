...
export INPFILE=meoh_683.com
export OUTFILE=meoh_683.out
export CHKFILE=meoh_683.chk
export FCKFILE=meoh_683.fchk
export DNSFILE=meoh_683.d.cube
export ESPFILE=meoh_683.p.cube
