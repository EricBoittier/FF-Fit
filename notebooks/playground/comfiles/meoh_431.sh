...
export INPFILE=meoh_431.com
export OUTFILE=meoh_431.out
export CHKFILE=meoh_431.chk
export FCKFILE=meoh_431.fchk
export DNSFILE=meoh_431.d.cube
export ESPFILE=meoh_431.p.cube
