...
export INPFILE=meoh_841.com
export OUTFILE=meoh_841.out
export CHKFILE=meoh_841.chk
export FCKFILE=meoh_841.fchk
export DNSFILE=meoh_841.d.cube
export ESPFILE=meoh_841.p.cube
