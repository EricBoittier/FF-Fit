...
export INPFILE=meoh_157.com
export OUTFILE=meoh_157.out
export CHKFILE=meoh_157.chk
export FCKFILE=meoh_157.fchk
export DNSFILE=meoh_157.d.cube
export ESPFILE=meoh_157.p.cube
