...
export INPFILE=meoh_192.com
export OUTFILE=meoh_192.out
export CHKFILE=meoh_192.chk
export FCKFILE=meoh_192.fchk
export DNSFILE=meoh_192.d.cube
export ESPFILE=meoh_192.p.cube
