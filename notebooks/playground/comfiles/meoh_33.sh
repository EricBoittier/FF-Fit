...
export INPFILE=meoh_33.com
export OUTFILE=meoh_33.out
export CHKFILE=meoh_33.chk
export FCKFILE=meoh_33.fchk
export DNSFILE=meoh_33.d.cube
export ESPFILE=meoh_33.p.cube
