...
export INPFILE=meoh_885.com
export OUTFILE=meoh_885.out
export CHKFILE=meoh_885.chk
export FCKFILE=meoh_885.fchk
export DNSFILE=meoh_885.d.cube
export ESPFILE=meoh_885.p.cube
