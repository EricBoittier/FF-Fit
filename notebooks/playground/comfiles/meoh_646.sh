...
export INPFILE=meoh_646.com
export OUTFILE=meoh_646.out
export CHKFILE=meoh_646.chk
export FCKFILE=meoh_646.fchk
export DNSFILE=meoh_646.d.cube
export ESPFILE=meoh_646.p.cube
