...
export INPFILE=meoh_466.com
export OUTFILE=meoh_466.out
export CHKFILE=meoh_466.chk
export FCKFILE=meoh_466.fchk
export DNSFILE=meoh_466.d.cube
export ESPFILE=meoh_466.p.cube
