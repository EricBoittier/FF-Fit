...
export INPFILE=meoh_469.com
export OUTFILE=meoh_469.out
export CHKFILE=meoh_469.chk
export FCKFILE=meoh_469.fchk
export DNSFILE=meoh_469.d.cube
export ESPFILE=meoh_469.p.cube
