...
export INPFILE=meoh_753.com
export OUTFILE=meoh_753.out
export CHKFILE=meoh_753.chk
export FCKFILE=meoh_753.fchk
export DNSFILE=meoh_753.d.cube
export ESPFILE=meoh_753.p.cube
