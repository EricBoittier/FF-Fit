...
export INPFILE=meoh_555.com
export OUTFILE=meoh_555.out
export CHKFILE=meoh_555.chk
export FCKFILE=meoh_555.fchk
export DNSFILE=meoh_555.d.cube
export ESPFILE=meoh_555.p.cube
