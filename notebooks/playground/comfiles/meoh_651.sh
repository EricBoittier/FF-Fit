...
export INPFILE=meoh_651.com
export OUTFILE=meoh_651.out
export CHKFILE=meoh_651.chk
export FCKFILE=meoh_651.fchk
export DNSFILE=meoh_651.d.cube
export ESPFILE=meoh_651.p.cube
