...
export INPFILE=meoh_994.com
export OUTFILE=meoh_994.out
export CHKFILE=meoh_994.chk
export FCKFILE=meoh_994.fchk
export DNSFILE=meoh_994.d.cube
export ESPFILE=meoh_994.p.cube
