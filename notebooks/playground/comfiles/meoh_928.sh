...
export INPFILE=meoh_928.com
export OUTFILE=meoh_928.out
export CHKFILE=meoh_928.chk
export FCKFILE=meoh_928.fchk
export DNSFILE=meoh_928.d.cube
export ESPFILE=meoh_928.p.cube
