...
export INPFILE=meoh_219.com
export OUTFILE=meoh_219.out
export CHKFILE=meoh_219.chk
export FCKFILE=meoh_219.fchk
export DNSFILE=meoh_219.d.cube
export ESPFILE=meoh_219.p.cube
