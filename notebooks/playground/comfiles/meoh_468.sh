...
export INPFILE=meoh_468.com
export OUTFILE=meoh_468.out
export CHKFILE=meoh_468.chk
export FCKFILE=meoh_468.fchk
export DNSFILE=meoh_468.d.cube
export ESPFILE=meoh_468.p.cube
