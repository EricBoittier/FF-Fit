...
export INPFILE=meoh_687.com
export OUTFILE=meoh_687.out
export CHKFILE=meoh_687.chk
export FCKFILE=meoh_687.fchk
export DNSFILE=meoh_687.d.cube
export ESPFILE=meoh_687.p.cube
