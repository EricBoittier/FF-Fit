...
export INPFILE=meoh_289.com
export OUTFILE=meoh_289.out
export CHKFILE=meoh_289.chk
export FCKFILE=meoh_289.fchk
export DNSFILE=meoh_289.d.cube
export ESPFILE=meoh_289.p.cube
