...
export INPFILE=meoh_557.com
export OUTFILE=meoh_557.out
export CHKFILE=meoh_557.chk
export FCKFILE=meoh_557.fchk
export DNSFILE=meoh_557.d.cube
export ESPFILE=meoh_557.p.cube
