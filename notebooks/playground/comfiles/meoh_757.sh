...
export INPFILE=meoh_757.com
export OUTFILE=meoh_757.out
export CHKFILE=meoh_757.chk
export FCKFILE=meoh_757.fchk
export DNSFILE=meoh_757.d.cube
export ESPFILE=meoh_757.p.cube
