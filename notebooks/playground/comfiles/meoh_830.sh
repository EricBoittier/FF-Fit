...
export INPFILE=meoh_830.com
export OUTFILE=meoh_830.out
export CHKFILE=meoh_830.chk
export FCKFILE=meoh_830.fchk
export DNSFILE=meoh_830.d.cube
export ESPFILE=meoh_830.p.cube
