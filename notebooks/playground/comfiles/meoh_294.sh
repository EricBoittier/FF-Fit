...
export INPFILE=meoh_294.com
export OUTFILE=meoh_294.out
export CHKFILE=meoh_294.chk
export FCKFILE=meoh_294.fchk
export DNSFILE=meoh_294.d.cube
export ESPFILE=meoh_294.p.cube
