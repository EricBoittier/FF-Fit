...
export INPFILE=meoh_515.com
export OUTFILE=meoh_515.out
export CHKFILE=meoh_515.chk
export FCKFILE=meoh_515.fchk
export DNSFILE=meoh_515.d.cube
export ESPFILE=meoh_515.p.cube
