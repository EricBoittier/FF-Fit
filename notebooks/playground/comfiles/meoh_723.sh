...
export INPFILE=meoh_723.com
export OUTFILE=meoh_723.out
export CHKFILE=meoh_723.chk
export FCKFILE=meoh_723.fchk
export DNSFILE=meoh_723.d.cube
export ESPFILE=meoh_723.p.cube
