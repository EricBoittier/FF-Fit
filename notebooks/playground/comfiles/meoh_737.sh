...
export INPFILE=meoh_737.com
export OUTFILE=meoh_737.out
export CHKFILE=meoh_737.chk
export FCKFILE=meoh_737.fchk
export DNSFILE=meoh_737.d.cube
export ESPFILE=meoh_737.p.cube
