...
export INPFILE=meoh_921.com
export OUTFILE=meoh_921.out
export CHKFILE=meoh_921.chk
export FCKFILE=meoh_921.fchk
export DNSFILE=meoh_921.d.cube
export ESPFILE=meoh_921.p.cube
