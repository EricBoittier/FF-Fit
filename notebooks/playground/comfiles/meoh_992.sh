...
export INPFILE=meoh_992.com
export OUTFILE=meoh_992.out
export CHKFILE=meoh_992.chk
export FCKFILE=meoh_992.fchk
export DNSFILE=meoh_992.d.cube
export ESPFILE=meoh_992.p.cube
