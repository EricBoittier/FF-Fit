...
export INPFILE=meoh_692.com
export OUTFILE=meoh_692.out
export CHKFILE=meoh_692.chk
export FCKFILE=meoh_692.fchk
export DNSFILE=meoh_692.d.cube
export ESPFILE=meoh_692.p.cube
