...
export INPFILE=meoh_983.com
export OUTFILE=meoh_983.out
export CHKFILE=meoh_983.chk
export FCKFILE=meoh_983.fchk
export DNSFILE=meoh_983.d.cube
export ESPFILE=meoh_983.p.cube
