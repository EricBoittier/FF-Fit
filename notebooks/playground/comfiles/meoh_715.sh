...
export INPFILE=meoh_715.com
export OUTFILE=meoh_715.out
export CHKFILE=meoh_715.chk
export FCKFILE=meoh_715.fchk
export DNSFILE=meoh_715.d.cube
export ESPFILE=meoh_715.p.cube
