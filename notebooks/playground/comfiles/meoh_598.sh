...
export INPFILE=meoh_598.com
export OUTFILE=meoh_598.out
export CHKFILE=meoh_598.chk
export FCKFILE=meoh_598.fchk
export DNSFILE=meoh_598.d.cube
export ESPFILE=meoh_598.p.cube
