...
export INPFILE=meoh_869.com
export OUTFILE=meoh_869.out
export CHKFILE=meoh_869.chk
export FCKFILE=meoh_869.fchk
export DNSFILE=meoh_869.d.cube
export ESPFILE=meoh_869.p.cube
