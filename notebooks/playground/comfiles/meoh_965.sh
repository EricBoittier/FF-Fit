...
export INPFILE=meoh_965.com
export OUTFILE=meoh_965.out
export CHKFILE=meoh_965.chk
export FCKFILE=meoh_965.fchk
export DNSFILE=meoh_965.d.cube
export ESPFILE=meoh_965.p.cube
