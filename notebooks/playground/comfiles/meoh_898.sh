...
export INPFILE=meoh_898.com
export OUTFILE=meoh_898.out
export CHKFILE=meoh_898.chk
export FCKFILE=meoh_898.fchk
export DNSFILE=meoh_898.d.cube
export ESPFILE=meoh_898.p.cube
