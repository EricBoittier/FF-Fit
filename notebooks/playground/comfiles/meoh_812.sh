...
export INPFILE=meoh_812.com
export OUTFILE=meoh_812.out
export CHKFILE=meoh_812.chk
export FCKFILE=meoh_812.fchk
export DNSFILE=meoh_812.d.cube
export ESPFILE=meoh_812.p.cube
