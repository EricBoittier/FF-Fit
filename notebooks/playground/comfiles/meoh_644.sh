...
export INPFILE=meoh_644.com
export OUTFILE=meoh_644.out
export CHKFILE=meoh_644.chk
export FCKFILE=meoh_644.fchk
export DNSFILE=meoh_644.d.cube
export ESPFILE=meoh_644.p.cube
