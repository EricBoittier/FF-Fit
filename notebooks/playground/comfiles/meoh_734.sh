...
export INPFILE=meoh_734.com
export OUTFILE=meoh_734.out
export CHKFILE=meoh_734.chk
export FCKFILE=meoh_734.fchk
export DNSFILE=meoh_734.d.cube
export ESPFILE=meoh_734.p.cube
