...
export INPFILE=meoh_426.com
export OUTFILE=meoh_426.out
export CHKFILE=meoh_426.chk
export FCKFILE=meoh_426.fchk
export DNSFILE=meoh_426.d.cube
export ESPFILE=meoh_426.p.cube
