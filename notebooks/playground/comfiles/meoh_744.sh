...
export INPFILE=meoh_744.com
export OUTFILE=meoh_744.out
export CHKFILE=meoh_744.chk
export FCKFILE=meoh_744.fchk
export DNSFILE=meoh_744.d.cube
export ESPFILE=meoh_744.p.cube
