...
export INPFILE=meoh_229.com
export OUTFILE=meoh_229.out
export CHKFILE=meoh_229.chk
export FCKFILE=meoh_229.fchk
export DNSFILE=meoh_229.d.cube
export ESPFILE=meoh_229.p.cube
