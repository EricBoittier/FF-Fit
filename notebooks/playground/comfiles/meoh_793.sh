...
export INPFILE=meoh_793.com
export OUTFILE=meoh_793.out
export CHKFILE=meoh_793.chk
export FCKFILE=meoh_793.fchk
export DNSFILE=meoh_793.d.cube
export ESPFILE=meoh_793.p.cube
