...
export INPFILE=meoh_459.com
export OUTFILE=meoh_459.out
export CHKFILE=meoh_459.chk
export FCKFILE=meoh_459.fchk
export DNSFILE=meoh_459.d.cube
export ESPFILE=meoh_459.p.cube
