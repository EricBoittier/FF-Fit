...
export INPFILE=meoh_189.com
export OUTFILE=meoh_189.out
export CHKFILE=meoh_189.chk
export FCKFILE=meoh_189.fchk
export DNSFILE=meoh_189.d.cube
export ESPFILE=meoh_189.p.cube
