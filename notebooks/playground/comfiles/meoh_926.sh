...
export INPFILE=meoh_926.com
export OUTFILE=meoh_926.out
export CHKFILE=meoh_926.chk
export FCKFILE=meoh_926.fchk
export DNSFILE=meoh_926.d.cube
export ESPFILE=meoh_926.p.cube
