...
export INPFILE=meoh_465.com
export OUTFILE=meoh_465.out
export CHKFILE=meoh_465.chk
export FCKFILE=meoh_465.fchk
export DNSFILE=meoh_465.d.cube
export ESPFILE=meoh_465.p.cube
