...
export INPFILE=meoh_851.com
export OUTFILE=meoh_851.out
export CHKFILE=meoh_851.chk
export FCKFILE=meoh_851.fchk
export DNSFILE=meoh_851.d.cube
export ESPFILE=meoh_851.p.cube
