...
export INPFILE=meoh_657.com
export OUTFILE=meoh_657.out
export CHKFILE=meoh_657.chk
export FCKFILE=meoh_657.fchk
export DNSFILE=meoh_657.d.cube
export ESPFILE=meoh_657.p.cube
