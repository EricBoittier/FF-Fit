...
export INPFILE=meoh_262.com
export OUTFILE=meoh_262.out
export CHKFILE=meoh_262.chk
export FCKFILE=meoh_262.fchk
export DNSFILE=meoh_262.d.cube
export ESPFILE=meoh_262.p.cube
