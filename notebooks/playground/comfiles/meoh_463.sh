...
export INPFILE=meoh_463.com
export OUTFILE=meoh_463.out
export CHKFILE=meoh_463.chk
export FCKFILE=meoh_463.fchk
export DNSFILE=meoh_463.d.cube
export ESPFILE=meoh_463.p.cube
