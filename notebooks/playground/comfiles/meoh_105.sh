...
export INPFILE=meoh_105.com
export OUTFILE=meoh_105.out
export CHKFILE=meoh_105.chk
export FCKFILE=meoh_105.fchk
export DNSFILE=meoh_105.d.cube
export ESPFILE=meoh_105.p.cube
