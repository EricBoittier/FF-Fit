...
export INPFILE=meoh_497.com
export OUTFILE=meoh_497.out
export CHKFILE=meoh_497.chk
export FCKFILE=meoh_497.fchk
export DNSFILE=meoh_497.d.cube
export ESPFILE=meoh_497.p.cube
