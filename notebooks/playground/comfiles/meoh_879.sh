...
export INPFILE=meoh_879.com
export OUTFILE=meoh_879.out
export CHKFILE=meoh_879.chk
export FCKFILE=meoh_879.fchk
export DNSFILE=meoh_879.d.cube
export ESPFILE=meoh_879.p.cube
