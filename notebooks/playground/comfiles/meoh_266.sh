...
export INPFILE=meoh_266.com
export OUTFILE=meoh_266.out
export CHKFILE=meoh_266.chk
export FCKFILE=meoh_266.fchk
export DNSFILE=meoh_266.d.cube
export ESPFILE=meoh_266.p.cube
