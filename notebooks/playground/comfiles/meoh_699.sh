...
export INPFILE=meoh_699.com
export OUTFILE=meoh_699.out
export CHKFILE=meoh_699.chk
export FCKFILE=meoh_699.fchk
export DNSFILE=meoh_699.d.cube
export ESPFILE=meoh_699.p.cube
