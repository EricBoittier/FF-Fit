...
export INPFILE=meoh_923.com
export OUTFILE=meoh_923.out
export CHKFILE=meoh_923.chk
export FCKFILE=meoh_923.fchk
export DNSFILE=meoh_923.d.cube
export ESPFILE=meoh_923.p.cube
