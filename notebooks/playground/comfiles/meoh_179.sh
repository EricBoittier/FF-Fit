...
export INPFILE=meoh_179.com
export OUTFILE=meoh_179.out
export CHKFILE=meoh_179.chk
export FCKFILE=meoh_179.fchk
export DNSFILE=meoh_179.d.cube
export ESPFILE=meoh_179.p.cube
