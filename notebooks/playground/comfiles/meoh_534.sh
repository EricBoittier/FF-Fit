...
export INPFILE=meoh_534.com
export OUTFILE=meoh_534.out
export CHKFILE=meoh_534.chk
export FCKFILE=meoh_534.fchk
export DNSFILE=meoh_534.d.cube
export ESPFILE=meoh_534.p.cube
