...
export INPFILE=meoh_638.com
export OUTFILE=meoh_638.out
export CHKFILE=meoh_638.chk
export FCKFILE=meoh_638.fchk
export DNSFILE=meoh_638.d.cube
export ESPFILE=meoh_638.p.cube
