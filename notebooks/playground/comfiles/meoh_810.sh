...
export INPFILE=meoh_810.com
export OUTFILE=meoh_810.out
export CHKFILE=meoh_810.chk
export FCKFILE=meoh_810.fchk
export DNSFILE=meoh_810.d.cube
export ESPFILE=meoh_810.p.cube
