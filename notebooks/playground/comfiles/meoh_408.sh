...
export INPFILE=meoh_408.com
export OUTFILE=meoh_408.out
export CHKFILE=meoh_408.chk
export FCKFILE=meoh_408.fchk
export DNSFILE=meoh_408.d.cube
export ESPFILE=meoh_408.p.cube
