...
export INPFILE=meoh_362.com
export OUTFILE=meoh_362.out
export CHKFILE=meoh_362.chk
export FCKFILE=meoh_362.fchk
export DNSFILE=meoh_362.d.cube
export ESPFILE=meoh_362.p.cube
