...
export INPFILE=meoh_191.com
export OUTFILE=meoh_191.out
export CHKFILE=meoh_191.chk
export FCKFILE=meoh_191.fchk
export DNSFILE=meoh_191.d.cube
export ESPFILE=meoh_191.p.cube
