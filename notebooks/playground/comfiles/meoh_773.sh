...
export INPFILE=meoh_773.com
export OUTFILE=meoh_773.out
export CHKFILE=meoh_773.chk
export FCKFILE=meoh_773.fchk
export DNSFILE=meoh_773.d.cube
export ESPFILE=meoh_773.p.cube
