...
export INPFILE=meoh_448.com
export OUTFILE=meoh_448.out
export CHKFILE=meoh_448.chk
export FCKFILE=meoh_448.fchk
export DNSFILE=meoh_448.d.cube
export ESPFILE=meoh_448.p.cube
