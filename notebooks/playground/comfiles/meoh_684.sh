...
export INPFILE=meoh_684.com
export OUTFILE=meoh_684.out
export CHKFILE=meoh_684.chk
export FCKFILE=meoh_684.fchk
export DNSFILE=meoh_684.d.cube
export ESPFILE=meoh_684.p.cube
