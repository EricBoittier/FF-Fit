...
export INPFILE=meoh_213.com
export OUTFILE=meoh_213.out
export CHKFILE=meoh_213.chk
export FCKFILE=meoh_213.fchk
export DNSFILE=meoh_213.d.cube
export ESPFILE=meoh_213.p.cube
