...
export INPFILE=meoh_295.com
export OUTFILE=meoh_295.out
export CHKFILE=meoh_295.chk
export FCKFILE=meoh_295.fchk
export DNSFILE=meoh_295.d.cube
export ESPFILE=meoh_295.p.cube
