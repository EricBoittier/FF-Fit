...
export INPFILE=meoh_573.com
export OUTFILE=meoh_573.out
export CHKFILE=meoh_573.chk
export FCKFILE=meoh_573.fchk
export DNSFILE=meoh_573.d.cube
export ESPFILE=meoh_573.p.cube
