...
export INPFILE=meoh_662.com
export OUTFILE=meoh_662.out
export CHKFILE=meoh_662.chk
export FCKFILE=meoh_662.fchk
export DNSFILE=meoh_662.d.cube
export ESPFILE=meoh_662.p.cube
