...
export INPFILE=meoh_701.com
export OUTFILE=meoh_701.out
export CHKFILE=meoh_701.chk
export FCKFILE=meoh_701.fchk
export DNSFILE=meoh_701.d.cube
export ESPFILE=meoh_701.p.cube
