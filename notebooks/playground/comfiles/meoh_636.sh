...
export INPFILE=meoh_636.com
export OUTFILE=meoh_636.out
export CHKFILE=meoh_636.chk
export FCKFILE=meoh_636.fchk
export DNSFILE=meoh_636.d.cube
export ESPFILE=meoh_636.p.cube
