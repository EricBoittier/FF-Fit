...
export INPFILE=meoh_131.com
export OUTFILE=meoh_131.out
export CHKFILE=meoh_131.chk
export FCKFILE=meoh_131.fchk
export DNSFILE=meoh_131.d.cube
export ESPFILE=meoh_131.p.cube
