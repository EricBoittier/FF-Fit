...
export INPFILE=meoh_406.com
export OUTFILE=meoh_406.out
export CHKFILE=meoh_406.chk
export FCKFILE=meoh_406.fchk
export DNSFILE=meoh_406.d.cube
export ESPFILE=meoh_406.p.cube
