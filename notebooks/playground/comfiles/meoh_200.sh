...
export INPFILE=meoh_200.com
export OUTFILE=meoh_200.out
export CHKFILE=meoh_200.chk
export FCKFILE=meoh_200.fchk
export DNSFILE=meoh_200.d.cube
export ESPFILE=meoh_200.p.cube
