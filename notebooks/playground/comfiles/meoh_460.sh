...
export INPFILE=meoh_460.com
export OUTFILE=meoh_460.out
export CHKFILE=meoh_460.chk
export FCKFILE=meoh_460.fchk
export DNSFILE=meoh_460.d.cube
export ESPFILE=meoh_460.p.cube
