...
export INPFILE=meoh_552.com
export OUTFILE=meoh_552.out
export CHKFILE=meoh_552.chk
export FCKFILE=meoh_552.fchk
export DNSFILE=meoh_552.d.cube
export ESPFILE=meoh_552.p.cube
