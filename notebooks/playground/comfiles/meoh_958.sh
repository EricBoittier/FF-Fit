...
export INPFILE=meoh_958.com
export OUTFILE=meoh_958.out
export CHKFILE=meoh_958.chk
export FCKFILE=meoh_958.fchk
export DNSFILE=meoh_958.d.cube
export ESPFILE=meoh_958.p.cube
