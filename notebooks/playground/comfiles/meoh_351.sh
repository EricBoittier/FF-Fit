...
export INPFILE=meoh_351.com
export OUTFILE=meoh_351.out
export CHKFILE=meoh_351.chk
export FCKFILE=meoh_351.fchk
export DNSFILE=meoh_351.d.cube
export ESPFILE=meoh_351.p.cube
