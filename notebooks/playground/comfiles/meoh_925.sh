...
export INPFILE=meoh_925.com
export OUTFILE=meoh_925.out
export CHKFILE=meoh_925.chk
export FCKFILE=meoh_925.fchk
export DNSFILE=meoh_925.d.cube
export ESPFILE=meoh_925.p.cube
