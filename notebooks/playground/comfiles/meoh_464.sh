...
export INPFILE=meoh_464.com
export OUTFILE=meoh_464.out
export CHKFILE=meoh_464.chk
export FCKFILE=meoh_464.fchk
export DNSFILE=meoh_464.d.cube
export ESPFILE=meoh_464.p.cube
