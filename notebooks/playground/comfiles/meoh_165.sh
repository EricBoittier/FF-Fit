...
export INPFILE=meoh_165.com
export OUTFILE=meoh_165.out
export CHKFILE=meoh_165.chk
export FCKFILE=meoh_165.fchk
export DNSFILE=meoh_165.d.cube
export ESPFILE=meoh_165.p.cube
