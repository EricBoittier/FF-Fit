...
export INPFILE=meoh_404.com
export OUTFILE=meoh_404.out
export CHKFILE=meoh_404.chk
export FCKFILE=meoh_404.fchk
export DNSFILE=meoh_404.d.cube
export ESPFILE=meoh_404.p.cube
