...
export INPFILE=meoh_565.com
export OUTFILE=meoh_565.out
export CHKFILE=meoh_565.chk
export FCKFILE=meoh_565.fchk
export DNSFILE=meoh_565.d.cube
export ESPFILE=meoh_565.p.cube
