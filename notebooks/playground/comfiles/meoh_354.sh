...
export INPFILE=meoh_354.com
export OUTFILE=meoh_354.out
export CHKFILE=meoh_354.chk
export FCKFILE=meoh_354.fchk
export DNSFILE=meoh_354.d.cube
export ESPFILE=meoh_354.p.cube
