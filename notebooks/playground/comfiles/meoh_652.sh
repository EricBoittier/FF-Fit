...
export INPFILE=meoh_652.com
export OUTFILE=meoh_652.out
export CHKFILE=meoh_652.chk
export FCKFILE=meoh_652.fchk
export DNSFILE=meoh_652.d.cube
export ESPFILE=meoh_652.p.cube
