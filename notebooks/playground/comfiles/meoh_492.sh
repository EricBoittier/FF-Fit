...
export INPFILE=meoh_492.com
export OUTFILE=meoh_492.out
export CHKFILE=meoh_492.chk
export FCKFILE=meoh_492.fchk
export DNSFILE=meoh_492.d.cube
export ESPFILE=meoh_492.p.cube
