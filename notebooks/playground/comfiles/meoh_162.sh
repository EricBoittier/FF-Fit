...
export INPFILE=meoh_162.com
export OUTFILE=meoh_162.out
export CHKFILE=meoh_162.chk
export FCKFILE=meoh_162.fchk
export DNSFILE=meoh_162.d.cube
export ESPFILE=meoh_162.p.cube
