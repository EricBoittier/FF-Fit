...
export INPFILE=meoh_195.com
export OUTFILE=meoh_195.out
export CHKFILE=meoh_195.chk
export FCKFILE=meoh_195.fchk
export DNSFILE=meoh_195.d.cube
export ESPFILE=meoh_195.p.cube
