...
export INPFILE=meoh_392.com
export OUTFILE=meoh_392.out
export CHKFILE=meoh_392.chk
export FCKFILE=meoh_392.fchk
export DNSFILE=meoh_392.d.cube
export ESPFILE=meoh_392.p.cube
