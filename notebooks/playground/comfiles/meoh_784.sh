...
export INPFILE=meoh_784.com
export OUTFILE=meoh_784.out
export CHKFILE=meoh_784.chk
export FCKFILE=meoh_784.fchk
export DNSFILE=meoh_784.d.cube
export ESPFILE=meoh_784.p.cube
