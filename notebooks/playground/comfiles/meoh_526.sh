...
export INPFILE=meoh_526.com
export OUTFILE=meoh_526.out
export CHKFILE=meoh_526.chk
export FCKFILE=meoh_526.fchk
export DNSFILE=meoh_526.d.cube
export ESPFILE=meoh_526.p.cube
