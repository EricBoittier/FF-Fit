...
export INPFILE=meoh_785.com
export OUTFILE=meoh_785.out
export CHKFILE=meoh_785.chk
export FCKFILE=meoh_785.fchk
export DNSFILE=meoh_785.d.cube
export ESPFILE=meoh_785.p.cube
