...
export INPFILE=meoh_997.com
export OUTFILE=meoh_997.out
export CHKFILE=meoh_997.chk
export FCKFILE=meoh_997.fchk
export DNSFILE=meoh_997.d.cube
export ESPFILE=meoh_997.p.cube
