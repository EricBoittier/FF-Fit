...
export INPFILE=meoh_601.com
export OUTFILE=meoh_601.out
export CHKFILE=meoh_601.chk
export FCKFILE=meoh_601.fchk
export DNSFILE=meoh_601.d.cube
export ESPFILE=meoh_601.p.cube
