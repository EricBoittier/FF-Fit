...
export INPFILE=meoh_217.com
export OUTFILE=meoh_217.out
export CHKFILE=meoh_217.chk
export FCKFILE=meoh_217.fchk
export DNSFILE=meoh_217.d.cube
export ESPFILE=meoh_217.p.cube
