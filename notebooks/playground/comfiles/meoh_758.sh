...
export INPFILE=meoh_758.com
export OUTFILE=meoh_758.out
export CHKFILE=meoh_758.chk
export FCKFILE=meoh_758.fchk
export DNSFILE=meoh_758.d.cube
export ESPFILE=meoh_758.p.cube
