...
export INPFILE=meoh_610.com
export OUTFILE=meoh_610.out
export CHKFILE=meoh_610.chk
export FCKFILE=meoh_610.fchk
export DNSFILE=meoh_610.d.cube
export ESPFILE=meoh_610.p.cube
