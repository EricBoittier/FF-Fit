...
export INPFILE=meoh_443.com
export OUTFILE=meoh_443.out
export CHKFILE=meoh_443.chk
export FCKFILE=meoh_443.fchk
export DNSFILE=meoh_443.d.cube
export ESPFILE=meoh_443.p.cube
