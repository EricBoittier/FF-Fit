...
export INPFILE=meoh_531.com
export OUTFILE=meoh_531.out
export CHKFILE=meoh_531.chk
export FCKFILE=meoh_531.fchk
export DNSFILE=meoh_531.d.cube
export ESPFILE=meoh_531.p.cube
