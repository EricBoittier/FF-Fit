...
export INPFILE=meoh_355.com
export OUTFILE=meoh_355.out
export CHKFILE=meoh_355.chk
export FCKFILE=meoh_355.fchk
export DNSFILE=meoh_355.d.cube
export ESPFILE=meoh_355.p.cube
