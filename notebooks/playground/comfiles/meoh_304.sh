...
export INPFILE=meoh_304.com
export OUTFILE=meoh_304.out
export CHKFILE=meoh_304.chk
export FCKFILE=meoh_304.fchk
export DNSFILE=meoh_304.d.cube
export ESPFILE=meoh_304.p.cube
