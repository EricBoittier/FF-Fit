...
export INPFILE=meoh_873.com
export OUTFILE=meoh_873.out
export CHKFILE=meoh_873.chk
export FCKFILE=meoh_873.fchk
export DNSFILE=meoh_873.d.cube
export ESPFILE=meoh_873.p.cube
