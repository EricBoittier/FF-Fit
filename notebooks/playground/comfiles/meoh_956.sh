...
export INPFILE=meoh_956.com
export OUTFILE=meoh_956.out
export CHKFILE=meoh_956.chk
export FCKFILE=meoh_956.fchk
export DNSFILE=meoh_956.d.cube
export ESPFILE=meoh_956.p.cube
