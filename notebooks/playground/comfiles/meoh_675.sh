...
export INPFILE=meoh_675.com
export OUTFILE=meoh_675.out
export CHKFILE=meoh_675.chk
export FCKFILE=meoh_675.fchk
export DNSFILE=meoh_675.d.cube
export ESPFILE=meoh_675.p.cube
