...
export INPFILE=meoh_946.com
export OUTFILE=meoh_946.out
export CHKFILE=meoh_946.chk
export FCKFILE=meoh_946.fchk
export DNSFILE=meoh_946.d.cube
export ESPFILE=meoh_946.p.cube
