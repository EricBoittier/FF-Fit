...
export INPFILE=meoh_574.com
export OUTFILE=meoh_574.out
export CHKFILE=meoh_574.chk
export FCKFILE=meoh_574.fchk
export DNSFILE=meoh_574.d.cube
export ESPFILE=meoh_574.p.cube
