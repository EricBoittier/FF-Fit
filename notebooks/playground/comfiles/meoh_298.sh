...
export INPFILE=meoh_298.com
export OUTFILE=meoh_298.out
export CHKFILE=meoh_298.chk
export FCKFILE=meoh_298.fchk
export DNSFILE=meoh_298.d.cube
export ESPFILE=meoh_298.p.cube
