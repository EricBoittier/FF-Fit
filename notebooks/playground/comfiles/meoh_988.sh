...
export INPFILE=meoh_988.com
export OUTFILE=meoh_988.out
export CHKFILE=meoh_988.chk
export FCKFILE=meoh_988.fchk
export DNSFILE=meoh_988.d.cube
export ESPFILE=meoh_988.p.cube
