...
export INPFILE=meoh_75.com
export OUTFILE=meoh_75.out
export CHKFILE=meoh_75.chk
export FCKFILE=meoh_75.fchk
export DNSFILE=meoh_75.d.cube
export ESPFILE=meoh_75.p.cube
