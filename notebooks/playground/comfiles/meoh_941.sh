...
export INPFILE=meoh_941.com
export OUTFILE=meoh_941.out
export CHKFILE=meoh_941.chk
export FCKFILE=meoh_941.fchk
export DNSFILE=meoh_941.d.cube
export ESPFILE=meoh_941.p.cube
