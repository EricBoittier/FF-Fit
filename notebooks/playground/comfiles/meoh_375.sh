...
export INPFILE=meoh_375.com
export OUTFILE=meoh_375.out
export CHKFILE=meoh_375.chk
export FCKFILE=meoh_375.fchk
export DNSFILE=meoh_375.d.cube
export ESPFILE=meoh_375.p.cube
