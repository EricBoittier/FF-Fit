...
export INPFILE=meoh_884.com
export OUTFILE=meoh_884.out
export CHKFILE=meoh_884.chk
export FCKFILE=meoh_884.fchk
export DNSFILE=meoh_884.d.cube
export ESPFILE=meoh_884.p.cube
