...
export INPFILE=meoh_108.com
export OUTFILE=meoh_108.out
export CHKFILE=meoh_108.chk
export FCKFILE=meoh_108.fchk
export DNSFILE=meoh_108.d.cube
export ESPFILE=meoh_108.p.cube
