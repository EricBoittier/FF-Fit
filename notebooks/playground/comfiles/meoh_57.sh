...
export INPFILE=meoh_57.com
export OUTFILE=meoh_57.out
export CHKFILE=meoh_57.chk
export FCKFILE=meoh_57.fchk
export DNSFILE=meoh_57.d.cube
export ESPFILE=meoh_57.p.cube
