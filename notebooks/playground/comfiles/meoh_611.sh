...
export INPFILE=meoh_611.com
export OUTFILE=meoh_611.out
export CHKFILE=meoh_611.chk
export FCKFILE=meoh_611.fchk
export DNSFILE=meoh_611.d.cube
export ESPFILE=meoh_611.p.cube
