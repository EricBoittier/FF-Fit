...
export INPFILE=meoh_276.com
export OUTFILE=meoh_276.out
export CHKFILE=meoh_276.chk
export FCKFILE=meoh_276.fchk
export DNSFILE=meoh_276.d.cube
export ESPFILE=meoh_276.p.cube
