...
export INPFILE=meoh_368.com
export OUTFILE=meoh_368.out
export CHKFILE=meoh_368.chk
export FCKFILE=meoh_368.fchk
export DNSFILE=meoh_368.d.cube
export ESPFILE=meoh_368.p.cube
