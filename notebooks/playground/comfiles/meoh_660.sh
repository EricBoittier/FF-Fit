...
export INPFILE=meoh_660.com
export OUTFILE=meoh_660.out
export CHKFILE=meoh_660.chk
export FCKFILE=meoh_660.fchk
export DNSFILE=meoh_660.d.cube
export ESPFILE=meoh_660.p.cube
