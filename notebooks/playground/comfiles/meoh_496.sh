...
export INPFILE=meoh_496.com
export OUTFILE=meoh_496.out
export CHKFILE=meoh_496.chk
export FCKFILE=meoh_496.fchk
export DNSFILE=meoh_496.d.cube
export ESPFILE=meoh_496.p.cube
