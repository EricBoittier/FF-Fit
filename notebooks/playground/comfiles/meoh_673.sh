...
export INPFILE=meoh_673.com
export OUTFILE=meoh_673.out
export CHKFILE=meoh_673.chk
export FCKFILE=meoh_673.fchk
export DNSFILE=meoh_673.d.cube
export ESPFILE=meoh_673.p.cube
