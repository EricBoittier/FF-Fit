...
export INPFILE=meoh_389.com
export OUTFILE=meoh_389.out
export CHKFILE=meoh_389.chk
export FCKFILE=meoh_389.fchk
export DNSFILE=meoh_389.d.cube
export ESPFILE=meoh_389.p.cube
