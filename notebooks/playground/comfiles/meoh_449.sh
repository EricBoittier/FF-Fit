...
export INPFILE=meoh_449.com
export OUTFILE=meoh_449.out
export CHKFILE=meoh_449.chk
export FCKFILE=meoh_449.fchk
export DNSFILE=meoh_449.d.cube
export ESPFILE=meoh_449.p.cube
