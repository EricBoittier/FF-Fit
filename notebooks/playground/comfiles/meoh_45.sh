...
export INPFILE=meoh_45.com
export OUTFILE=meoh_45.out
export CHKFILE=meoh_45.chk
export FCKFILE=meoh_45.fchk
export DNSFILE=meoh_45.d.cube
export ESPFILE=meoh_45.p.cube
