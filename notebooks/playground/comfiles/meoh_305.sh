...
export INPFILE=meoh_305.com
export OUTFILE=meoh_305.out
export CHKFILE=meoh_305.chk
export FCKFILE=meoh_305.fchk
export DNSFILE=meoh_305.d.cube
export ESPFILE=meoh_305.p.cube
