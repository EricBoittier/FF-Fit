...
export INPFILE=meoh_933.com
export OUTFILE=meoh_933.out
export CHKFILE=meoh_933.chk
export FCKFILE=meoh_933.fchk
export DNSFILE=meoh_933.d.cube
export ESPFILE=meoh_933.p.cube
