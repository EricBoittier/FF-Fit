...
export INPFILE=meoh_896.com
export OUTFILE=meoh_896.out
export CHKFILE=meoh_896.chk
export FCKFILE=meoh_896.fchk
export DNSFILE=meoh_896.d.cube
export ESPFILE=meoh_896.p.cube
