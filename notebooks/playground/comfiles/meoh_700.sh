...
export INPFILE=meoh_700.com
export OUTFILE=meoh_700.out
export CHKFILE=meoh_700.chk
export FCKFILE=meoh_700.fchk
export DNSFILE=meoh_700.d.cube
export ESPFILE=meoh_700.p.cube
