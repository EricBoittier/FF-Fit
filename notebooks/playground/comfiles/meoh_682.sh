...
export INPFILE=meoh_682.com
export OUTFILE=meoh_682.out
export CHKFILE=meoh_682.chk
export FCKFILE=meoh_682.fchk
export DNSFILE=meoh_682.d.cube
export ESPFILE=meoh_682.p.cube
