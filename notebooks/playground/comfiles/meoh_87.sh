...
export INPFILE=meoh_87.com
export OUTFILE=meoh_87.out
export CHKFILE=meoh_87.chk
export FCKFILE=meoh_87.fchk
export DNSFILE=meoh_87.d.cube
export ESPFILE=meoh_87.p.cube
