...
export INPFILE=meoh_103.com
export OUTFILE=meoh_103.out
export CHKFILE=meoh_103.chk
export FCKFILE=meoh_103.fchk
export DNSFILE=meoh_103.d.cube
export ESPFILE=meoh_103.p.cube
