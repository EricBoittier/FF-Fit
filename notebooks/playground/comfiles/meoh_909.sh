...
export INPFILE=meoh_909.com
export OUTFILE=meoh_909.out
export CHKFILE=meoh_909.chk
export FCKFILE=meoh_909.fchk
export DNSFILE=meoh_909.d.cube
export ESPFILE=meoh_909.p.cube
