...
export INPFILE=meoh_41.com
export OUTFILE=meoh_41.out
export CHKFILE=meoh_41.chk
export FCKFILE=meoh_41.fchk
export DNSFILE=meoh_41.d.cube
export ESPFILE=meoh_41.p.cube
