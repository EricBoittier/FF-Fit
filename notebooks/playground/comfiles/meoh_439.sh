...
export INPFILE=meoh_439.com
export OUTFILE=meoh_439.out
export CHKFILE=meoh_439.chk
export FCKFILE=meoh_439.fchk
export DNSFILE=meoh_439.d.cube
export ESPFILE=meoh_439.p.cube
