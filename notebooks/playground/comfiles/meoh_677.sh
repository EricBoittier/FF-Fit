...
export INPFILE=meoh_677.com
export OUTFILE=meoh_677.out
export CHKFILE=meoh_677.chk
export FCKFILE=meoh_677.fchk
export DNSFILE=meoh_677.d.cube
export ESPFILE=meoh_677.p.cube
