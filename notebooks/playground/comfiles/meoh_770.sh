...
export INPFILE=meoh_770.com
export OUTFILE=meoh_770.out
export CHKFILE=meoh_770.chk
export FCKFILE=meoh_770.fchk
export DNSFILE=meoh_770.d.cube
export ESPFILE=meoh_770.p.cube
