...
export INPFILE=meoh_533.com
export OUTFILE=meoh_533.out
export CHKFILE=meoh_533.chk
export FCKFILE=meoh_533.fchk
export DNSFILE=meoh_533.d.cube
export ESPFILE=meoh_533.p.cube
