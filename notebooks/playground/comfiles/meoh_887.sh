...
export INPFILE=meoh_887.com
export OUTFILE=meoh_887.out
export CHKFILE=meoh_887.chk
export FCKFILE=meoh_887.fchk
export DNSFILE=meoh_887.d.cube
export ESPFILE=meoh_887.p.cube
