...
export INPFILE=meoh_473.com
export OUTFILE=meoh_473.out
export CHKFILE=meoh_473.chk
export FCKFILE=meoh_473.fchk
export DNSFILE=meoh_473.d.cube
export ESPFILE=meoh_473.p.cube
