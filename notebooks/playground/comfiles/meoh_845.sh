...
export INPFILE=meoh_845.com
export OUTFILE=meoh_845.out
export CHKFILE=meoh_845.chk
export FCKFILE=meoh_845.fchk
export DNSFILE=meoh_845.d.cube
export ESPFILE=meoh_845.p.cube
