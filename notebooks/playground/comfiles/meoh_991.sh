...
export INPFILE=meoh_991.com
export OUTFILE=meoh_991.out
export CHKFILE=meoh_991.chk
export FCKFILE=meoh_991.fchk
export DNSFILE=meoh_991.d.cube
export ESPFILE=meoh_991.p.cube
