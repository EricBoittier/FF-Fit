...
export INPFILE=meoh_277.com
export OUTFILE=meoh_277.out
export CHKFILE=meoh_277.chk
export FCKFILE=meoh_277.fchk
export DNSFILE=meoh_277.d.cube
export ESPFILE=meoh_277.p.cube
