...
export INPFILE=meoh_982.com
export OUTFILE=meoh_982.out
export CHKFILE=meoh_982.chk
export FCKFILE=meoh_982.fchk
export DNSFILE=meoh_982.d.cube
export ESPFILE=meoh_982.p.cube
