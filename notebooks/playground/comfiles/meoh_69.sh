...
export INPFILE=meoh_69.com
export OUTFILE=meoh_69.out
export CHKFILE=meoh_69.chk
export FCKFILE=meoh_69.fchk
export DNSFILE=meoh_69.d.cube
export ESPFILE=meoh_69.p.cube
