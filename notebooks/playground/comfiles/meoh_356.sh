...
export INPFILE=meoh_356.com
export OUTFILE=meoh_356.out
export CHKFILE=meoh_356.chk
export FCKFILE=meoh_356.fchk
export DNSFILE=meoh_356.d.cube
export ESPFILE=meoh_356.p.cube
