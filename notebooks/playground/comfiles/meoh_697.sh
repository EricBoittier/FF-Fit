...
export INPFILE=meoh_697.com
export OUTFILE=meoh_697.out
export CHKFILE=meoh_697.chk
export FCKFILE=meoh_697.fchk
export DNSFILE=meoh_697.d.cube
export ESPFILE=meoh_697.p.cube
