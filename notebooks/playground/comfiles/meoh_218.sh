...
export INPFILE=meoh_218.com
export OUTFILE=meoh_218.out
export CHKFILE=meoh_218.chk
export FCKFILE=meoh_218.fchk
export DNSFILE=meoh_218.d.cube
export ESPFILE=meoh_218.p.cube
