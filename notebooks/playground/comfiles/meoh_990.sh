...
export INPFILE=meoh_990.com
export OUTFILE=meoh_990.out
export CHKFILE=meoh_990.chk
export FCKFILE=meoh_990.fchk
export DNSFILE=meoh_990.d.cube
export ESPFILE=meoh_990.p.cube
