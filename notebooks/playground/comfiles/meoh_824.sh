...
export INPFILE=meoh_824.com
export OUTFILE=meoh_824.out
export CHKFILE=meoh_824.chk
export FCKFILE=meoh_824.fchk
export DNSFILE=meoh_824.d.cube
export ESPFILE=meoh_824.p.cube
