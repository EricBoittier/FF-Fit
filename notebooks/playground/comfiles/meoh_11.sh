...
export INPFILE=meoh_11.com
export OUTFILE=meoh_11.out
export CHKFILE=meoh_11.chk
export FCKFILE=meoh_11.fchk
export DNSFILE=meoh_11.d.cube
export ESPFILE=meoh_11.p.cube
