...
export INPFILE=meoh_772.com
export OUTFILE=meoh_772.out
export CHKFILE=meoh_772.chk
export FCKFILE=meoh_772.fchk
export DNSFILE=meoh_772.d.cube
export ESPFILE=meoh_772.p.cube
