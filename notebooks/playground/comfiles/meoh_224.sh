...
export INPFILE=meoh_224.com
export OUTFILE=meoh_224.out
export CHKFILE=meoh_224.chk
export FCKFILE=meoh_224.fchk
export DNSFILE=meoh_224.d.cube
export ESPFILE=meoh_224.p.cube
