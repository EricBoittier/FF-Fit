...
export INPFILE=meoh_366.com
export OUTFILE=meoh_366.out
export CHKFILE=meoh_366.chk
export FCKFILE=meoh_366.fchk
export DNSFILE=meoh_366.d.cube
export ESPFILE=meoh_366.p.cube
