...
export INPFILE=meoh_313.com
export OUTFILE=meoh_313.out
export CHKFILE=meoh_313.chk
export FCKFILE=meoh_313.fchk
export DNSFILE=meoh_313.d.cube
export ESPFILE=meoh_313.p.cube
