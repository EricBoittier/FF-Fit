...
export INPFILE=meoh_490.com
export OUTFILE=meoh_490.out
export CHKFILE=meoh_490.chk
export FCKFILE=meoh_490.fchk
export DNSFILE=meoh_490.d.cube
export ESPFILE=meoh_490.p.cube
