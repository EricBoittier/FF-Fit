...
export INPFILE=meoh_538.com
export OUTFILE=meoh_538.out
export CHKFILE=meoh_538.chk
export FCKFILE=meoh_538.fchk
export DNSFILE=meoh_538.d.cube
export ESPFILE=meoh_538.p.cube
