...
export INPFILE=meoh_114.com
export OUTFILE=meoh_114.out
export CHKFILE=meoh_114.chk
export FCKFILE=meoh_114.fchk
export DNSFILE=meoh_114.d.cube
export ESPFILE=meoh_114.p.cube
