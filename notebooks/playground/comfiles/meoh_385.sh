...
export INPFILE=meoh_385.com
export OUTFILE=meoh_385.out
export CHKFILE=meoh_385.chk
export FCKFILE=meoh_385.fchk
export DNSFILE=meoh_385.d.cube
export ESPFILE=meoh_385.p.cube
