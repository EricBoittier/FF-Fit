...
export INPFILE=meoh_99.com
export OUTFILE=meoh_99.out
export CHKFILE=meoh_99.chk
export FCKFILE=meoh_99.fchk
export DNSFILE=meoh_99.d.cube
export ESPFILE=meoh_99.p.cube
