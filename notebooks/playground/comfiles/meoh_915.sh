...
export INPFILE=meoh_915.com
export OUTFILE=meoh_915.out
export CHKFILE=meoh_915.chk
export FCKFILE=meoh_915.fchk
export DNSFILE=meoh_915.d.cube
export ESPFILE=meoh_915.p.cube
