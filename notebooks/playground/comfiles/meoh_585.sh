...
export INPFILE=meoh_585.com
export OUTFILE=meoh_585.out
export CHKFILE=meoh_585.chk
export FCKFILE=meoh_585.fchk
export DNSFILE=meoh_585.d.cube
export ESPFILE=meoh_585.p.cube
