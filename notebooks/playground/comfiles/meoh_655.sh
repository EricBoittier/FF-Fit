...
export INPFILE=meoh_655.com
export OUTFILE=meoh_655.out
export CHKFILE=meoh_655.chk
export FCKFILE=meoh_655.fchk
export DNSFILE=meoh_655.d.cube
export ESPFILE=meoh_655.p.cube
