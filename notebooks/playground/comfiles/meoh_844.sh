...
export INPFILE=meoh_844.com
export OUTFILE=meoh_844.out
export CHKFILE=meoh_844.chk
export FCKFILE=meoh_844.fchk
export DNSFILE=meoh_844.d.cube
export ESPFILE=meoh_844.p.cube
