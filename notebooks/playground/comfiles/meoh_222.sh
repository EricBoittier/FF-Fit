...
export INPFILE=meoh_222.com
export OUTFILE=meoh_222.out
export CHKFILE=meoh_222.chk
export FCKFILE=meoh_222.fchk
export DNSFILE=meoh_222.d.cube
export ESPFILE=meoh_222.p.cube
