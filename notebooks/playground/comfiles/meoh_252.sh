...
export INPFILE=meoh_252.com
export OUTFILE=meoh_252.out
export CHKFILE=meoh_252.chk
export FCKFILE=meoh_252.fchk
export DNSFILE=meoh_252.d.cube
export ESPFILE=meoh_252.p.cube
