...
export INPFILE=meoh_320.com
export OUTFILE=meoh_320.out
export CHKFILE=meoh_320.chk
export FCKFILE=meoh_320.fchk
export DNSFILE=meoh_320.d.cube
export ESPFILE=meoh_320.p.cube
