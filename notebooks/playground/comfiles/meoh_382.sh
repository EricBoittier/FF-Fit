...
export INPFILE=meoh_382.com
export OUTFILE=meoh_382.out
export CHKFILE=meoh_382.chk
export FCKFILE=meoh_382.fchk
export DNSFILE=meoh_382.d.cube
export ESPFILE=meoh_382.p.cube
