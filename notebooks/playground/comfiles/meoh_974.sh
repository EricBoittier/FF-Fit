...
export INPFILE=meoh_974.com
export OUTFILE=meoh_974.out
export CHKFILE=meoh_974.chk
export FCKFILE=meoh_974.fchk
export DNSFILE=meoh_974.d.cube
export ESPFILE=meoh_974.p.cube
