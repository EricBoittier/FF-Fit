...
export INPFILE=meoh_616.com
export OUTFILE=meoh_616.out
export CHKFILE=meoh_616.chk
export FCKFILE=meoh_616.fchk
export DNSFILE=meoh_616.d.cube
export ESPFILE=meoh_616.p.cube
