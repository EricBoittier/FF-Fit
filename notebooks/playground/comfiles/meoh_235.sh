...
export INPFILE=meoh_235.com
export OUTFILE=meoh_235.out
export CHKFILE=meoh_235.chk
export FCKFILE=meoh_235.fchk
export DNSFILE=meoh_235.d.cube
export ESPFILE=meoh_235.p.cube
