...
export INPFILE=meoh_930.com
export OUTFILE=meoh_930.out
export CHKFILE=meoh_930.chk
export FCKFILE=meoh_930.fchk
export DNSFILE=meoh_930.d.cube
export ESPFILE=meoh_930.p.cube
