...
export INPFILE=meoh_849.com
export OUTFILE=meoh_849.out
export CHKFILE=meoh_849.chk
export FCKFILE=meoh_849.fchk
export DNSFILE=meoh_849.d.cube
export ESPFILE=meoh_849.p.cube
