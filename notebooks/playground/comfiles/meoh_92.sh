...
export INPFILE=meoh_92.com
export OUTFILE=meoh_92.out
export CHKFILE=meoh_92.chk
export FCKFILE=meoh_92.fchk
export DNSFILE=meoh_92.d.cube
export ESPFILE=meoh_92.p.cube
