...
export INPFILE=meoh_595.com
export OUTFILE=meoh_595.out
export CHKFILE=meoh_595.chk
export FCKFILE=meoh_595.fchk
export DNSFILE=meoh_595.d.cube
export ESPFILE=meoh_595.p.cube
