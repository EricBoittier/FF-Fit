...
export INPFILE=meoh_856.com
export OUTFILE=meoh_856.out
export CHKFILE=meoh_856.chk
export FCKFILE=meoh_856.fchk
export DNSFILE=meoh_856.d.cube
export ESPFILE=meoh_856.p.cube
