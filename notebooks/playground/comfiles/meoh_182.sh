...
export INPFILE=meoh_182.com
export OUTFILE=meoh_182.out
export CHKFILE=meoh_182.chk
export FCKFILE=meoh_182.fchk
export DNSFILE=meoh_182.d.cube
export ESPFILE=meoh_182.p.cube
