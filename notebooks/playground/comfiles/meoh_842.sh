...
export INPFILE=meoh_842.com
export OUTFILE=meoh_842.out
export CHKFILE=meoh_842.chk
export FCKFILE=meoh_842.fchk
export DNSFILE=meoh_842.d.cube
export ESPFILE=meoh_842.p.cube
