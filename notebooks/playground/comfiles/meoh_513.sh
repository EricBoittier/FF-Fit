...
export INPFILE=meoh_513.com
export OUTFILE=meoh_513.out
export CHKFILE=meoh_513.chk
export FCKFILE=meoh_513.fchk
export DNSFILE=meoh_513.d.cube
export ESPFILE=meoh_513.p.cube
