...
export INPFILE=meoh_562.com
export OUTFILE=meoh_562.out
export CHKFILE=meoh_562.chk
export FCKFILE=meoh_562.fchk
export DNSFILE=meoh_562.d.cube
export ESPFILE=meoh_562.p.cube
