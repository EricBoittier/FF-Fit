...
export INPFILE=meoh_984.com
export OUTFILE=meoh_984.out
export CHKFILE=meoh_984.chk
export FCKFILE=meoh_984.fchk
export DNSFILE=meoh_984.d.cube
export ESPFILE=meoh_984.p.cube
