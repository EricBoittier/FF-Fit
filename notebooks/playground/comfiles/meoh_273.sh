...
export INPFILE=meoh_273.com
export OUTFILE=meoh_273.out
export CHKFILE=meoh_273.chk
export FCKFILE=meoh_273.fchk
export DNSFILE=meoh_273.d.cube
export ESPFILE=meoh_273.p.cube
