...
export INPFILE=meoh_728.com
export OUTFILE=meoh_728.out
export CHKFILE=meoh_728.chk
export FCKFILE=meoh_728.fchk
export DNSFILE=meoh_728.d.cube
export ESPFILE=meoh_728.p.cube
