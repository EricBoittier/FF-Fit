...
export INPFILE=meoh_146.com
export OUTFILE=meoh_146.out
export CHKFILE=meoh_146.chk
export FCKFILE=meoh_146.fchk
export DNSFILE=meoh_146.d.cube
export ESPFILE=meoh_146.p.cube
