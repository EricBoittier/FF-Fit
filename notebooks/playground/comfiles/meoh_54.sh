...
export INPFILE=meoh_54.com
export OUTFILE=meoh_54.out
export CHKFILE=meoh_54.chk
export FCKFILE=meoh_54.fchk
export DNSFILE=meoh_54.d.cube
export ESPFILE=meoh_54.p.cube
