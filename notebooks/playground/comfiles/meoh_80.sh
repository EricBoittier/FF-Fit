...
export INPFILE=meoh_80.com
export OUTFILE=meoh_80.out
export CHKFILE=meoh_80.chk
export FCKFILE=meoh_80.fchk
export DNSFILE=meoh_80.d.cube
export ESPFILE=meoh_80.p.cube
