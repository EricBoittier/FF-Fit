...
export INPFILE=meoh_892.com
export OUTFILE=meoh_892.out
export CHKFILE=meoh_892.chk
export FCKFILE=meoh_892.fchk
export DNSFILE=meoh_892.d.cube
export ESPFILE=meoh_892.p.cube
