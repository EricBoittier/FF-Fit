...
export INPFILE=meoh_317.com
export OUTFILE=meoh_317.out
export CHKFILE=meoh_317.chk
export FCKFILE=meoh_317.fchk
export DNSFILE=meoh_317.d.cube
export ESPFILE=meoh_317.p.cube
