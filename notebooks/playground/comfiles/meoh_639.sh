...
export INPFILE=meoh_639.com
export OUTFILE=meoh_639.out
export CHKFILE=meoh_639.chk
export FCKFILE=meoh_639.fchk
export DNSFILE=meoh_639.d.cube
export ESPFILE=meoh_639.p.cube
