...
export INPFILE=meoh_518.com
export OUTFILE=meoh_518.out
export CHKFILE=meoh_518.chk
export FCKFILE=meoh_518.fchk
export DNSFILE=meoh_518.d.cube
export ESPFILE=meoh_518.p.cube
