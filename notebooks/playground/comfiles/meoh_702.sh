...
export INPFILE=meoh_702.com
export OUTFILE=meoh_702.out
export CHKFILE=meoh_702.chk
export FCKFILE=meoh_702.fchk
export DNSFILE=meoh_702.d.cube
export ESPFILE=meoh_702.p.cube
