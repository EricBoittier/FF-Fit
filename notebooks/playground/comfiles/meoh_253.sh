...
export INPFILE=meoh_253.com
export OUTFILE=meoh_253.out
export CHKFILE=meoh_253.chk
export FCKFILE=meoh_253.fchk
export DNSFILE=meoh_253.d.cube
export ESPFILE=meoh_253.p.cube
