...
export INPFILE=meoh_155.com
export OUTFILE=meoh_155.out
export CHKFILE=meoh_155.chk
export FCKFILE=meoh_155.fchk
export DNSFILE=meoh_155.d.cube
export ESPFILE=meoh_155.p.cube
