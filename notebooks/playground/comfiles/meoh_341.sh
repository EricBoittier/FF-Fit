...
export INPFILE=meoh_341.com
export OUTFILE=meoh_341.out
export CHKFILE=meoh_341.chk
export FCKFILE=meoh_341.fchk
export DNSFILE=meoh_341.d.cube
export ESPFILE=meoh_341.p.cube
