...
export INPFILE=meoh_17.com
export OUTFILE=meoh_17.out
export CHKFILE=meoh_17.chk
export FCKFILE=meoh_17.fchk
export DNSFILE=meoh_17.d.cube
export ESPFILE=meoh_17.p.cube
