...
export INPFILE=meoh_809.com
export OUTFILE=meoh_809.out
export CHKFILE=meoh_809.chk
export FCKFILE=meoh_809.fchk
export DNSFILE=meoh_809.d.cube
export ESPFILE=meoh_809.p.cube
