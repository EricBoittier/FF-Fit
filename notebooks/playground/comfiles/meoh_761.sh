...
export INPFILE=meoh_761.com
export OUTFILE=meoh_761.out
export CHKFILE=meoh_761.chk
export FCKFILE=meoh_761.fchk
export DNSFILE=meoh_761.d.cube
export ESPFILE=meoh_761.p.cube
