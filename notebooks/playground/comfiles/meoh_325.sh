...
export INPFILE=meoh_325.com
export OUTFILE=meoh_325.out
export CHKFILE=meoh_325.chk
export FCKFILE=meoh_325.fchk
export DNSFILE=meoh_325.d.cube
export ESPFILE=meoh_325.p.cube
