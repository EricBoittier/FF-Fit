...
export INPFILE=meoh_6.com
export OUTFILE=meoh_6.out
export CHKFILE=meoh_6.chk
export FCKFILE=meoh_6.fchk
export DNSFILE=meoh_6.d.cube
export ESPFILE=meoh_6.p.cube
