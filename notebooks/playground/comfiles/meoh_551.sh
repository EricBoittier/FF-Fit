...
export INPFILE=meoh_551.com
export OUTFILE=meoh_551.out
export CHKFILE=meoh_551.chk
export FCKFILE=meoh_551.fchk
export DNSFILE=meoh_551.d.cube
export ESPFILE=meoh_551.p.cube
