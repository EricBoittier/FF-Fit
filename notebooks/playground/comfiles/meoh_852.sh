...
export INPFILE=meoh_852.com
export OUTFILE=meoh_852.out
export CHKFILE=meoh_852.chk
export FCKFILE=meoh_852.fchk
export DNSFILE=meoh_852.d.cube
export ESPFILE=meoh_852.p.cube
