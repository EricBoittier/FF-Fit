...
export INPFILE=meoh_34.com
export OUTFILE=meoh_34.out
export CHKFILE=meoh_34.chk
export FCKFILE=meoh_34.fchk
export DNSFILE=meoh_34.d.cube
export ESPFILE=meoh_34.p.cube
