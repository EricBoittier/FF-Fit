...
export INPFILE=meoh_244.com
export OUTFILE=meoh_244.out
export CHKFILE=meoh_244.chk
export FCKFILE=meoh_244.fchk
export DNSFILE=meoh_244.d.cube
export ESPFILE=meoh_244.p.cube
