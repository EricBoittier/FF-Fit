...
export INPFILE=meoh_717.com
export OUTFILE=meoh_717.out
export CHKFILE=meoh_717.chk
export FCKFILE=meoh_717.fchk
export DNSFILE=meoh_717.d.cube
export ESPFILE=meoh_717.p.cube
