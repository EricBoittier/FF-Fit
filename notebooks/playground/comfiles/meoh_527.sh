...
export INPFILE=meoh_527.com
export OUTFILE=meoh_527.out
export CHKFILE=meoh_527.chk
export FCKFILE=meoh_527.fchk
export DNSFILE=meoh_527.d.cube
export ESPFILE=meoh_527.p.cube
