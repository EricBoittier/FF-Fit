...
export INPFILE=meoh_301.com
export OUTFILE=meoh_301.out
export CHKFILE=meoh_301.chk
export FCKFILE=meoh_301.fchk
export DNSFILE=meoh_301.d.cube
export ESPFILE=meoh_301.p.cube
