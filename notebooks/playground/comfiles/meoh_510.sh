...
export INPFILE=meoh_510.com
export OUTFILE=meoh_510.out
export CHKFILE=meoh_510.chk
export FCKFILE=meoh_510.fchk
export DNSFILE=meoh_510.d.cube
export ESPFILE=meoh_510.p.cube
