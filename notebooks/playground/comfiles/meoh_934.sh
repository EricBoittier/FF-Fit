...
export INPFILE=meoh_934.com
export OUTFILE=meoh_934.out
export CHKFILE=meoh_934.chk
export FCKFILE=meoh_934.fchk
export DNSFILE=meoh_934.d.cube
export ESPFILE=meoh_934.p.cube
