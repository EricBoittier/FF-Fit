...
export INPFILE=meoh_167.com
export OUTFILE=meoh_167.out
export CHKFILE=meoh_167.chk
export FCKFILE=meoh_167.fchk
export DNSFILE=meoh_167.d.cube
export ESPFILE=meoh_167.p.cube
