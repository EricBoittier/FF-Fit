...
export INPFILE=meoh_507.com
export OUTFILE=meoh_507.out
export CHKFILE=meoh_507.chk
export FCKFILE=meoh_507.fchk
export DNSFILE=meoh_507.d.cube
export ESPFILE=meoh_507.p.cube
