...
export INPFILE=meoh_790.com
export OUTFILE=meoh_790.out
export CHKFILE=meoh_790.chk
export FCKFILE=meoh_790.fchk
export DNSFILE=meoh_790.d.cube
export ESPFILE=meoh_790.p.cube
