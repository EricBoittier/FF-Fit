...
export INPFILE=meoh_719.com
export OUTFILE=meoh_719.out
export CHKFILE=meoh_719.chk
export FCKFILE=meoh_719.fchk
export DNSFILE=meoh_719.d.cube
export ESPFILE=meoh_719.p.cube
