...
export INPFILE=meoh_126.com
export OUTFILE=meoh_126.out
export CHKFILE=meoh_126.chk
export FCKFILE=meoh_126.fchk
export DNSFILE=meoh_126.d.cube
export ESPFILE=meoh_126.p.cube
