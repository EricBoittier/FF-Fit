...
export INPFILE=meoh_488.com
export OUTFILE=meoh_488.out
export CHKFILE=meoh_488.chk
export FCKFILE=meoh_488.fchk
export DNSFILE=meoh_488.d.cube
export ESPFILE=meoh_488.p.cube
