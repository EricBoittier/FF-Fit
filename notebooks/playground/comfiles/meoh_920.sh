...
export INPFILE=meoh_920.com
export OUTFILE=meoh_920.out
export CHKFILE=meoh_920.chk
export FCKFILE=meoh_920.fchk
export DNSFILE=meoh_920.d.cube
export ESPFILE=meoh_920.p.cube
