...
export INPFILE=meoh_247.com
export OUTFILE=meoh_247.out
export CHKFILE=meoh_247.chk
export FCKFILE=meoh_247.fchk
export DNSFILE=meoh_247.d.cube
export ESPFILE=meoh_247.p.cube
