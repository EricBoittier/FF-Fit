...
export INPFILE=meoh_36.com
export OUTFILE=meoh_36.out
export CHKFILE=meoh_36.chk
export FCKFILE=meoh_36.fchk
export DNSFILE=meoh_36.d.cube
export ESPFILE=meoh_36.p.cube
