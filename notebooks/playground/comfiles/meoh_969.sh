...
export INPFILE=meoh_969.com
export OUTFILE=meoh_969.out
export CHKFILE=meoh_969.chk
export FCKFILE=meoh_969.fchk
export DNSFILE=meoh_969.d.cube
export ESPFILE=meoh_969.p.cube
