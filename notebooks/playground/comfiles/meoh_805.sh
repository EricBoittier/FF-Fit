...
export INPFILE=meoh_805.com
export OUTFILE=meoh_805.out
export CHKFILE=meoh_805.chk
export FCKFILE=meoh_805.fchk
export DNSFILE=meoh_805.d.cube
export ESPFILE=meoh_805.p.cube
