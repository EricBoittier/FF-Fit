...
export INPFILE=meoh_175.com
export OUTFILE=meoh_175.out
export CHKFILE=meoh_175.chk
export FCKFILE=meoh_175.fchk
export DNSFILE=meoh_175.d.cube
export ESPFILE=meoh_175.p.cube
