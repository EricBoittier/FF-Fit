...
export INPFILE=meoh_519.com
export OUTFILE=meoh_519.out
export CHKFILE=meoh_519.chk
export FCKFILE=meoh_519.fchk
export DNSFILE=meoh_519.d.cube
export ESPFILE=meoh_519.p.cube
