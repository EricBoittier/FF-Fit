...
export INPFILE=meoh_502.com
export OUTFILE=meoh_502.out
export CHKFILE=meoh_502.chk
export FCKFILE=meoh_502.fchk
export DNSFILE=meoh_502.d.cube
export ESPFILE=meoh_502.p.cube
