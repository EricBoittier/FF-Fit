...
export INPFILE=meoh_91.com
export OUTFILE=meoh_91.out
export CHKFILE=meoh_91.chk
export FCKFILE=meoh_91.fchk
export DNSFILE=meoh_91.d.cube
export ESPFILE=meoh_91.p.cube
