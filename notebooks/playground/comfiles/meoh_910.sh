...
export INPFILE=meoh_910.com
export OUTFILE=meoh_910.out
export CHKFILE=meoh_910.chk
export FCKFILE=meoh_910.fchk
export DNSFILE=meoh_910.d.cube
export ESPFILE=meoh_910.p.cube
