...
export INPFILE=meoh_183.com
export OUTFILE=meoh_183.out
export CHKFILE=meoh_183.chk
export FCKFILE=meoh_183.fchk
export DNSFILE=meoh_183.d.cube
export ESPFILE=meoh_183.p.cube
