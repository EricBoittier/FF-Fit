...
export INPFILE=meoh_430.com
export OUTFILE=meoh_430.out
export CHKFILE=meoh_430.chk
export FCKFILE=meoh_430.fchk
export DNSFILE=meoh_430.d.cube
export ESPFILE=meoh_430.p.cube
