...
export INPFILE=meoh_415.com
export OUTFILE=meoh_415.out
export CHKFILE=meoh_415.chk
export FCKFILE=meoh_415.fchk
export DNSFILE=meoh_415.d.cube
export ESPFILE=meoh_415.p.cube
