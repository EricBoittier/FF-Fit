...
export INPFILE=meoh_197.com
export OUTFILE=meoh_197.out
export CHKFILE=meoh_197.chk
export FCKFILE=meoh_197.fchk
export DNSFILE=meoh_197.d.cube
export ESPFILE=meoh_197.p.cube
