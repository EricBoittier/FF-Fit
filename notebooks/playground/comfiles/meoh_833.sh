...
export INPFILE=meoh_833.com
export OUTFILE=meoh_833.out
export CHKFILE=meoh_833.chk
export FCKFILE=meoh_833.fchk
export DNSFILE=meoh_833.d.cube
export ESPFILE=meoh_833.p.cube
