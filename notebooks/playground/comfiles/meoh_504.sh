...
export INPFILE=meoh_504.com
export OUTFILE=meoh_504.out
export CHKFILE=meoh_504.chk
export FCKFILE=meoh_504.fchk
export DNSFILE=meoh_504.d.cube
export ESPFILE=meoh_504.p.cube
