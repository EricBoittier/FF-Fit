...
export INPFILE=meoh_427.com
export OUTFILE=meoh_427.out
export CHKFILE=meoh_427.chk
export FCKFILE=meoh_427.fchk
export DNSFILE=meoh_427.d.cube
export ESPFILE=meoh_427.p.cube
