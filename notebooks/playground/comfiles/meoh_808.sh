...
export INPFILE=meoh_808.com
export OUTFILE=meoh_808.out
export CHKFILE=meoh_808.chk
export FCKFILE=meoh_808.fchk
export DNSFILE=meoh_808.d.cube
export ESPFILE=meoh_808.p.cube
