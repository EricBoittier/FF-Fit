...
export INPFILE=meoh_853.com
export OUTFILE=meoh_853.out
export CHKFILE=meoh_853.chk
export FCKFILE=meoh_853.fchk
export DNSFILE=meoh_853.d.cube
export ESPFILE=meoh_853.p.cube
