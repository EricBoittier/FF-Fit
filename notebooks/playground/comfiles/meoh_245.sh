...
export INPFILE=meoh_245.com
export OUTFILE=meoh_245.out
export CHKFILE=meoh_245.chk
export FCKFILE=meoh_245.fchk
export DNSFILE=meoh_245.d.cube
export ESPFILE=meoh_245.p.cube
