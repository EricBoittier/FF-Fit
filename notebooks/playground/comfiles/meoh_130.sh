...
export INPFILE=meoh_130.com
export OUTFILE=meoh_130.out
export CHKFILE=meoh_130.chk
export FCKFILE=meoh_130.fchk
export DNSFILE=meoh_130.d.cube
export ESPFILE=meoh_130.p.cube
