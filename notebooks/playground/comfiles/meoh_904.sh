...
export INPFILE=meoh_904.com
export OUTFILE=meoh_904.out
export CHKFILE=meoh_904.chk
export FCKFILE=meoh_904.fchk
export DNSFILE=meoh_904.d.cube
export ESPFILE=meoh_904.p.cube
