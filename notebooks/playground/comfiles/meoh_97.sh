...
export INPFILE=meoh_97.com
export OUTFILE=meoh_97.out
export CHKFILE=meoh_97.chk
export FCKFILE=meoh_97.fchk
export DNSFILE=meoh_97.d.cube
export ESPFILE=meoh_97.p.cube
