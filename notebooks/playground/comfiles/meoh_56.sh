...
export INPFILE=meoh_56.com
export OUTFILE=meoh_56.out
export CHKFILE=meoh_56.chk
export FCKFILE=meoh_56.fchk
export DNSFILE=meoh_56.d.cube
export ESPFILE=meoh_56.p.cube
