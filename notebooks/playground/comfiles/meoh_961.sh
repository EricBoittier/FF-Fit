...
export INPFILE=meoh_961.com
export OUTFILE=meoh_961.out
export CHKFILE=meoh_961.chk
export FCKFILE=meoh_961.fchk
export DNSFILE=meoh_961.d.cube
export ESPFILE=meoh_961.p.cube
