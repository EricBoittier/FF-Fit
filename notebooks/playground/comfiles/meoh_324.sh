...
export INPFILE=meoh_324.com
export OUTFILE=meoh_324.out
export CHKFILE=meoh_324.chk
export FCKFILE=meoh_324.fchk
export DNSFILE=meoh_324.d.cube
export ESPFILE=meoh_324.p.cube
