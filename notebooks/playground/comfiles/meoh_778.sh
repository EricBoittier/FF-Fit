...
export INPFILE=meoh_778.com
export OUTFILE=meoh_778.out
export CHKFILE=meoh_778.chk
export FCKFILE=meoh_778.fchk
export DNSFILE=meoh_778.d.cube
export ESPFILE=meoh_778.p.cube
