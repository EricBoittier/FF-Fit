...
export INPFILE=meoh_166.com
export OUTFILE=meoh_166.out
export CHKFILE=meoh_166.chk
export FCKFILE=meoh_166.fchk
export DNSFILE=meoh_166.d.cube
export ESPFILE=meoh_166.p.cube
