...
export INPFILE=meoh_583.com
export OUTFILE=meoh_583.out
export CHKFILE=meoh_583.chk
export FCKFILE=meoh_583.fchk
export DNSFILE=meoh_583.d.cube
export ESPFILE=meoh_583.p.cube
