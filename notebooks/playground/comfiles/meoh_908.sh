...
export INPFILE=meoh_908.com
export OUTFILE=meoh_908.out
export CHKFILE=meoh_908.chk
export FCKFILE=meoh_908.fchk
export DNSFILE=meoh_908.d.cube
export ESPFILE=meoh_908.p.cube
