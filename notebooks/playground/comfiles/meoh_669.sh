...
export INPFILE=meoh_669.com
export OUTFILE=meoh_669.out
export CHKFILE=meoh_669.chk
export FCKFILE=meoh_669.fchk
export DNSFILE=meoh_669.d.cube
export ESPFILE=meoh_669.p.cube
