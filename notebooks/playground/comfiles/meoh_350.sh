...
export INPFILE=meoh_350.com
export OUTFILE=meoh_350.out
export CHKFILE=meoh_350.chk
export FCKFILE=meoh_350.fchk
export DNSFILE=meoh_350.d.cube
export ESPFILE=meoh_350.p.cube
