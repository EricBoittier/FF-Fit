...
export INPFILE=meoh_777.com
export OUTFILE=meoh_777.out
export CHKFILE=meoh_777.chk
export FCKFILE=meoh_777.fchk
export DNSFILE=meoh_777.d.cube
export ESPFILE=meoh_777.p.cube
