...
export INPFILE=meoh_952.com
export OUTFILE=meoh_952.out
export CHKFILE=meoh_952.chk
export FCKFILE=meoh_952.fchk
export DNSFILE=meoh_952.d.cube
export ESPFILE=meoh_952.p.cube
