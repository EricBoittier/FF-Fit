...
export INPFILE=meoh_788.com
export OUTFILE=meoh_788.out
export CHKFILE=meoh_788.chk
export FCKFILE=meoh_788.fchk
export DNSFILE=meoh_788.d.cube
export ESPFILE=meoh_788.p.cube
