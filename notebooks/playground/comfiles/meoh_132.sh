...
export INPFILE=meoh_132.com
export OUTFILE=meoh_132.out
export CHKFILE=meoh_132.chk
export FCKFILE=meoh_132.fchk
export DNSFILE=meoh_132.d.cube
export ESPFILE=meoh_132.p.cube
