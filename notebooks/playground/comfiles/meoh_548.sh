...
export INPFILE=meoh_548.com
export OUTFILE=meoh_548.out
export CHKFILE=meoh_548.chk
export FCKFILE=meoh_548.fchk
export DNSFILE=meoh_548.d.cube
export ESPFILE=meoh_548.p.cube
