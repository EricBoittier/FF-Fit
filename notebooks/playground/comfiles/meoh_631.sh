...
export INPFILE=meoh_631.com
export OUTFILE=meoh_631.out
export CHKFILE=meoh_631.chk
export FCKFILE=meoh_631.fchk
export DNSFILE=meoh_631.d.cube
export ESPFILE=meoh_631.p.cube
