...
export INPFILE=meoh_398.com
export OUTFILE=meoh_398.out
export CHKFILE=meoh_398.chk
export FCKFILE=meoh_398.fchk
export DNSFILE=meoh_398.d.cube
export ESPFILE=meoh_398.p.cube
