...
export INPFILE=meoh_822.com
export OUTFILE=meoh_822.out
export CHKFILE=meoh_822.chk
export FCKFILE=meoh_822.fchk
export DNSFILE=meoh_822.d.cube
export ESPFILE=meoh_822.p.cube
