...
export INPFILE=meoh_754.com
export OUTFILE=meoh_754.out
export CHKFILE=meoh_754.chk
export FCKFILE=meoh_754.fchk
export DNSFILE=meoh_754.d.cube
export ESPFILE=meoh_754.p.cube
