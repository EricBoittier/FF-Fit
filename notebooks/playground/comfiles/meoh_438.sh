...
export INPFILE=meoh_438.com
export OUTFILE=meoh_438.out
export CHKFILE=meoh_438.chk
export FCKFILE=meoh_438.fchk
export DNSFILE=meoh_438.d.cube
export ESPFILE=meoh_438.p.cube
