...
export INPFILE=meoh_508.com
export OUTFILE=meoh_508.out
export CHKFILE=meoh_508.chk
export FCKFILE=meoh_508.fchk
export DNSFILE=meoh_508.d.cube
export ESPFILE=meoh_508.p.cube
