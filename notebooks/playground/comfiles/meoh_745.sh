...
export INPFILE=meoh_745.com
export OUTFILE=meoh_745.out
export CHKFILE=meoh_745.chk
export FCKFILE=meoh_745.fchk
export DNSFILE=meoh_745.d.cube
export ESPFILE=meoh_745.p.cube
