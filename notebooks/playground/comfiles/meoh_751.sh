...
export INPFILE=meoh_751.com
export OUTFILE=meoh_751.out
export CHKFILE=meoh_751.chk
export FCKFILE=meoh_751.fchk
export DNSFILE=meoh_751.d.cube
export ESPFILE=meoh_751.p.cube
