...
export INPFILE=meoh_122.com
export OUTFILE=meoh_122.out
export CHKFILE=meoh_122.chk
export FCKFILE=meoh_122.fchk
export DNSFILE=meoh_122.d.cube
export ESPFILE=meoh_122.p.cube
