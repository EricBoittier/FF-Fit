...
export INPFILE=meoh_891.com
export OUTFILE=meoh_891.out
export CHKFILE=meoh_891.chk
export FCKFILE=meoh_891.fchk
export DNSFILE=meoh_891.d.cube
export ESPFILE=meoh_891.p.cube
