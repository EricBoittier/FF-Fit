...
export INPFILE=meoh_288.com
export OUTFILE=meoh_288.out
export CHKFILE=meoh_288.chk
export FCKFILE=meoh_288.fchk
export DNSFILE=meoh_288.d.cube
export ESPFILE=meoh_288.p.cube
