...
export INPFILE=meoh_336.com
export OUTFILE=meoh_336.out
export CHKFILE=meoh_336.chk
export FCKFILE=meoh_336.fchk
export DNSFILE=meoh_336.d.cube
export ESPFILE=meoh_336.p.cube
