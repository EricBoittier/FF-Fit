...
export INPFILE=meoh_365.com
export OUTFILE=meoh_365.out
export CHKFILE=meoh_365.chk
export FCKFILE=meoh_365.fchk
export DNSFILE=meoh_365.d.cube
export ESPFILE=meoh_365.p.cube
