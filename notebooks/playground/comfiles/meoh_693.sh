...
export INPFILE=meoh_693.com
export OUTFILE=meoh_693.out
export CHKFILE=meoh_693.chk
export FCKFILE=meoh_693.fchk
export DNSFILE=meoh_693.d.cube
export ESPFILE=meoh_693.p.cube
