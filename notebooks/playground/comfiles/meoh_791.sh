...
export INPFILE=meoh_791.com
export OUTFILE=meoh_791.out
export CHKFILE=meoh_791.chk
export FCKFILE=meoh_791.fchk
export DNSFILE=meoh_791.d.cube
export ESPFILE=meoh_791.p.cube
