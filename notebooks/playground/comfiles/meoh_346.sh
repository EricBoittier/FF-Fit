...
export INPFILE=meoh_346.com
export OUTFILE=meoh_346.out
export CHKFILE=meoh_346.chk
export FCKFILE=meoh_346.fchk
export DNSFILE=meoh_346.d.cube
export ESPFILE=meoh_346.p.cube
