...
export INPFILE=meoh_716.com
export OUTFILE=meoh_716.out
export CHKFILE=meoh_716.chk
export FCKFILE=meoh_716.fchk
export DNSFILE=meoh_716.d.cube
export ESPFILE=meoh_716.p.cube
