...
export INPFILE=meoh_942.com
export OUTFILE=meoh_942.out
export CHKFILE=meoh_942.chk
export FCKFILE=meoh_942.fchk
export DNSFILE=meoh_942.d.cube
export ESPFILE=meoh_942.p.cube
