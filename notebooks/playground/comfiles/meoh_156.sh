...
export INPFILE=meoh_156.com
export OUTFILE=meoh_156.out
export CHKFILE=meoh_156.chk
export FCKFILE=meoh_156.fchk
export DNSFILE=meoh_156.d.cube
export ESPFILE=meoh_156.p.cube
