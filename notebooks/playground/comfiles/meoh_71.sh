...
export INPFILE=meoh_71.com
export OUTFILE=meoh_71.out
export CHKFILE=meoh_71.chk
export FCKFILE=meoh_71.fchk
export DNSFILE=meoh_71.d.cube
export ESPFILE=meoh_71.p.cube
