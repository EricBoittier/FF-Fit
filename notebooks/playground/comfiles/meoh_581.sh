...
export INPFILE=meoh_581.com
export OUTFILE=meoh_581.out
export CHKFILE=meoh_581.chk
export FCKFILE=meoh_581.fchk
export DNSFILE=meoh_581.d.cube
export ESPFILE=meoh_581.p.cube
