...
export INPFILE=meoh_49.com
export OUTFILE=meoh_49.out
export CHKFILE=meoh_49.chk
export FCKFILE=meoh_49.fchk
export DNSFILE=meoh_49.d.cube
export ESPFILE=meoh_49.p.cube
