...
export INPFILE=meoh_589.com
export OUTFILE=meoh_589.out
export CHKFILE=meoh_589.chk
export FCKFILE=meoh_589.fchk
export DNSFILE=meoh_589.d.cube
export ESPFILE=meoh_589.p.cube
