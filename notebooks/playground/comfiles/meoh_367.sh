...
export INPFILE=meoh_367.com
export OUTFILE=meoh_367.out
export CHKFILE=meoh_367.chk
export FCKFILE=meoh_367.fchk
export DNSFILE=meoh_367.d.cube
export ESPFILE=meoh_367.p.cube
