...
export INPFILE=meoh_113.com
export OUTFILE=meoh_113.out
export CHKFILE=meoh_113.chk
export FCKFILE=meoh_113.fchk
export DNSFILE=meoh_113.d.cube
export ESPFILE=meoh_113.p.cube
