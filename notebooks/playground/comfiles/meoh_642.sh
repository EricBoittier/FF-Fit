...
export INPFILE=meoh_642.com
export OUTFILE=meoh_642.out
export CHKFILE=meoh_642.chk
export FCKFILE=meoh_642.fchk
export DNSFILE=meoh_642.d.cube
export ESPFILE=meoh_642.p.cube
