...
export INPFILE=meoh_177.com
export OUTFILE=meoh_177.out
export CHKFILE=meoh_177.chk
export FCKFILE=meoh_177.fchk
export DNSFILE=meoh_177.d.cube
export ESPFILE=meoh_177.p.cube
