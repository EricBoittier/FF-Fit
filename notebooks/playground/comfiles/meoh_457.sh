...
export INPFILE=meoh_457.com
export OUTFILE=meoh_457.out
export CHKFILE=meoh_457.chk
export FCKFILE=meoh_457.fchk
export DNSFILE=meoh_457.d.cube
export ESPFILE=meoh_457.p.cube
