...
export INPFILE=meoh_566.com
export OUTFILE=meoh_566.out
export CHKFILE=meoh_566.chk
export FCKFILE=meoh_566.fchk
export DNSFILE=meoh_566.d.cube
export ESPFILE=meoh_566.p.cube
