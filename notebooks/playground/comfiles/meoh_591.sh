...
export INPFILE=meoh_591.com
export OUTFILE=meoh_591.out
export CHKFILE=meoh_591.chk
export FCKFILE=meoh_591.fchk
export DNSFILE=meoh_591.d.cube
export ESPFILE=meoh_591.p.cube
