...
export INPFILE=meoh_55.com
export OUTFILE=meoh_55.out
export CHKFILE=meoh_55.chk
export FCKFILE=meoh_55.fchk
export DNSFILE=meoh_55.d.cube
export ESPFILE=meoh_55.p.cube
