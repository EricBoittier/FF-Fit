...
export INPFILE=meoh_403.com
export OUTFILE=meoh_403.out
export CHKFILE=meoh_403.chk
export FCKFILE=meoh_403.fchk
export DNSFILE=meoh_403.d.cube
export ESPFILE=meoh_403.p.cube
