...
export INPFILE=meoh_599.com
export OUTFILE=meoh_599.out
export CHKFILE=meoh_599.chk
export FCKFILE=meoh_599.fchk
export DNSFILE=meoh_599.d.cube
export ESPFILE=meoh_599.p.cube
