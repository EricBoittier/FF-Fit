...
export INPFILE=meoh_428.com
export OUTFILE=meoh_428.out
export CHKFILE=meoh_428.chk
export FCKFILE=meoh_428.fchk
export DNSFILE=meoh_428.d.cube
export ESPFILE=meoh_428.p.cube
