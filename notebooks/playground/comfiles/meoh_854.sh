...
export INPFILE=meoh_854.com
export OUTFILE=meoh_854.out
export CHKFILE=meoh_854.chk
export FCKFILE=meoh_854.fchk
export DNSFILE=meoh_854.d.cube
export ESPFILE=meoh_854.p.cube
