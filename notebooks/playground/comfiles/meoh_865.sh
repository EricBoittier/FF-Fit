...
export INPFILE=meoh_865.com
export OUTFILE=meoh_865.out
export CHKFILE=meoh_865.chk
export FCKFILE=meoh_865.fchk
export DNSFILE=meoh_865.d.cube
export ESPFILE=meoh_865.p.cube
