...
export INPFILE=meoh_425.com
export OUTFILE=meoh_425.out
export CHKFILE=meoh_425.chk
export FCKFILE=meoh_425.fchk
export DNSFILE=meoh_425.d.cube
export ESPFILE=meoh_425.p.cube
