...
export INPFILE=meoh_376.com
export OUTFILE=meoh_376.out
export CHKFILE=meoh_376.chk
export FCKFILE=meoh_376.fchk
export DNSFILE=meoh_376.d.cube
export ESPFILE=meoh_376.p.cube
