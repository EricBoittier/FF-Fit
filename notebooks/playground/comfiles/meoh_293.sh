...
export INPFILE=meoh_293.com
export OUTFILE=meoh_293.out
export CHKFILE=meoh_293.chk
export FCKFILE=meoh_293.fchk
export DNSFILE=meoh_293.d.cube
export ESPFILE=meoh_293.p.cube
