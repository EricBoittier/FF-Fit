...
export INPFILE=meoh_360.com
export OUTFILE=meoh_360.out
export CHKFILE=meoh_360.chk
export FCKFILE=meoh_360.fchk
export DNSFILE=meoh_360.d.cube
export ESPFILE=meoh_360.p.cube
