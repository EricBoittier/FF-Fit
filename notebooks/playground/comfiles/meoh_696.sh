...
export INPFILE=meoh_696.com
export OUTFILE=meoh_696.out
export CHKFILE=meoh_696.chk
export FCKFILE=meoh_696.fchk
export DNSFILE=meoh_696.d.cube
export ESPFILE=meoh_696.p.cube
