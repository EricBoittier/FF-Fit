...
export INPFILE=meoh_525.com
export OUTFILE=meoh_525.out
export CHKFILE=meoh_525.chk
export FCKFILE=meoh_525.fchk
export DNSFILE=meoh_525.d.cube
export ESPFILE=meoh_525.p.cube
