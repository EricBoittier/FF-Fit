...
export INPFILE=meoh_24.com
export OUTFILE=meoh_24.out
export CHKFILE=meoh_24.chk
export FCKFILE=meoh_24.fchk
export DNSFILE=meoh_24.d.cube
export ESPFILE=meoh_24.p.cube
