...
export INPFILE=meoh_872.com
export OUTFILE=meoh_872.out
export CHKFILE=meoh_872.chk
export FCKFILE=meoh_872.fchk
export DNSFILE=meoh_872.d.cube
export ESPFILE=meoh_872.p.cube
