...
export INPFILE=meoh_202.com
export OUTFILE=meoh_202.out
export CHKFILE=meoh_202.chk
export FCKFILE=meoh_202.fchk
export DNSFILE=meoh_202.d.cube
export ESPFILE=meoh_202.p.cube
