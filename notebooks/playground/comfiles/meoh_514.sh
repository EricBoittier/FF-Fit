...
export INPFILE=meoh_514.com
export OUTFILE=meoh_514.out
export CHKFILE=meoh_514.chk
export FCKFILE=meoh_514.fchk
export DNSFILE=meoh_514.d.cube
export ESPFILE=meoh_514.p.cube
