...
export INPFILE=meoh_819.com
export OUTFILE=meoh_819.out
export CHKFILE=meoh_819.chk
export FCKFILE=meoh_819.fchk
export DNSFILE=meoh_819.d.cube
export ESPFILE=meoh_819.p.cube
