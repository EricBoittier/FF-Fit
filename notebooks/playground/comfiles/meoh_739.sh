...
export INPFILE=meoh_739.com
export OUTFILE=meoh_739.out
export CHKFILE=meoh_739.chk
export FCKFILE=meoh_739.fchk
export DNSFILE=meoh_739.d.cube
export ESPFILE=meoh_739.p.cube
