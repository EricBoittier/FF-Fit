...
export INPFILE=meoh_371.com
export OUTFILE=meoh_371.out
export CHKFILE=meoh_371.chk
export FCKFILE=meoh_371.fchk
export DNSFILE=meoh_371.d.cube
export ESPFILE=meoh_371.p.cube
