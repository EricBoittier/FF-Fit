...
export INPFILE=meoh_42.com
export OUTFILE=meoh_42.out
export CHKFILE=meoh_42.chk
export FCKFILE=meoh_42.fchk
export DNSFILE=meoh_42.d.cube
export ESPFILE=meoh_42.p.cube
