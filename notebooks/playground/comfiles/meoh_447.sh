...
export INPFILE=meoh_447.com
export OUTFILE=meoh_447.out
export CHKFILE=meoh_447.chk
export FCKFILE=meoh_447.fchk
export DNSFILE=meoh_447.d.cube
export ESPFILE=meoh_447.p.cube
