...
export INPFILE=meoh_480.com
export OUTFILE=meoh_480.out
export CHKFILE=meoh_480.chk
export FCKFILE=meoh_480.fchk
export DNSFILE=meoh_480.d.cube
export ESPFILE=meoh_480.p.cube
