...
export INPFILE=meoh_860.com
export OUTFILE=meoh_860.out
export CHKFILE=meoh_860.chk
export FCKFILE=meoh_860.fchk
export DNSFILE=meoh_860.d.cube
export ESPFILE=meoh_860.p.cube
