...
export INPFILE=meoh_310.com
export OUTFILE=meoh_310.out
export CHKFILE=meoh_310.chk
export FCKFILE=meoh_310.fchk
export DNSFILE=meoh_310.d.cube
export ESPFILE=meoh_310.p.cube
