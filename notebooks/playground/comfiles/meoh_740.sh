...
export INPFILE=meoh_740.com
export OUTFILE=meoh_740.out
export CHKFILE=meoh_740.chk
export FCKFILE=meoh_740.fchk
export DNSFILE=meoh_740.d.cube
export ESPFILE=meoh_740.p.cube
