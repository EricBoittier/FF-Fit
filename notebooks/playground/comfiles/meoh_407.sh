...
export INPFILE=meoh_407.com
export OUTFILE=meoh_407.out
export CHKFILE=meoh_407.chk
export FCKFILE=meoh_407.fchk
export DNSFILE=meoh_407.d.cube
export ESPFILE=meoh_407.p.cube
