...
export INPFILE=meoh_543.com
export OUTFILE=meoh_543.out
export CHKFILE=meoh_543.chk
export FCKFILE=meoh_543.fchk
export DNSFILE=meoh_543.d.cube
export ESPFILE=meoh_543.p.cube
