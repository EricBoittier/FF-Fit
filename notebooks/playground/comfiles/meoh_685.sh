...
export INPFILE=meoh_685.com
export OUTFILE=meoh_685.out
export CHKFILE=meoh_685.chk
export FCKFILE=meoh_685.fchk
export DNSFILE=meoh_685.d.cube
export ESPFILE=meoh_685.p.cube
