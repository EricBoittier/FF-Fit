...
export INPFILE=meoh_572.com
export OUTFILE=meoh_572.out
export CHKFILE=meoh_572.chk
export FCKFILE=meoh_572.fchk
export DNSFILE=meoh_572.d.cube
export ESPFILE=meoh_572.p.cube
