...
export INPFILE=meoh_721.com
export OUTFILE=meoh_721.out
export CHKFILE=meoh_721.chk
export FCKFILE=meoh_721.fchk
export DNSFILE=meoh_721.d.cube
export ESPFILE=meoh_721.p.cube
