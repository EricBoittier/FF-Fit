...
export INPFILE=meoh_871.com
export OUTFILE=meoh_871.out
export CHKFILE=meoh_871.chk
export FCKFILE=meoh_871.fchk
export DNSFILE=meoh_871.d.cube
export ESPFILE=meoh_871.p.cube
