...
export INPFILE=meoh_966.com
export OUTFILE=meoh_966.out
export CHKFILE=meoh_966.chk
export FCKFILE=meoh_966.fchk
export DNSFILE=meoh_966.d.cube
export ESPFILE=meoh_966.p.cube
