...
export INPFILE=meoh_674.com
export OUTFILE=meoh_674.out
export CHKFILE=meoh_674.chk
export FCKFILE=meoh_674.fchk
export DNSFILE=meoh_674.d.cube
export ESPFILE=meoh_674.p.cube
