...
export INPFILE=meoh_876.com
export OUTFILE=meoh_876.out
export CHKFILE=meoh_876.chk
export FCKFILE=meoh_876.fchk
export DNSFILE=meoh_876.d.cube
export ESPFILE=meoh_876.p.cube
