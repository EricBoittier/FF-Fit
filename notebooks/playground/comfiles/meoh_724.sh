...
export INPFILE=meoh_724.com
export OUTFILE=meoh_724.out
export CHKFILE=meoh_724.chk
export FCKFILE=meoh_724.fchk
export DNSFILE=meoh_724.d.cube
export ESPFILE=meoh_724.p.cube
