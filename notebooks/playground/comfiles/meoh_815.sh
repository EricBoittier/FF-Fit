...
export INPFILE=meoh_815.com
export OUTFILE=meoh_815.out
export CHKFILE=meoh_815.chk
export FCKFILE=meoh_815.fchk
export DNSFILE=meoh_815.d.cube
export ESPFILE=meoh_815.p.cube
