...
export INPFILE=meoh_840.com
export OUTFILE=meoh_840.out
export CHKFILE=meoh_840.chk
export FCKFILE=meoh_840.fchk
export DNSFILE=meoh_840.d.cube
export ESPFILE=meoh_840.p.cube
