...
export INPFILE=meoh_47.com
export OUTFILE=meoh_47.out
export CHKFILE=meoh_47.chk
export FCKFILE=meoh_47.fchk
export DNSFILE=meoh_47.d.cube
export ESPFILE=meoh_47.p.cube
