...
export INPFILE=meoh_648.com
export OUTFILE=meoh_648.out
export CHKFILE=meoh_648.chk
export FCKFILE=meoh_648.fchk
export DNSFILE=meoh_648.d.cube
export ESPFILE=meoh_648.p.cube
