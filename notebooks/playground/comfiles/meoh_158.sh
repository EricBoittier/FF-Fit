...
export INPFILE=meoh_158.com
export OUTFILE=meoh_158.out
export CHKFILE=meoh_158.chk
export FCKFILE=meoh_158.fchk
export DNSFILE=meoh_158.d.cube
export ESPFILE=meoh_158.p.cube
