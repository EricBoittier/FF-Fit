...
export INPFILE=meoh_637.com
export OUTFILE=meoh_637.out
export CHKFILE=meoh_637.chk
export FCKFILE=meoh_637.fchk
export DNSFILE=meoh_637.d.cube
export ESPFILE=meoh_637.p.cube
