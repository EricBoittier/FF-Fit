...
export INPFILE=meoh_29.com
export OUTFILE=meoh_29.out
export CHKFILE=meoh_29.chk
export FCKFILE=meoh_29.fchk
export DNSFILE=meoh_29.d.cube
export ESPFILE=meoh_29.p.cube
