...
export INPFILE=meoh_580.com
export OUTFILE=meoh_580.out
export CHKFILE=meoh_580.chk
export FCKFILE=meoh_580.fchk
export DNSFILE=meoh_580.d.cube
export ESPFILE=meoh_580.p.cube
