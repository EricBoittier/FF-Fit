...
export INPFILE=meoh_246.com
export OUTFILE=meoh_246.out
export CHKFILE=meoh_246.chk
export FCKFILE=meoh_246.fchk
export DNSFILE=meoh_246.d.cube
export ESPFILE=meoh_246.p.cube
