...
export INPFILE=meoh_43.com
export OUTFILE=meoh_43.out
export CHKFILE=meoh_43.chk
export FCKFILE=meoh_43.fchk
export DNSFILE=meoh_43.d.cube
export ESPFILE=meoh_43.p.cube
