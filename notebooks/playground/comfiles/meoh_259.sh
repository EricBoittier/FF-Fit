...
export INPFILE=meoh_259.com
export OUTFILE=meoh_259.out
export CHKFILE=meoh_259.chk
export FCKFILE=meoh_259.fchk
export DNSFILE=meoh_259.d.cube
export ESPFILE=meoh_259.p.cube
