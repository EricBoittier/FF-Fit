...
export INPFILE=meoh_967.com
export OUTFILE=meoh_967.out
export CHKFILE=meoh_967.chk
export FCKFILE=meoh_967.fchk
export DNSFILE=meoh_967.d.cube
export ESPFILE=meoh_967.p.cube
