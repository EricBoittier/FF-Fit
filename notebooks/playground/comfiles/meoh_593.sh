...
export INPFILE=meoh_593.com
export OUTFILE=meoh_593.out
export CHKFILE=meoh_593.chk
export FCKFILE=meoh_593.fchk
export DNSFILE=meoh_593.d.cube
export ESPFILE=meoh_593.p.cube
