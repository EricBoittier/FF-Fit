...
export INPFILE=meoh_352.com
export OUTFILE=meoh_352.out
export CHKFILE=meoh_352.chk
export FCKFILE=meoh_352.fchk
export DNSFILE=meoh_352.d.cube
export ESPFILE=meoh_352.p.cube
