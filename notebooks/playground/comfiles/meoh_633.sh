...
export INPFILE=meoh_633.com
export OUTFILE=meoh_633.out
export CHKFILE=meoh_633.chk
export FCKFILE=meoh_633.fchk
export DNSFILE=meoh_633.d.cube
export ESPFILE=meoh_633.p.cube
