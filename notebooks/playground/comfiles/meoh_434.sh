...
export INPFILE=meoh_434.com
export OUTFILE=meoh_434.out
export CHKFILE=meoh_434.chk
export FCKFILE=meoh_434.fchk
export DNSFILE=meoh_434.d.cube
export ESPFILE=meoh_434.p.cube
