...
export INPFILE=meoh_94.com
export OUTFILE=meoh_94.out
export CHKFILE=meoh_94.chk
export FCKFILE=meoh_94.fchk
export DNSFILE=meoh_94.d.cube
export ESPFILE=meoh_94.p.cube
