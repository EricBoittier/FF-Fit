...
export INPFILE=meoh_912.com
export OUTFILE=meoh_912.out
export CHKFILE=meoh_912.chk
export FCKFILE=meoh_912.fchk
export DNSFILE=meoh_912.d.cube
export ESPFILE=meoh_912.p.cube
