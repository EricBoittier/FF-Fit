...
export INPFILE=meoh_524.com
export OUTFILE=meoh_524.out
export CHKFILE=meoh_524.chk
export FCKFILE=meoh_524.fchk
export DNSFILE=meoh_524.d.cube
export ESPFILE=meoh_524.p.cube
