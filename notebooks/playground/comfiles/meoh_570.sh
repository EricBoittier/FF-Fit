...
export INPFILE=meoh_570.com
export OUTFILE=meoh_570.out
export CHKFILE=meoh_570.chk
export FCKFILE=meoh_570.fchk
export DNSFILE=meoh_570.d.cube
export ESPFILE=meoh_570.p.cube
