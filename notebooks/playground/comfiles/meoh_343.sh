...
export INPFILE=meoh_343.com
export OUTFILE=meoh_343.out
export CHKFILE=meoh_343.chk
export FCKFILE=meoh_343.fchk
export DNSFILE=meoh_343.d.cube
export ESPFILE=meoh_343.p.cube
