...
export INPFILE=meoh_821.com
export OUTFILE=meoh_821.out
export CHKFILE=meoh_821.chk
export FCKFILE=meoh_821.fchk
export DNSFILE=meoh_821.d.cube
export ESPFILE=meoh_821.p.cube
