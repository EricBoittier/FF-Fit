...
export INPFILE=meoh_2.com
export OUTFILE=meoh_2.out
export CHKFILE=meoh_2.chk
export FCKFILE=meoh_2.fchk
export DNSFILE=meoh_2.d.cube
export ESPFILE=meoh_2.p.cube
