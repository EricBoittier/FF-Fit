...
export INPFILE=meoh_458.com
export OUTFILE=meoh_458.out
export CHKFILE=meoh_458.chk
export FCKFILE=meoh_458.fchk
export DNSFILE=meoh_458.d.cube
export ESPFILE=meoh_458.p.cube
