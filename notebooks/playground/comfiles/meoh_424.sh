...
export INPFILE=meoh_424.com
export OUTFILE=meoh_424.out
export CHKFILE=meoh_424.chk
export FCKFILE=meoh_424.fchk
export DNSFILE=meoh_424.d.cube
export ESPFILE=meoh_424.p.cube
