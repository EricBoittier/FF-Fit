...
export INPFILE=meoh_839.com
export OUTFILE=meoh_839.out
export CHKFILE=meoh_839.chk
export FCKFILE=meoh_839.fchk
export DNSFILE=meoh_839.d.cube
export ESPFILE=meoh_839.p.cube
