...
export INPFILE=meoh_695.com
export OUTFILE=meoh_695.out
export CHKFILE=meoh_695.chk
export FCKFILE=meoh_695.fchk
export DNSFILE=meoh_695.d.cube
export ESPFILE=meoh_695.p.cube
