...
export INPFILE=meoh_731.com
export OUTFILE=meoh_731.out
export CHKFILE=meoh_731.chk
export FCKFILE=meoh_731.fchk
export DNSFILE=meoh_731.d.cube
export ESPFILE=meoh_731.p.cube
