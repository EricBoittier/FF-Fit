...
export INPFILE=meoh_38.com
export OUTFILE=meoh_38.out
export CHKFILE=meoh_38.chk
export FCKFILE=meoh_38.fchk
export DNSFILE=meoh_38.d.cube
export ESPFILE=meoh_38.p.cube
