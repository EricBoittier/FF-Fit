...
export INPFILE=meoh_826.com
export OUTFILE=meoh_826.out
export CHKFILE=meoh_826.chk
export FCKFILE=meoh_826.fchk
export DNSFILE=meoh_826.d.cube
export ESPFILE=meoh_826.p.cube
