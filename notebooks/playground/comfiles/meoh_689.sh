...
export INPFILE=meoh_689.com
export OUTFILE=meoh_689.out
export CHKFILE=meoh_689.chk
export FCKFILE=meoh_689.fchk
export DNSFILE=meoh_689.d.cube
export ESPFILE=meoh_689.p.cube
