...
export INPFILE=meoh_730.com
export OUTFILE=meoh_730.out
export CHKFILE=meoh_730.chk
export FCKFILE=meoh_730.fchk
export DNSFILE=meoh_730.d.cube
export ESPFILE=meoh_730.p.cube
