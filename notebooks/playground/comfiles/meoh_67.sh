...
export INPFILE=meoh_67.com
export OUTFILE=meoh_67.out
export CHKFILE=meoh_67.chk
export FCKFILE=meoh_67.fchk
export DNSFILE=meoh_67.d.cube
export ESPFILE=meoh_67.p.cube
