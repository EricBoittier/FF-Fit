...
export INPFILE=meoh_95.com
export OUTFILE=meoh_95.out
export CHKFILE=meoh_95.chk
export FCKFILE=meoh_95.fchk
export DNSFILE=meoh_95.d.cube
export ESPFILE=meoh_95.p.cube
