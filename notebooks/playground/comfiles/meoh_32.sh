...
export INPFILE=meoh_32.com
export OUTFILE=meoh_32.out
export CHKFILE=meoh_32.chk
export FCKFILE=meoh_32.fchk
export DNSFILE=meoh_32.d.cube
export ESPFILE=meoh_32.p.cube
