...
export INPFILE=meoh_400.com
export OUTFILE=meoh_400.out
export CHKFILE=meoh_400.chk
export FCKFILE=meoh_400.fchk
export DNSFILE=meoh_400.d.cube
export ESPFILE=meoh_400.p.cube
