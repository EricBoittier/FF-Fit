...
export INPFILE=meoh_21.com
export OUTFILE=meoh_21.out
export CHKFILE=meoh_21.chk
export FCKFILE=meoh_21.fchk
export DNSFILE=meoh_21.d.cube
export ESPFILE=meoh_21.p.cube
