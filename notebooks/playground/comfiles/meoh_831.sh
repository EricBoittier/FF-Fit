...
export INPFILE=meoh_831.com
export OUTFILE=meoh_831.out
export CHKFILE=meoh_831.chk
export FCKFILE=meoh_831.fchk
export DNSFILE=meoh_831.d.cube
export ESPFILE=meoh_831.p.cube
