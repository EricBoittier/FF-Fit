...
export INPFILE=meoh_850.com
export OUTFILE=meoh_850.out
export CHKFILE=meoh_850.chk
export FCKFILE=meoh_850.fchk
export DNSFILE=meoh_850.d.cube
export ESPFILE=meoh_850.p.cube
