...
export INPFILE=meoh_59.com
export OUTFILE=meoh_59.out
export CHKFILE=meoh_59.chk
export FCKFILE=meoh_59.fchk
export DNSFILE=meoh_59.d.cube
export ESPFILE=meoh_59.p.cube
