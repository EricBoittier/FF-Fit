...
export INPFILE=meoh_859.com
export OUTFILE=meoh_859.out
export CHKFILE=meoh_859.chk
export FCKFILE=meoh_859.fchk
export DNSFILE=meoh_859.d.cube
export ESPFILE=meoh_859.p.cube
