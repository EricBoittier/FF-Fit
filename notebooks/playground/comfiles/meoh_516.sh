...
export INPFILE=meoh_516.com
export OUTFILE=meoh_516.out
export CHKFILE=meoh_516.chk
export FCKFILE=meoh_516.fchk
export DNSFILE=meoh_516.d.cube
export ESPFILE=meoh_516.p.cube
