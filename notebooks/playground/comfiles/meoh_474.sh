...
export INPFILE=meoh_474.com
export OUTFILE=meoh_474.out
export CHKFILE=meoh_474.chk
export FCKFILE=meoh_474.fchk
export DNSFILE=meoh_474.d.cube
export ESPFILE=meoh_474.p.cube
