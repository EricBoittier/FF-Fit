...
export INPFILE=meoh_855.com
export OUTFILE=meoh_855.out
export CHKFILE=meoh_855.chk
export FCKFILE=meoh_855.fchk
export DNSFILE=meoh_855.d.cube
export ESPFILE=meoh_855.p.cube
