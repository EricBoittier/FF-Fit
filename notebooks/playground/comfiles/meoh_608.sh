...
export INPFILE=meoh_608.com
export OUTFILE=meoh_608.out
export CHKFILE=meoh_608.chk
export FCKFILE=meoh_608.fchk
export DNSFILE=meoh_608.d.cube
export ESPFILE=meoh_608.p.cube
