...
export INPFILE=meoh_626.com
export OUTFILE=meoh_626.out
export CHKFILE=meoh_626.chk
export FCKFILE=meoh_626.fchk
export DNSFILE=meoh_626.d.cube
export ESPFILE=meoh_626.p.cube
