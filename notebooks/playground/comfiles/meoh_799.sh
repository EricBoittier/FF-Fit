...
export INPFILE=meoh_799.com
export OUTFILE=meoh_799.out
export CHKFILE=meoh_799.chk
export FCKFILE=meoh_799.fchk
export DNSFILE=meoh_799.d.cube
export ESPFILE=meoh_799.p.cube
