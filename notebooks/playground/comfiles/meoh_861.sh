...
export INPFILE=meoh_861.com
export OUTFILE=meoh_861.out
export CHKFILE=meoh_861.chk
export FCKFILE=meoh_861.fchk
export DNSFILE=meoh_861.d.cube
export ESPFILE=meoh_861.p.cube
