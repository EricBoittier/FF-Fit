...
export INPFILE=meoh_605.com
export OUTFILE=meoh_605.out
export CHKFILE=meoh_605.chk
export FCKFILE=meoh_605.fchk
export DNSFILE=meoh_605.d.cube
export ESPFILE=meoh_605.p.cube
