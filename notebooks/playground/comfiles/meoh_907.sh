...
export INPFILE=meoh_907.com
export OUTFILE=meoh_907.out
export CHKFILE=meoh_907.chk
export FCKFILE=meoh_907.fchk
export DNSFILE=meoh_907.d.cube
export ESPFILE=meoh_907.p.cube
