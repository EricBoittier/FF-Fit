...
export INPFILE=meoh_151.com
export OUTFILE=meoh_151.out
export CHKFILE=meoh_151.chk
export FCKFILE=meoh_151.fchk
export DNSFILE=meoh_151.d.cube
export ESPFILE=meoh_151.p.cube
