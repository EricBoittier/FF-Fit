...
export INPFILE=meoh_672.com
export OUTFILE=meoh_672.out
export CHKFILE=meoh_672.chk
export FCKFILE=meoh_672.fchk
export DNSFILE=meoh_672.d.cube
export ESPFILE=meoh_672.p.cube
