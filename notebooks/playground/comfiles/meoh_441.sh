...
export INPFILE=meoh_441.com
export OUTFILE=meoh_441.out
export CHKFILE=meoh_441.chk
export FCKFILE=meoh_441.fchk
export DNSFILE=meoh_441.d.cube
export ESPFILE=meoh_441.p.cube
