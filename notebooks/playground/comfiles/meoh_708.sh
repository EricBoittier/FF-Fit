...
export INPFILE=meoh_708.com
export OUTFILE=meoh_708.out
export CHKFILE=meoh_708.chk
export FCKFILE=meoh_708.fchk
export DNSFILE=meoh_708.d.cube
export ESPFILE=meoh_708.p.cube
