...
export INPFILE=meoh_498.com
export OUTFILE=meoh_498.out
export CHKFILE=meoh_498.chk
export FCKFILE=meoh_498.fchk
export DNSFILE=meoh_498.d.cube
export ESPFILE=meoh_498.p.cube
