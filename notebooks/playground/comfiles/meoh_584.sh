...
export INPFILE=meoh_584.com
export OUTFILE=meoh_584.out
export CHKFILE=meoh_584.chk
export FCKFILE=meoh_584.fchk
export DNSFILE=meoh_584.d.cube
export ESPFILE=meoh_584.p.cube
