...
export INPFILE=meoh_353.com
export OUTFILE=meoh_353.out
export CHKFILE=meoh_353.chk
export FCKFILE=meoh_353.fchk
export DNSFILE=meoh_353.d.cube
export ESPFILE=meoh_353.p.cube
