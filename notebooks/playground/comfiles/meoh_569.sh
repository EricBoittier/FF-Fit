...
export INPFILE=meoh_569.com
export OUTFILE=meoh_569.out
export CHKFILE=meoh_569.chk
export FCKFILE=meoh_569.fchk
export DNSFILE=meoh_569.d.cube
export ESPFILE=meoh_569.p.cube
