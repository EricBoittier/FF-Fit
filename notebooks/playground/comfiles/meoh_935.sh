...
export INPFILE=meoh_935.com
export OUTFILE=meoh_935.out
export CHKFILE=meoh_935.chk
export FCKFILE=meoh_935.fchk
export DNSFILE=meoh_935.d.cube
export ESPFILE=meoh_935.p.cube
