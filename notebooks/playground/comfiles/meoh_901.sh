...
export INPFILE=meoh_901.com
export OUTFILE=meoh_901.out
export CHKFILE=meoh_901.chk
export FCKFILE=meoh_901.fchk
export DNSFILE=meoh_901.d.cube
export ESPFILE=meoh_901.p.cube
