...
export INPFILE=meoh_149.com
export OUTFILE=meoh_149.out
export CHKFILE=meoh_149.chk
export FCKFILE=meoh_149.fchk
export DNSFILE=meoh_149.d.cube
export ESPFILE=meoh_149.p.cube
