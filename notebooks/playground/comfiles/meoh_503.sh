...
export INPFILE=meoh_503.com
export OUTFILE=meoh_503.out
export CHKFILE=meoh_503.chk
export FCKFILE=meoh_503.fchk
export DNSFILE=meoh_503.d.cube
export ESPFILE=meoh_503.p.cube
