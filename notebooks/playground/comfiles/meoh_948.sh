...
export INPFILE=meoh_948.com
export OUTFILE=meoh_948.out
export CHKFILE=meoh_948.chk
export FCKFILE=meoh_948.fchk
export DNSFILE=meoh_948.d.cube
export ESPFILE=meoh_948.p.cube
