...
export INPFILE=meoh_291.com
export OUTFILE=meoh_291.out
export CHKFILE=meoh_291.chk
export FCKFILE=meoh_291.fchk
export DNSFILE=meoh_291.d.cube
export ESPFILE=meoh_291.p.cube
