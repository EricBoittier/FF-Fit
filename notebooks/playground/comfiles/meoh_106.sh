...
export INPFILE=meoh_106.com
export OUTFILE=meoh_106.out
export CHKFILE=meoh_106.chk
export FCKFILE=meoh_106.fchk
export DNSFILE=meoh_106.d.cube
export ESPFILE=meoh_106.p.cube
