...
export INPFILE=meoh_658.com
export OUTFILE=meoh_658.out
export CHKFILE=meoh_658.chk
export FCKFILE=meoh_658.fchk
export DNSFILE=meoh_658.d.cube
export ESPFILE=meoh_658.p.cube
