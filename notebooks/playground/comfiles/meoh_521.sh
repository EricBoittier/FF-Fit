...
export INPFILE=meoh_521.com
export OUTFILE=meoh_521.out
export CHKFILE=meoh_521.chk
export FCKFILE=meoh_521.fchk
export DNSFILE=meoh_521.d.cube
export ESPFILE=meoh_521.p.cube
