...
export INPFILE=meoh_817.com
export OUTFILE=meoh_817.out
export CHKFILE=meoh_817.chk
export FCKFILE=meoh_817.fchk
export DNSFILE=meoh_817.d.cube
export ESPFILE=meoh_817.p.cube
