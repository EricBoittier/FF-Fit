...
export INPFILE=meoh_536.com
export OUTFILE=meoh_536.out
export CHKFILE=meoh_536.chk
export FCKFILE=meoh_536.fchk
export DNSFILE=meoh_536.d.cube
export ESPFILE=meoh_536.p.cube
