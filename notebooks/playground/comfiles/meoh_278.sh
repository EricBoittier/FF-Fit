...
export INPFILE=meoh_278.com
export OUTFILE=meoh_278.out
export CHKFILE=meoh_278.chk
export FCKFILE=meoh_278.fchk
export DNSFILE=meoh_278.d.cube
export ESPFILE=meoh_278.p.cube
