...
export INPFILE=meoh_138.com
export OUTFILE=meoh_138.out
export CHKFILE=meoh_138.chk
export FCKFILE=meoh_138.fchk
export DNSFILE=meoh_138.d.cube
export ESPFILE=meoh_138.p.cube
