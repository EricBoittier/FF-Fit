...
export INPFILE=meoh_897.com
export OUTFILE=meoh_897.out
export CHKFILE=meoh_897.chk
export FCKFILE=meoh_897.fchk
export DNSFILE=meoh_897.d.cube
export ESPFILE=meoh_897.p.cube
