...
export INPFILE=meoh_732.com
export OUTFILE=meoh_732.out
export CHKFILE=meoh_732.chk
export FCKFILE=meoh_732.fchk
export DNSFILE=meoh_732.d.cube
export ESPFILE=meoh_732.p.cube
