...
export INPFILE=meoh_522.com
export OUTFILE=meoh_522.out
export CHKFILE=meoh_522.chk
export FCKFILE=meoh_522.fchk
export DNSFILE=meoh_522.d.cube
export ESPFILE=meoh_522.p.cube
