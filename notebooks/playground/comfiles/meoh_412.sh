...
export INPFILE=meoh_412.com
export OUTFILE=meoh_412.out
export CHKFILE=meoh_412.chk
export FCKFILE=meoh_412.fchk
export DNSFILE=meoh_412.d.cube
export ESPFILE=meoh_412.p.cube
