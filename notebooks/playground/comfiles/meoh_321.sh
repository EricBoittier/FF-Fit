...
export INPFILE=meoh_321.com
export OUTFILE=meoh_321.out
export CHKFILE=meoh_321.chk
export FCKFILE=meoh_321.fchk
export DNSFILE=meoh_321.d.cube
export ESPFILE=meoh_321.p.cube
