...
export INPFILE=meoh_311.com
export OUTFILE=meoh_311.out
export CHKFILE=meoh_311.chk
export FCKFILE=meoh_311.fchk
export DNSFILE=meoh_311.d.cube
export ESPFILE=meoh_311.p.cube
