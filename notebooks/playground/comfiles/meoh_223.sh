...
export INPFILE=meoh_223.com
export OUTFILE=meoh_223.out
export CHKFILE=meoh_223.chk
export FCKFILE=meoh_223.fchk
export DNSFILE=meoh_223.d.cube
export ESPFILE=meoh_223.p.cube
