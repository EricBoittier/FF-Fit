...
export INPFILE=meoh_314.com
export OUTFILE=meoh_314.out
export CHKFILE=meoh_314.chk
export FCKFILE=meoh_314.fchk
export DNSFILE=meoh_314.d.cube
export ESPFILE=meoh_314.p.cube
