...
export INPFILE=meoh_505.com
export OUTFILE=meoh_505.out
export CHKFILE=meoh_505.chk
export FCKFILE=meoh_505.fchk
export DNSFILE=meoh_505.d.cube
export ESPFILE=meoh_505.p.cube
