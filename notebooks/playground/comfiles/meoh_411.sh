...
export INPFILE=meoh_411.com
export OUTFILE=meoh_411.out
export CHKFILE=meoh_411.chk
export FCKFILE=meoh_411.fchk
export DNSFILE=meoh_411.d.cube
export ESPFILE=meoh_411.p.cube
