...
export INPFILE=meoh_287.com
export OUTFILE=meoh_287.out
export CHKFILE=meoh_287.chk
export FCKFILE=meoh_287.fchk
export DNSFILE=meoh_287.d.cube
export ESPFILE=meoh_287.p.cube
