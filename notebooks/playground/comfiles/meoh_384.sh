...
export INPFILE=meoh_384.com
export OUTFILE=meoh_384.out
export CHKFILE=meoh_384.chk
export FCKFILE=meoh_384.fchk
export DNSFILE=meoh_384.d.cube
export ESPFILE=meoh_384.p.cube
