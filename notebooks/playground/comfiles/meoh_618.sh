...
export INPFILE=meoh_618.com
export OUTFILE=meoh_618.out
export CHKFILE=meoh_618.chk
export FCKFILE=meoh_618.fchk
export DNSFILE=meoh_618.d.cube
export ESPFILE=meoh_618.p.cube
