...
export INPFILE=meoh_883.com
export OUTFILE=meoh_883.out
export CHKFILE=meoh_883.chk
export FCKFILE=meoh_883.fchk
export DNSFILE=meoh_883.d.cube
export ESPFILE=meoh_883.p.cube
