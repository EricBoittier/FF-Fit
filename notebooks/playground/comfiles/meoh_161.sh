...
export INPFILE=meoh_161.com
export OUTFILE=meoh_161.out
export CHKFILE=meoh_161.chk
export FCKFILE=meoh_161.fchk
export DNSFILE=meoh_161.d.cube
export ESPFILE=meoh_161.p.cube
