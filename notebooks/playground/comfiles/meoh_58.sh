...
export INPFILE=meoh_58.com
export OUTFILE=meoh_58.out
export CHKFILE=meoh_58.chk
export FCKFILE=meoh_58.fchk
export DNSFILE=meoh_58.d.cube
export ESPFILE=meoh_58.p.cube
