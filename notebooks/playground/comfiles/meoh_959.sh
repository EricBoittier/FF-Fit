...
export INPFILE=meoh_959.com
export OUTFILE=meoh_959.out
export CHKFILE=meoh_959.chk
export FCKFILE=meoh_959.fchk
export DNSFILE=meoh_959.d.cube
export ESPFILE=meoh_959.p.cube
