...
export INPFILE=meoh_397.com
export OUTFILE=meoh_397.out
export CHKFILE=meoh_397.chk
export FCKFILE=meoh_397.fchk
export DNSFILE=meoh_397.d.cube
export ESPFILE=meoh_397.p.cube
