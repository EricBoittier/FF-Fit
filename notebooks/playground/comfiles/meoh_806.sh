...
export INPFILE=meoh_806.com
export OUTFILE=meoh_806.out
export CHKFILE=meoh_806.chk
export FCKFILE=meoh_806.fchk
export DNSFILE=meoh_806.d.cube
export ESPFILE=meoh_806.p.cube
