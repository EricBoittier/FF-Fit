...
export INPFILE=meoh_18.com
export OUTFILE=meoh_18.out
export CHKFILE=meoh_18.chk
export FCKFILE=meoh_18.fchk
export DNSFILE=meoh_18.d.cube
export ESPFILE=meoh_18.p.cube
