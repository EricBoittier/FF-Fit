...
export INPFILE=meoh_742.com
export OUTFILE=meoh_742.out
export CHKFILE=meoh_742.chk
export FCKFILE=meoh_742.fchk
export DNSFILE=meoh_742.d.cube
export ESPFILE=meoh_742.p.cube
