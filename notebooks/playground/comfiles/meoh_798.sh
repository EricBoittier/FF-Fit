...
export INPFILE=meoh_798.com
export OUTFILE=meoh_798.out
export CHKFILE=meoh_798.chk
export FCKFILE=meoh_798.fchk
export DNSFILE=meoh_798.d.cube
export ESPFILE=meoh_798.p.cube
