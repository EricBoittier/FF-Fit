...
export INPFILE=meoh_334.com
export OUTFILE=meoh_334.out
export CHKFILE=meoh_334.chk
export FCKFILE=meoh_334.fchk
export DNSFILE=meoh_334.d.cube
export ESPFILE=meoh_334.p.cube
