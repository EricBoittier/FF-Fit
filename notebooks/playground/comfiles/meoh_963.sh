...
export INPFILE=meoh_963.com
export OUTFILE=meoh_963.out
export CHKFILE=meoh_963.chk
export FCKFILE=meoh_963.fchk
export DNSFILE=meoh_963.d.cube
export ESPFILE=meoh_963.p.cube
