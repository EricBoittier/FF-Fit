...
export INPFILE=meoh_358.com
export OUTFILE=meoh_358.out
export CHKFILE=meoh_358.chk
export FCKFILE=meoh_358.fchk
export DNSFILE=meoh_358.d.cube
export ESPFILE=meoh_358.p.cube
