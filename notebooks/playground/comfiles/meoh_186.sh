...
export INPFILE=meoh_186.com
export OUTFILE=meoh_186.out
export CHKFILE=meoh_186.chk
export FCKFILE=meoh_186.fchk
export DNSFILE=meoh_186.d.cube
export ESPFILE=meoh_186.p.cube
