...
export INPFILE=meoh_511.com
export OUTFILE=meoh_511.out
export CHKFILE=meoh_511.chk
export FCKFILE=meoh_511.fchk
export DNSFILE=meoh_511.d.cube
export ESPFILE=meoh_511.p.cube
