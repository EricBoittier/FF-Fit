...
export INPFILE=meoh_172.com
export OUTFILE=meoh_172.out
export CHKFILE=meoh_172.chk
export FCKFILE=meoh_172.fchk
export DNSFILE=meoh_172.d.cube
export ESPFILE=meoh_172.p.cube
