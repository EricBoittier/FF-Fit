...
export INPFILE=meoh_100.com
export OUTFILE=meoh_100.out
export CHKFILE=meoh_100.chk
export FCKFILE=meoh_100.fchk
export DNSFILE=meoh_100.d.cube
export ESPFILE=meoh_100.p.cube
