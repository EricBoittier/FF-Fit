...
export INPFILE=meoh_811.com
export OUTFILE=meoh_811.out
export CHKFILE=meoh_811.chk
export FCKFILE=meoh_811.fchk
export DNSFILE=meoh_811.d.cube
export ESPFILE=meoh_811.p.cube
