...
export INPFILE=meoh_482.com
export OUTFILE=meoh_482.out
export CHKFILE=meoh_482.chk
export FCKFILE=meoh_482.fchk
export DNSFILE=meoh_482.d.cube
export ESPFILE=meoh_482.p.cube
