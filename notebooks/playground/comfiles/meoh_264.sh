...
export INPFILE=meoh_264.com
export OUTFILE=meoh_264.out
export CHKFILE=meoh_264.chk
export FCKFILE=meoh_264.fchk
export DNSFILE=meoh_264.d.cube
export ESPFILE=meoh_264.p.cube
