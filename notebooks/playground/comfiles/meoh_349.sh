...
export INPFILE=meoh_349.com
export OUTFILE=meoh_349.out
export CHKFILE=meoh_349.chk
export FCKFILE=meoh_349.fchk
export DNSFILE=meoh_349.d.cube
export ESPFILE=meoh_349.p.cube
