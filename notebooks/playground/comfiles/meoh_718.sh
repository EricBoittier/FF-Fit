...
export INPFILE=meoh_718.com
export OUTFILE=meoh_718.out
export CHKFILE=meoh_718.chk
export FCKFILE=meoh_718.fchk
export DNSFILE=meoh_718.d.cube
export ESPFILE=meoh_718.p.cube
