...
export INPFILE=meoh_609.com
export OUTFILE=meoh_609.out
export CHKFILE=meoh_609.chk
export FCKFILE=meoh_609.fchk
export DNSFILE=meoh_609.d.cube
export ESPFILE=meoh_609.p.cube
