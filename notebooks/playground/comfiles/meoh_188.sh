...
export INPFILE=meoh_188.com
export OUTFILE=meoh_188.out
export CHKFILE=meoh_188.chk
export FCKFILE=meoh_188.fchk
export DNSFILE=meoh_188.d.cube
export ESPFILE=meoh_188.p.cube
