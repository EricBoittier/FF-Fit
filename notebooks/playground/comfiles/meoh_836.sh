...
export INPFILE=meoh_836.com
export OUTFILE=meoh_836.out
export CHKFILE=meoh_836.chk
export FCKFILE=meoh_836.fchk
export DNSFILE=meoh_836.d.cube
export ESPFILE=meoh_836.p.cube
