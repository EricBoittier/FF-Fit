...
export INPFILE=meoh_148.com
export OUTFILE=meoh_148.out
export CHKFILE=meoh_148.chk
export FCKFILE=meoh_148.fchk
export DNSFILE=meoh_148.d.cube
export ESPFILE=meoh_148.p.cube
