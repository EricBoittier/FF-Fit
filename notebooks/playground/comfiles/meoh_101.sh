...
export INPFILE=meoh_101.com
export OUTFILE=meoh_101.out
export CHKFILE=meoh_101.chk
export FCKFILE=meoh_101.fchk
export DNSFILE=meoh_101.d.cube
export ESPFILE=meoh_101.p.cube
