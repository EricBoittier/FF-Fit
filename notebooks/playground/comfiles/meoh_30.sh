...
export INPFILE=meoh_30.com
export OUTFILE=meoh_30.out
export CHKFILE=meoh_30.chk
export FCKFILE=meoh_30.fchk
export DNSFILE=meoh_30.d.cube
export ESPFILE=meoh_30.p.cube
