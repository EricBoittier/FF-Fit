...
export INPFILE=meoh_653.com
export OUTFILE=meoh_653.out
export CHKFILE=meoh_653.chk
export FCKFILE=meoh_653.fchk
export DNSFILE=meoh_653.d.cube
export ESPFILE=meoh_653.p.cube
