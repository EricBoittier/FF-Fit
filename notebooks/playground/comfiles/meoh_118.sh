...
export INPFILE=meoh_118.com
export OUTFILE=meoh_118.out
export CHKFILE=meoh_118.chk
export FCKFILE=meoh_118.fchk
export DNSFILE=meoh_118.d.cube
export ESPFILE=meoh_118.p.cube
