...
export INPFILE=meoh_396.com
export OUTFILE=meoh_396.out
export CHKFILE=meoh_396.chk
export FCKFILE=meoh_396.fchk
export DNSFILE=meoh_396.d.cube
export ESPFILE=meoh_396.p.cube
