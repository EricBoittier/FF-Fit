...
export INPFILE=meoh_297.com
export OUTFILE=meoh_297.out
export CHKFILE=meoh_297.chk
export FCKFILE=meoh_297.fchk
export DNSFILE=meoh_297.d.cube
export ESPFILE=meoh_297.p.cube
