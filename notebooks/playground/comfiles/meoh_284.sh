...
export INPFILE=meoh_284.com
export OUTFILE=meoh_284.out
export CHKFILE=meoh_284.chk
export FCKFILE=meoh_284.fchk
export DNSFILE=meoh_284.d.cube
export ESPFILE=meoh_284.p.cube
