...
export INPFILE=meoh_813.com
export OUTFILE=meoh_813.out
export CHKFILE=meoh_813.chk
export FCKFILE=meoh_813.fchk
export DNSFILE=meoh_813.d.cube
export ESPFILE=meoh_813.p.cube
