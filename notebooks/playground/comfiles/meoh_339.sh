...
export INPFILE=meoh_339.com
export OUTFILE=meoh_339.out
export CHKFILE=meoh_339.chk
export FCKFILE=meoh_339.fchk
export DNSFILE=meoh_339.d.cube
export ESPFILE=meoh_339.p.cube
