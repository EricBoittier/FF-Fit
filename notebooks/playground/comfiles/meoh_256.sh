...
export INPFILE=meoh_256.com
export OUTFILE=meoh_256.out
export CHKFILE=meoh_256.chk
export FCKFILE=meoh_256.fchk
export DNSFILE=meoh_256.d.cube
export ESPFILE=meoh_256.p.cube
