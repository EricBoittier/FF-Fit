...
export INPFILE=meoh_993.com
export OUTFILE=meoh_993.out
export CHKFILE=meoh_993.chk
export FCKFILE=meoh_993.fchk
export DNSFILE=meoh_993.d.cube
export ESPFILE=meoh_993.p.cube
