...
export INPFILE=meoh_998.com
export OUTFILE=meoh_998.out
export CHKFILE=meoh_998.chk
export FCKFILE=meoh_998.fchk
export DNSFILE=meoh_998.d.cube
export ESPFILE=meoh_998.p.cube
