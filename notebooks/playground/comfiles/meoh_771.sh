...
export INPFILE=meoh_771.com
export OUTFILE=meoh_771.out
export CHKFILE=meoh_771.chk
export FCKFILE=meoh_771.fchk
export DNSFILE=meoh_771.d.cube
export ESPFILE=meoh_771.p.cube
