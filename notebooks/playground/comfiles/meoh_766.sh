...
export INPFILE=meoh_766.com
export OUTFILE=meoh_766.out
export CHKFILE=meoh_766.chk
export FCKFILE=meoh_766.fchk
export DNSFILE=meoh_766.d.cube
export ESPFILE=meoh_766.p.cube
