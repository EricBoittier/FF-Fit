...
export INPFILE=meoh_768.com
export OUTFILE=meoh_768.out
export CHKFILE=meoh_768.chk
export FCKFILE=meoh_768.fchk
export DNSFILE=meoh_768.d.cube
export ESPFILE=meoh_768.p.cube
