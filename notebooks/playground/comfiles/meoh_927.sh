...
export INPFILE=meoh_927.com
export OUTFILE=meoh_927.out
export CHKFILE=meoh_927.chk
export FCKFILE=meoh_927.fchk
export DNSFILE=meoh_927.d.cube
export ESPFILE=meoh_927.p.cube
