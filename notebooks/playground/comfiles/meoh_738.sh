...
export INPFILE=meoh_738.com
export OUTFILE=meoh_738.out
export CHKFILE=meoh_738.chk
export FCKFILE=meoh_738.fchk
export DNSFILE=meoh_738.d.cube
export ESPFILE=meoh_738.p.cube
