...
export INPFILE=meoh_159.com
export OUTFILE=meoh_159.out
export CHKFILE=meoh_159.chk
export FCKFILE=meoh_159.fchk
export DNSFILE=meoh_159.d.cube
export ESPFILE=meoh_159.p.cube
