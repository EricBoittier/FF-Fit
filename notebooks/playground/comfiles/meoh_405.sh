...
export INPFILE=meoh_405.com
export OUTFILE=meoh_405.out
export CHKFILE=meoh_405.chk
export FCKFILE=meoh_405.fchk
export DNSFILE=meoh_405.d.cube
export ESPFILE=meoh_405.p.cube
