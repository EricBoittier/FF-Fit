...
export INPFILE=meoh_209.com
export OUTFILE=meoh_209.out
export CHKFILE=meoh_209.chk
export FCKFILE=meoh_209.fchk
export DNSFILE=meoh_209.d.cube
export ESPFILE=meoh_209.p.cube
