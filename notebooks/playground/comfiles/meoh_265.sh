...
export INPFILE=meoh_265.com
export OUTFILE=meoh_265.out
export CHKFILE=meoh_265.chk
export FCKFILE=meoh_265.fchk
export DNSFILE=meoh_265.d.cube
export ESPFILE=meoh_265.p.cube
