...
export INPFILE=meoh_281.com
export OUTFILE=meoh_281.out
export CHKFILE=meoh_281.chk
export FCKFILE=meoh_281.fchk
export DNSFILE=meoh_281.d.cube
export ESPFILE=meoh_281.p.cube
