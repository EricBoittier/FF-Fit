...
export INPFILE=meoh_232.com
export OUTFILE=meoh_232.out
export CHKFILE=meoh_232.chk
export FCKFILE=meoh_232.fchk
export DNSFILE=meoh_232.d.cube
export ESPFILE=meoh_232.p.cube
