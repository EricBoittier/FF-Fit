...
export INPFILE=meoh_868.com
export OUTFILE=meoh_868.out
export CHKFILE=meoh_868.chk
export FCKFILE=meoh_868.fchk
export DNSFILE=meoh_868.d.cube
export ESPFILE=meoh_868.p.cube
