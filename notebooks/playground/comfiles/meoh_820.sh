...
export INPFILE=meoh_820.com
export OUTFILE=meoh_820.out
export CHKFILE=meoh_820.chk
export FCKFILE=meoh_820.fchk
export DNSFILE=meoh_820.d.cube
export ESPFILE=meoh_820.p.cube
