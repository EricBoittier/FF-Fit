...
export INPFILE=meoh_858.com
export OUTFILE=meoh_858.out
export CHKFILE=meoh_858.chk
export FCKFILE=meoh_858.fchk
export DNSFILE=meoh_858.d.cube
export ESPFILE=meoh_858.p.cube
