...
export INPFILE=meoh_686.com
export OUTFILE=meoh_686.out
export CHKFILE=meoh_686.chk
export FCKFILE=meoh_686.fchk
export DNSFILE=meoh_686.d.cube
export ESPFILE=meoh_686.p.cube
