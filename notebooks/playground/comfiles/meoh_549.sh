...
export INPFILE=meoh_549.com
export OUTFILE=meoh_549.out
export CHKFILE=meoh_549.chk
export FCKFILE=meoh_549.fchk
export DNSFILE=meoh_549.d.cube
export ESPFILE=meoh_549.p.cube
