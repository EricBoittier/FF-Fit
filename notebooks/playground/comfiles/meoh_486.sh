...
export INPFILE=meoh_486.com
export OUTFILE=meoh_486.out
export CHKFILE=meoh_486.chk
export FCKFILE=meoh_486.fchk
export DNSFILE=meoh_486.d.cube
export ESPFILE=meoh_486.p.cube
