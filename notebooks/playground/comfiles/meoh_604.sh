...
export INPFILE=meoh_604.com
export OUTFILE=meoh_604.out
export CHKFILE=meoh_604.chk
export FCKFILE=meoh_604.fchk
export DNSFILE=meoh_604.d.cube
export ESPFILE=meoh_604.p.cube
