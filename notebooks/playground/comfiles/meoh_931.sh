...
export INPFILE=meoh_931.com
export OUTFILE=meoh_931.out
export CHKFILE=meoh_931.chk
export FCKFILE=meoh_931.fchk
export DNSFILE=meoh_931.d.cube
export ESPFILE=meoh_931.p.cube
