...
export INPFILE=meoh_236.com
export OUTFILE=meoh_236.out
export CHKFILE=meoh_236.chk
export FCKFILE=meoh_236.fchk
export DNSFILE=meoh_236.d.cube
export ESPFILE=meoh_236.p.cube
