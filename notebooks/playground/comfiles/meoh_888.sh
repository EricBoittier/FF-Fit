...
export INPFILE=meoh_888.com
export OUTFILE=meoh_888.out
export CHKFILE=meoh_888.chk
export FCKFILE=meoh_888.fchk
export DNSFILE=meoh_888.d.cube
export ESPFILE=meoh_888.p.cube
