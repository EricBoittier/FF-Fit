...
export INPFILE=meoh_240.com
export OUTFILE=meoh_240.out
export CHKFILE=meoh_240.chk
export FCKFILE=meoh_240.fchk
export DNSFILE=meoh_240.d.cube
export ESPFILE=meoh_240.p.cube
