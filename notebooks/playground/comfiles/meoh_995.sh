...
export INPFILE=meoh_995.com
export OUTFILE=meoh_995.out
export CHKFILE=meoh_995.chk
export FCKFILE=meoh_995.fchk
export DNSFILE=meoh_995.d.cube
export ESPFILE=meoh_995.p.cube
