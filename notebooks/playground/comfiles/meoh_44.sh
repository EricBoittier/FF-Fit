...
export INPFILE=meoh_44.com
export OUTFILE=meoh_44.out
export CHKFILE=meoh_44.chk
export FCKFILE=meoh_44.fchk
export DNSFILE=meoh_44.d.cube
export ESPFILE=meoh_44.p.cube
