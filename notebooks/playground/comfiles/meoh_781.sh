...
export INPFILE=meoh_781.com
export OUTFILE=meoh_781.out
export CHKFILE=meoh_781.chk
export FCKFILE=meoh_781.fchk
export DNSFILE=meoh_781.d.cube
export ESPFILE=meoh_781.p.cube
