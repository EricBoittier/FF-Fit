...
export INPFILE=meoh_640.com
export OUTFILE=meoh_640.out
export CHKFILE=meoh_640.chk
export FCKFILE=meoh_640.fchk
export DNSFILE=meoh_640.d.cube
export ESPFILE=meoh_640.p.cube
