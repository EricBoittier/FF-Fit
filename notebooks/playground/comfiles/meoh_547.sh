...
export INPFILE=meoh_547.com
export OUTFILE=meoh_547.out
export CHKFILE=meoh_547.chk
export FCKFILE=meoh_547.fchk
export DNSFILE=meoh_547.d.cube
export ESPFILE=meoh_547.p.cube
