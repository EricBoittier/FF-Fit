...
export INPFILE=meoh_743.com
export OUTFILE=meoh_743.out
export CHKFILE=meoh_743.chk
export FCKFILE=meoh_743.fchk
export DNSFILE=meoh_743.d.cube
export ESPFILE=meoh_743.p.cube
