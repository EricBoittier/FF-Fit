...
export INPFILE=meoh_419.com
export OUTFILE=meoh_419.out
export CHKFILE=meoh_419.chk
export FCKFILE=meoh_419.fchk
export DNSFILE=meoh_419.d.cube
export ESPFILE=meoh_419.p.cube
