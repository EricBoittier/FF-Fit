...
export INPFILE=meoh_445.com
export OUTFILE=meoh_445.out
export CHKFILE=meoh_445.chk
export FCKFILE=meoh_445.fchk
export DNSFILE=meoh_445.d.cube
export ESPFILE=meoh_445.p.cube
