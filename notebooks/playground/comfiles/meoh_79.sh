...
export INPFILE=meoh_79.com
export OUTFILE=meoh_79.out
export CHKFILE=meoh_79.chk
export FCKFILE=meoh_79.fchk
export DNSFILE=meoh_79.d.cube
export ESPFILE=meoh_79.p.cube
