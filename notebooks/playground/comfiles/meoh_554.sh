...
export INPFILE=meoh_554.com
export OUTFILE=meoh_554.out
export CHKFILE=meoh_554.chk
export FCKFILE=meoh_554.fchk
export DNSFILE=meoh_554.d.cube
export ESPFILE=meoh_554.p.cube
