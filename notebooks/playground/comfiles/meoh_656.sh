...
export INPFILE=meoh_656.com
export OUTFILE=meoh_656.out
export CHKFILE=meoh_656.chk
export FCKFILE=meoh_656.fchk
export DNSFILE=meoh_656.d.cube
export ESPFILE=meoh_656.p.cube
