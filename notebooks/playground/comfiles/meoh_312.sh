...
export INPFILE=meoh_312.com
export OUTFILE=meoh_312.out
export CHKFILE=meoh_312.chk
export FCKFILE=meoh_312.fchk
export DNSFILE=meoh_312.d.cube
export ESPFILE=meoh_312.p.cube
