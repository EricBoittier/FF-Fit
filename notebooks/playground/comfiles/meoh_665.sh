...
export INPFILE=meoh_665.com
export OUTFILE=meoh_665.out
export CHKFILE=meoh_665.chk
export FCKFILE=meoh_665.fchk
export DNSFILE=meoh_665.d.cube
export ESPFILE=meoh_665.p.cube
