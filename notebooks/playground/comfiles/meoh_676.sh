...
export INPFILE=meoh_676.com
export OUTFILE=meoh_676.out
export CHKFILE=meoh_676.chk
export FCKFILE=meoh_676.fchk
export DNSFILE=meoh_676.d.cube
export ESPFILE=meoh_676.p.cube
