...
export INPFILE=meoh_357.com
export OUTFILE=meoh_357.out
export CHKFILE=meoh_357.chk
export FCKFILE=meoh_357.fchk
export DNSFILE=meoh_357.d.cube
export ESPFILE=meoh_357.p.cube
