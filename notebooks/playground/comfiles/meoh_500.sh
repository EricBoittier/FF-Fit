...
export INPFILE=meoh_500.com
export OUTFILE=meoh_500.out
export CHKFILE=meoh_500.chk
export FCKFILE=meoh_500.fchk
export DNSFILE=meoh_500.d.cube
export ESPFILE=meoh_500.p.cube
