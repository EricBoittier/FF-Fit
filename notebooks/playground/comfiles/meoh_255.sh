...
export INPFILE=meoh_255.com
export OUTFILE=meoh_255.out
export CHKFILE=meoh_255.chk
export FCKFILE=meoh_255.fchk
export DNSFILE=meoh_255.d.cube
export ESPFILE=meoh_255.p.cube
