...
export INPFILE=meoh_12.com
export OUTFILE=meoh_12.out
export CHKFILE=meoh_12.chk
export FCKFILE=meoh_12.fchk
export DNSFILE=meoh_12.d.cube
export ESPFILE=meoh_12.p.cube
