...
export INPFILE=meoh_999.com
export OUTFILE=meoh_999.out
export CHKFILE=meoh_999.chk
export FCKFILE=meoh_999.fchk
export DNSFILE=meoh_999.d.cube
export ESPFILE=meoh_999.p.cube
