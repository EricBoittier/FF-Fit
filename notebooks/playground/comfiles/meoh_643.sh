...
export INPFILE=meoh_643.com
export OUTFILE=meoh_643.out
export CHKFILE=meoh_643.chk
export FCKFILE=meoh_643.fchk
export DNSFILE=meoh_643.d.cube
export ESPFILE=meoh_643.p.cube
