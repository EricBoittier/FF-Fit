...
export INPFILE=meoh_4.com
export OUTFILE=meoh_4.out
export CHKFILE=meoh_4.chk
export FCKFILE=meoh_4.fchk
export DNSFILE=meoh_4.d.cube
export ESPFILE=meoh_4.p.cube
