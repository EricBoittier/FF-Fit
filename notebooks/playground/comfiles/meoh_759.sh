...
export INPFILE=meoh_759.com
export OUTFILE=meoh_759.out
export CHKFILE=meoh_759.chk
export FCKFILE=meoh_759.fchk
export DNSFILE=meoh_759.d.cube
export ESPFILE=meoh_759.p.cube
