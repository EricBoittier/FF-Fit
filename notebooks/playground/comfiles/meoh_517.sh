...
export INPFILE=meoh_517.com
export OUTFILE=meoh_517.out
export CHKFILE=meoh_517.chk
export FCKFILE=meoh_517.fchk
export DNSFILE=meoh_517.d.cube
export ESPFILE=meoh_517.p.cube
