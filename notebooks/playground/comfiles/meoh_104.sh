...
export INPFILE=meoh_104.com
export OUTFILE=meoh_104.out
export CHKFILE=meoh_104.chk
export FCKFILE=meoh_104.fchk
export DNSFILE=meoh_104.d.cube
export ESPFILE=meoh_104.p.cube
