...
export INPFILE=meoh_260.com
export OUTFILE=meoh_260.out
export CHKFILE=meoh_260.chk
export FCKFILE=meoh_260.fchk
export DNSFILE=meoh_260.d.cube
export ESPFILE=meoh_260.p.cube
