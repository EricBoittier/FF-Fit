...
export INPFILE=meoh_361.com
export OUTFILE=meoh_361.out
export CHKFILE=meoh_361.chk
export FCKFILE=meoh_361.fchk
export DNSFILE=meoh_361.d.cube
export ESPFILE=meoh_361.p.cube
