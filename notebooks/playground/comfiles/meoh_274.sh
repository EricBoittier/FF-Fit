...
export INPFILE=meoh_274.com
export OUTFILE=meoh_274.out
export CHKFILE=meoh_274.chk
export FCKFILE=meoh_274.fchk
export DNSFILE=meoh_274.d.cube
export ESPFILE=meoh_274.p.cube
