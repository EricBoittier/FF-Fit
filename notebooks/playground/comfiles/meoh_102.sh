...
export INPFILE=meoh_102.com
export OUTFILE=meoh_102.out
export CHKFILE=meoh_102.chk
export FCKFILE=meoh_102.fchk
export DNSFILE=meoh_102.d.cube
export ESPFILE=meoh_102.p.cube
