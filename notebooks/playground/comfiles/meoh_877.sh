...
export INPFILE=meoh_877.com
export OUTFILE=meoh_877.out
export CHKFILE=meoh_877.chk
export FCKFILE=meoh_877.fchk
export DNSFILE=meoh_877.d.cube
export ESPFILE=meoh_877.p.cube
