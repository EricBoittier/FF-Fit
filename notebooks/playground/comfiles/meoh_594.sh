...
export INPFILE=meoh_594.com
export OUTFILE=meoh_594.out
export CHKFILE=meoh_594.chk
export FCKFILE=meoh_594.fchk
export DNSFILE=meoh_594.d.cube
export ESPFILE=meoh_594.p.cube
