...
export INPFILE=meoh_3.com
export OUTFILE=meoh_3.out
export CHKFILE=meoh_3.chk
export FCKFILE=meoh_3.fchk
export DNSFILE=meoh_3.d.cube
export ESPFILE=meoh_3.p.cube
