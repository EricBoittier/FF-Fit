...
export INPFILE=meoh_720.com
export OUTFILE=meoh_720.out
export CHKFILE=meoh_720.chk
export FCKFILE=meoh_720.fchk
export DNSFILE=meoh_720.d.cube
export ESPFILE=meoh_720.p.cube
