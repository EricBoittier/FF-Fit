...
export INPFILE=meoh_379.com
export OUTFILE=meoh_379.out
export CHKFILE=meoh_379.chk
export FCKFILE=meoh_379.fchk
export DNSFILE=meoh_379.d.cube
export ESPFILE=meoh_379.p.cube
