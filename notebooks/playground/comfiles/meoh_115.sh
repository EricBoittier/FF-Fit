...
export INPFILE=meoh_115.com
export OUTFILE=meoh_115.out
export CHKFILE=meoh_115.chk
export FCKFILE=meoh_115.fchk
export DNSFILE=meoh_115.d.cube
export ESPFILE=meoh_115.p.cube
