...
export INPFILE=meoh_654.com
export OUTFILE=meoh_654.out
export CHKFILE=meoh_654.chk
export FCKFILE=meoh_654.fchk
export DNSFILE=meoh_654.d.cube
export ESPFILE=meoh_654.p.cube
