...
export INPFILE=meoh_414.com
export OUTFILE=meoh_414.out
export CHKFILE=meoh_414.chk
export FCKFILE=meoh_414.fchk
export DNSFILE=meoh_414.d.cube
export ESPFILE=meoh_414.p.cube
