...
export INPFILE=meoh_545.com
export OUTFILE=meoh_545.out
export CHKFILE=meoh_545.chk
export FCKFILE=meoh_545.fchk
export DNSFILE=meoh_545.d.cube
export ESPFILE=meoh_545.p.cube
