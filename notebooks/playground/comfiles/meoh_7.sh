...
export INPFILE=meoh_7.com
export OUTFILE=meoh_7.out
export CHKFILE=meoh_7.chk
export FCKFILE=meoh_7.fchk
export DNSFILE=meoh_7.d.cube
export ESPFILE=meoh_7.p.cube
