...
export INPFILE=meoh_27.com
export OUTFILE=meoh_27.out
export CHKFILE=meoh_27.chk
export FCKFILE=meoh_27.fchk
export DNSFILE=meoh_27.d.cube
export ESPFILE=meoh_27.p.cube
