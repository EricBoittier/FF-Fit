...
export INPFILE=meoh_786.com
export OUTFILE=meoh_786.out
export CHKFILE=meoh_786.chk
export FCKFILE=meoh_786.fchk
export DNSFILE=meoh_786.d.cube
export ESPFILE=meoh_786.p.cube
