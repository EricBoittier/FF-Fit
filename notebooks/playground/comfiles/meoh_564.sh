...
export INPFILE=meoh_564.com
export OUTFILE=meoh_564.out
export CHKFILE=meoh_564.chk
export FCKFILE=meoh_564.fchk
export DNSFILE=meoh_564.d.cube
export ESPFILE=meoh_564.p.cube
