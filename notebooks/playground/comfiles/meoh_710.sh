...
export INPFILE=meoh_710.com
export OUTFILE=meoh_710.out
export CHKFILE=meoh_710.chk
export FCKFILE=meoh_710.fchk
export DNSFILE=meoh_710.d.cube
export ESPFILE=meoh_710.p.cube
