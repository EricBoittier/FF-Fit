...
export INPFILE=meoh_816.com
export OUTFILE=meoh_816.out
export CHKFILE=meoh_816.chk
export FCKFILE=meoh_816.fchk
export DNSFILE=meoh_816.d.cube
export ESPFILE=meoh_816.p.cube
