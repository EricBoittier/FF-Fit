...
export INPFILE=meoh_752.com
export OUTFILE=meoh_752.out
export CHKFILE=meoh_752.chk
export FCKFILE=meoh_752.fchk
export DNSFILE=meoh_752.d.cube
export ESPFILE=meoh_752.p.cube
