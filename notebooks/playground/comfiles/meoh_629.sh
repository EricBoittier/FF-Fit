...
export INPFILE=meoh_629.com
export OUTFILE=meoh_629.out
export CHKFILE=meoh_629.chk
export FCKFILE=meoh_629.fchk
export DNSFILE=meoh_629.d.cube
export ESPFILE=meoh_629.p.cube
