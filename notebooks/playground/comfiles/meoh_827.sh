...
export INPFILE=meoh_827.com
export OUTFILE=meoh_827.out
export CHKFILE=meoh_827.chk
export FCKFILE=meoh_827.fchk
export DNSFILE=meoh_827.d.cube
export ESPFILE=meoh_827.p.cube
