...
export INPFILE=meoh_26.com
export OUTFILE=meoh_26.out
export CHKFILE=meoh_26.chk
export FCKFILE=meoh_26.fchk
export DNSFILE=meoh_26.d.cube
export ESPFILE=meoh_26.p.cube
