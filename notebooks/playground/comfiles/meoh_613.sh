...
export INPFILE=meoh_613.com
export OUTFILE=meoh_613.out
export CHKFILE=meoh_613.chk
export FCKFILE=meoh_613.fchk
export DNSFILE=meoh_613.d.cube
export ESPFILE=meoh_613.p.cube
