...
export INPFILE=meoh_328.com
export OUTFILE=meoh_328.out
export CHKFILE=meoh_328.chk
export FCKFILE=meoh_328.fchk
export DNSFILE=meoh_328.d.cube
export ESPFILE=meoh_328.p.cube
