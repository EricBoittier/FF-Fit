...
export INPFILE=meoh_442.com
export OUTFILE=meoh_442.out
export CHKFILE=meoh_442.chk
export FCKFILE=meoh_442.fchk
export DNSFILE=meoh_442.d.cube
export ESPFILE=meoh_442.p.cube
