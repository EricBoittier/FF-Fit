...
export INPFILE=meoh_550.com
export OUTFILE=meoh_550.out
export CHKFILE=meoh_550.chk
export FCKFILE=meoh_550.fchk
export DNSFILE=meoh_550.d.cube
export ESPFILE=meoh_550.p.cube
