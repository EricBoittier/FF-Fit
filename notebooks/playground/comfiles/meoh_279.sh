...
export INPFILE=meoh_279.com
export OUTFILE=meoh_279.out
export CHKFILE=meoh_279.chk
export FCKFILE=meoh_279.fchk
export DNSFILE=meoh_279.d.cube
export ESPFILE=meoh_279.p.cube
