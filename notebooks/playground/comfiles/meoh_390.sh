...
export INPFILE=meoh_390.com
export OUTFILE=meoh_390.out
export CHKFILE=meoh_390.chk
export FCKFILE=meoh_390.fchk
export DNSFILE=meoh_390.d.cube
export ESPFILE=meoh_390.p.cube
