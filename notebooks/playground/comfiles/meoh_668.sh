...
export INPFILE=meoh_668.com
export OUTFILE=meoh_668.out
export CHKFILE=meoh_668.chk
export FCKFILE=meoh_668.fchk
export DNSFILE=meoh_668.d.cube
export ESPFILE=meoh_668.p.cube
