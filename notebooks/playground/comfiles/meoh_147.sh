...
export INPFILE=meoh_147.com
export OUTFILE=meoh_147.out
export CHKFILE=meoh_147.chk
export FCKFILE=meoh_147.fchk
export DNSFILE=meoh_147.d.cube
export ESPFILE=meoh_147.p.cube
