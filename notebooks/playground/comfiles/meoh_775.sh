...
export INPFILE=meoh_775.com
export OUTFILE=meoh_775.out
export CHKFILE=meoh_775.chk
export FCKFILE=meoh_775.fchk
export DNSFILE=meoh_775.d.cube
export ESPFILE=meoh_775.p.cube
