...
export INPFILE=meoh_848.com
export OUTFILE=meoh_848.out
export CHKFILE=meoh_848.chk
export FCKFILE=meoh_848.fchk
export DNSFILE=meoh_848.d.cube
export ESPFILE=meoh_848.p.cube
