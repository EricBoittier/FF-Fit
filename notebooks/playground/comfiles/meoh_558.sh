...
export INPFILE=meoh_558.com
export OUTFILE=meoh_558.out
export CHKFILE=meoh_558.chk
export FCKFILE=meoh_558.fchk
export DNSFILE=meoh_558.d.cube
export ESPFILE=meoh_558.p.cube
