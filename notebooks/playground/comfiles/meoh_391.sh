...
export INPFILE=meoh_391.com
export OUTFILE=meoh_391.out
export CHKFILE=meoh_391.chk
export FCKFILE=meoh_391.fchk
export DNSFILE=meoh_391.d.cube
export ESPFILE=meoh_391.p.cube
