...
export INPFILE=meoh_272.com
export OUTFILE=meoh_272.out
export CHKFILE=meoh_272.chk
export FCKFILE=meoh_272.fchk
export DNSFILE=meoh_272.d.cube
export ESPFILE=meoh_272.p.cube
