...
export INPFILE=meoh_116.com
export OUTFILE=meoh_116.out
export CHKFILE=meoh_116.chk
export FCKFILE=meoh_116.fchk
export DNSFILE=meoh_116.d.cube
export ESPFILE=meoh_116.p.cube
