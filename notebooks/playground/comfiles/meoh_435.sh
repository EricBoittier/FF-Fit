...
export INPFILE=meoh_435.com
export OUTFILE=meoh_435.out
export CHKFILE=meoh_435.chk
export FCKFILE=meoh_435.fchk
export DNSFILE=meoh_435.d.cube
export ESPFILE=meoh_435.p.cube
