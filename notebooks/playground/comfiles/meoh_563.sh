...
export INPFILE=meoh_563.com
export OUTFILE=meoh_563.out
export CHKFILE=meoh_563.chk
export FCKFILE=meoh_563.fchk
export DNSFILE=meoh_563.d.cube
export ESPFILE=meoh_563.p.cube
