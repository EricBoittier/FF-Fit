...
export INPFILE=meoh_600.com
export OUTFILE=meoh_600.out
export CHKFILE=meoh_600.chk
export FCKFILE=meoh_600.fchk
export DNSFILE=meoh_600.d.cube
export ESPFILE=meoh_600.p.cube
