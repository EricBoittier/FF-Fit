...
export INPFILE=meoh_308.com
export OUTFILE=meoh_308.out
export CHKFILE=meoh_308.chk
export FCKFILE=meoh_308.fchk
export DNSFILE=meoh_308.d.cube
export ESPFILE=meoh_308.p.cube
