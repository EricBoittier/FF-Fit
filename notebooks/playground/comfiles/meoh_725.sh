...
export INPFILE=meoh_725.com
export OUTFILE=meoh_725.out
export CHKFILE=meoh_725.chk
export FCKFILE=meoh_725.fchk
export DNSFILE=meoh_725.d.cube
export ESPFILE=meoh_725.p.cube
