...
export INPFILE=meoh_666.com
export OUTFILE=meoh_666.out
export CHKFILE=meoh_666.chk
export FCKFILE=meoh_666.fchk
export DNSFILE=meoh_666.d.cube
export ESPFILE=meoh_666.p.cube
