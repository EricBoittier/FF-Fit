...
export INPFILE=meoh_603.com
export OUTFILE=meoh_603.out
export CHKFILE=meoh_603.chk
export FCKFILE=meoh_603.fchk
export DNSFILE=meoh_603.d.cube
export ESPFILE=meoh_603.p.cube
