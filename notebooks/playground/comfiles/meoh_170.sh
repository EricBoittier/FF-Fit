...
export INPFILE=meoh_170.com
export OUTFILE=meoh_170.out
export CHKFILE=meoh_170.chk
export FCKFILE=meoh_170.fchk
export DNSFILE=meoh_170.d.cube
export ESPFILE=meoh_170.p.cube
