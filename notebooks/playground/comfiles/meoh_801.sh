...
export INPFILE=meoh_801.com
export OUTFILE=meoh_801.out
export CHKFILE=meoh_801.chk
export FCKFILE=meoh_801.fchk
export DNSFILE=meoh_801.d.cube
export ESPFILE=meoh_801.p.cube
