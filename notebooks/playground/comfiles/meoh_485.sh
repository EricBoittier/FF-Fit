...
export INPFILE=meoh_485.com
export OUTFILE=meoh_485.out
export CHKFILE=meoh_485.chk
export FCKFILE=meoh_485.fchk
export DNSFILE=meoh_485.d.cube
export ESPFILE=meoh_485.p.cube
