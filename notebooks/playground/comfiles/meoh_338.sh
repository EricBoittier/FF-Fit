...
export INPFILE=meoh_338.com
export OUTFILE=meoh_338.out
export CHKFILE=meoh_338.chk
export FCKFILE=meoh_338.fchk
export DNSFILE=meoh_338.d.cube
export ESPFILE=meoh_338.p.cube
