...
export INPFILE=meoh_402.com
export OUTFILE=meoh_402.out
export CHKFILE=meoh_402.chk
export FCKFILE=meoh_402.fchk
export DNSFILE=meoh_402.d.cube
export ESPFILE=meoh_402.p.cube
