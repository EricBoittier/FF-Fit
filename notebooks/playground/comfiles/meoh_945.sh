...
export INPFILE=meoh_945.com
export OUTFILE=meoh_945.out
export CHKFILE=meoh_945.chk
export FCKFILE=meoh_945.fchk
export DNSFILE=meoh_945.d.cube
export ESPFILE=meoh_945.p.cube
