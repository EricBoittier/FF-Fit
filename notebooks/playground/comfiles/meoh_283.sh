...
export INPFILE=meoh_283.com
export OUTFILE=meoh_283.out
export CHKFILE=meoh_283.chk
export FCKFILE=meoh_283.fchk
export DNSFILE=meoh_283.d.cube
export ESPFILE=meoh_283.p.cube
