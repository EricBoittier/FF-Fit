...
export INPFILE=meoh_215.com
export OUTFILE=meoh_215.out
export CHKFILE=meoh_215.chk
export FCKFILE=meoh_215.fchk
export DNSFILE=meoh_215.d.cube
export ESPFILE=meoh_215.p.cube
