...
export INPFILE=meoh_769.com
export OUTFILE=meoh_769.out
export CHKFILE=meoh_769.chk
export FCKFILE=meoh_769.fchk
export DNSFILE=meoh_769.d.cube
export ESPFILE=meoh_769.p.cube
