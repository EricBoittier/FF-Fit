...
export INPFILE=meoh_145.com
export OUTFILE=meoh_145.out
export CHKFILE=meoh_145.chk
export FCKFILE=meoh_145.fchk
export DNSFILE=meoh_145.d.cube
export ESPFILE=meoh_145.p.cube
