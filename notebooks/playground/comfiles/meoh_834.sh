...
export INPFILE=meoh_834.com
export OUTFILE=meoh_834.out
export CHKFILE=meoh_834.chk
export FCKFILE=meoh_834.fchk
export DNSFILE=meoh_834.d.cube
export ESPFILE=meoh_834.p.cube
