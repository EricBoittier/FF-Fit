...
export INPFILE=meoh_13.com
export OUTFILE=meoh_13.out
export CHKFILE=meoh_13.chk
export FCKFILE=meoh_13.fchk
export DNSFILE=meoh_13.d.cube
export ESPFILE=meoh_13.p.cube
