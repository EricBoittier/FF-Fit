...
export INPFILE=meoh_985.com
export OUTFILE=meoh_985.out
export CHKFILE=meoh_985.chk
export FCKFILE=meoh_985.fchk
export DNSFILE=meoh_985.d.cube
export ESPFILE=meoh_985.p.cube
