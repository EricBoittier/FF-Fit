...
export INPFILE=meoh_943.com
export OUTFILE=meoh_943.out
export CHKFILE=meoh_943.chk
export FCKFILE=meoh_943.fchk
export DNSFILE=meoh_943.d.cube
export ESPFILE=meoh_943.p.cube
