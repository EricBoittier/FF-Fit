...
export INPFILE=meoh_764.com
export OUTFILE=meoh_764.out
export CHKFILE=meoh_764.chk
export FCKFILE=meoh_764.fchk
export DNSFILE=meoh_764.d.cube
export ESPFILE=meoh_764.p.cube
