...
export INPFILE=meoh_359.com
export OUTFILE=meoh_359.out
export CHKFILE=meoh_359.chk
export FCKFILE=meoh_359.fchk
export DNSFILE=meoh_359.d.cube
export ESPFILE=meoh_359.p.cube
