...
export INPFILE=meoh_89.com
export OUTFILE=meoh_89.out
export CHKFILE=meoh_89.chk
export FCKFILE=meoh_89.fchk
export DNSFILE=meoh_89.d.cube
export ESPFILE=meoh_89.p.cube
