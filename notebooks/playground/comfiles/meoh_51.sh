...
export INPFILE=meoh_51.com
export OUTFILE=meoh_51.out
export CHKFILE=meoh_51.chk
export FCKFILE=meoh_51.fchk
export DNSFILE=meoh_51.d.cube
export ESPFILE=meoh_51.p.cube
