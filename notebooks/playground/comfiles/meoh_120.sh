...
export INPFILE=meoh_120.com
export OUTFILE=meoh_120.out
export CHKFILE=meoh_120.chk
export FCKFILE=meoh_120.fchk
export DNSFILE=meoh_120.d.cube
export ESPFILE=meoh_120.p.cube
