...
export INPFILE=meoh_299.com
export OUTFILE=meoh_299.out
export CHKFILE=meoh_299.chk
export FCKFILE=meoh_299.fchk
export DNSFILE=meoh_299.d.cube
export ESPFILE=meoh_299.p.cube
