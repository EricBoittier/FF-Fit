...
export INPFILE=meoh_483.com
export OUTFILE=meoh_483.out
export CHKFILE=meoh_483.chk
export FCKFILE=meoh_483.fchk
export DNSFILE=meoh_483.d.cube
export ESPFILE=meoh_483.p.cube
