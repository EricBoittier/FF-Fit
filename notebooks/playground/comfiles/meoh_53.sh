...
export INPFILE=meoh_53.com
export OUTFILE=meoh_53.out
export CHKFILE=meoh_53.chk
export FCKFILE=meoh_53.fchk
export DNSFILE=meoh_53.d.cube
export ESPFILE=meoh_53.p.cube
