...
export INPFILE=meoh_680.com
export OUTFILE=meoh_680.out
export CHKFILE=meoh_680.chk
export FCKFILE=meoh_680.fchk
export DNSFILE=meoh_680.d.cube
export ESPFILE=meoh_680.p.cube
