...
export INPFILE=meoh_938.com
export OUTFILE=meoh_938.out
export CHKFILE=meoh_938.chk
export FCKFILE=meoh_938.fchk
export DNSFILE=meoh_938.d.cube
export ESPFILE=meoh_938.p.cube
