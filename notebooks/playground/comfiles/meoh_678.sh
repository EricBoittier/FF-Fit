...
export INPFILE=meoh_678.com
export OUTFILE=meoh_678.out
export CHKFILE=meoh_678.chk
export FCKFILE=meoh_678.fchk
export DNSFILE=meoh_678.d.cube
export ESPFILE=meoh_678.p.cube
