...
export INPFILE=meoh_649.com
export OUTFILE=meoh_649.out
export CHKFILE=meoh_649.chk
export FCKFILE=meoh_649.fchk
export DNSFILE=meoh_649.d.cube
export ESPFILE=meoh_649.p.cube
