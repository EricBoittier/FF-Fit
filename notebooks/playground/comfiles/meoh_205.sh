...
export INPFILE=meoh_205.com
export OUTFILE=meoh_205.out
export CHKFILE=meoh_205.chk
export FCKFILE=meoh_205.fchk
export DNSFILE=meoh_205.d.cube
export ESPFILE=meoh_205.p.cube
