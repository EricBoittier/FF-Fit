...
export INPFILE=meoh_306.com
export OUTFILE=meoh_306.out
export CHKFILE=meoh_306.chk
export FCKFILE=meoh_306.fchk
export DNSFILE=meoh_306.d.cube
export ESPFILE=meoh_306.p.cube
