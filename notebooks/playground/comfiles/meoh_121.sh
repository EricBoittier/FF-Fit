...
export INPFILE=meoh_121.com
export OUTFILE=meoh_121.out
export CHKFILE=meoh_121.chk
export FCKFILE=meoh_121.fchk
export DNSFILE=meoh_121.d.cube
export ESPFILE=meoh_121.p.cube
