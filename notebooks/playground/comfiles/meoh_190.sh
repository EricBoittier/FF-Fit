...
export INPFILE=meoh_190.com
export OUTFILE=meoh_190.out
export CHKFILE=meoh_190.chk
export FCKFILE=meoh_190.fchk
export DNSFILE=meoh_190.d.cube
export ESPFILE=meoh_190.p.cube
