...
export INPFILE=meoh_81.com
export OUTFILE=meoh_81.out
export CHKFILE=meoh_81.chk
export FCKFILE=meoh_81.fchk
export DNSFILE=meoh_81.d.cube
export ESPFILE=meoh_81.p.cube
