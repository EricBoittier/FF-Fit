...
export INPFILE=meoh_623.com
export OUTFILE=meoh_623.out
export CHKFILE=meoh_623.chk
export FCKFILE=meoh_623.fchk
export DNSFILE=meoh_623.d.cube
export ESPFILE=meoh_623.p.cube
