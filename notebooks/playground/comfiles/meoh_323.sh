...
export INPFILE=meoh_323.com
export OUTFILE=meoh_323.out
export CHKFILE=meoh_323.chk
export FCKFILE=meoh_323.fchk
export DNSFILE=meoh_323.d.cube
export ESPFILE=meoh_323.p.cube
