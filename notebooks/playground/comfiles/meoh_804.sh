...
export INPFILE=meoh_804.com
export OUTFILE=meoh_804.out
export CHKFILE=meoh_804.chk
export FCKFILE=meoh_804.fchk
export DNSFILE=meoh_804.d.cube
export ESPFILE=meoh_804.p.cube
