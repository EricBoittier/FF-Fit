...
export INPFILE=meoh_957.com
export OUTFILE=meoh_957.out
export CHKFILE=meoh_957.chk
export FCKFILE=meoh_957.fchk
export DNSFILE=meoh_957.d.cube
export ESPFILE=meoh_957.p.cube
