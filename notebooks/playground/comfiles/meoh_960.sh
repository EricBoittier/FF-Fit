...
export INPFILE=meoh_960.com
export OUTFILE=meoh_960.out
export CHKFILE=meoh_960.chk
export FCKFILE=meoh_960.fchk
export DNSFILE=meoh_960.d.cube
export ESPFILE=meoh_960.p.cube
