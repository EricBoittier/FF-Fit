...
export INPFILE=meoh_782.com
export OUTFILE=meoh_782.out
export CHKFILE=meoh_782.chk
export FCKFILE=meoh_782.fchk
export DNSFILE=meoh_782.d.cube
export ESPFILE=meoh_782.p.cube
