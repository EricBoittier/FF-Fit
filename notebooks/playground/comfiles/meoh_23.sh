...
export INPFILE=meoh_23.com
export OUTFILE=meoh_23.out
export CHKFILE=meoh_23.chk
export FCKFILE=meoh_23.fchk
export DNSFILE=meoh_23.d.cube
export ESPFILE=meoh_23.p.cube
