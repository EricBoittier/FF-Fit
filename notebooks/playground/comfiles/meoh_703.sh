...
export INPFILE=meoh_703.com
export OUTFILE=meoh_703.out
export CHKFILE=meoh_703.chk
export FCKFILE=meoh_703.fchk
export DNSFILE=meoh_703.d.cube
export ESPFILE=meoh_703.p.cube
