...
export INPFILE=meoh_667.com
export OUTFILE=meoh_667.out
export CHKFILE=meoh_667.chk
export FCKFILE=meoh_667.fchk
export DNSFILE=meoh_667.d.cube
export ESPFILE=meoh_667.p.cube
