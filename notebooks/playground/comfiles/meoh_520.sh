...
export INPFILE=meoh_520.com
export OUTFILE=meoh_520.out
export CHKFILE=meoh_520.chk
export FCKFILE=meoh_520.fchk
export DNSFILE=meoh_520.d.cube
export ESPFILE=meoh_520.p.cube
