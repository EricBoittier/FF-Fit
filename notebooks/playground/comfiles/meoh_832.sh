...
export INPFILE=meoh_832.com
export OUTFILE=meoh_832.out
export CHKFILE=meoh_832.chk
export FCKFILE=meoh_832.fchk
export DNSFILE=meoh_832.d.cube
export ESPFILE=meoh_832.p.cube
