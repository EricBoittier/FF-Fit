...
export INPFILE=meoh_237.com
export OUTFILE=meoh_237.out
export CHKFILE=meoh_237.chk
export FCKFILE=meoh_237.fchk
export DNSFILE=meoh_237.d.cube
export ESPFILE=meoh_237.p.cube
