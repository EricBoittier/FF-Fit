...
export INPFILE=meoh_537.com
export OUTFILE=meoh_537.out
export CHKFILE=meoh_537.chk
export FCKFILE=meoh_537.fchk
export DNSFILE=meoh_537.d.cube
export ESPFILE=meoh_537.p.cube
