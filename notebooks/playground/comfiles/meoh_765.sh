...
export INPFILE=meoh_765.com
export OUTFILE=meoh_765.out
export CHKFILE=meoh_765.chk
export FCKFILE=meoh_765.fchk
export DNSFILE=meoh_765.d.cube
export ESPFILE=meoh_765.p.cube
