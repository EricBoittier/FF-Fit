...
export INPFILE=meoh_316.com
export OUTFILE=meoh_316.out
export CHKFILE=meoh_316.chk
export FCKFILE=meoh_316.fchk
export DNSFILE=meoh_316.d.cube
export ESPFILE=meoh_316.p.cube
