...
export INPFILE=meoh_803.com
export OUTFILE=meoh_803.out
export CHKFILE=meoh_803.chk
export FCKFILE=meoh_803.fchk
export DNSFILE=meoh_803.d.cube
export ESPFILE=meoh_803.p.cube
