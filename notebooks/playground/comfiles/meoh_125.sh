...
export INPFILE=meoh_125.com
export OUTFILE=meoh_125.out
export CHKFILE=meoh_125.chk
export FCKFILE=meoh_125.fchk
export DNSFILE=meoh_125.d.cube
export ESPFILE=meoh_125.p.cube
