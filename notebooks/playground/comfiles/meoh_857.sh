...
export INPFILE=meoh_857.com
export OUTFILE=meoh_857.out
export CHKFILE=meoh_857.chk
export FCKFILE=meoh_857.fchk
export DNSFILE=meoh_857.d.cube
export ESPFILE=meoh_857.p.cube
