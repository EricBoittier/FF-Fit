...
export INPFILE=meoh_19.com
export OUTFILE=meoh_19.out
export CHKFILE=meoh_19.chk
export FCKFILE=meoh_19.fchk
export DNSFILE=meoh_19.d.cube
export ESPFILE=meoh_19.p.cube
