...
export INPFILE=meoh_560.com
export OUTFILE=meoh_560.out
export CHKFILE=meoh_560.chk
export FCKFILE=meoh_560.fchk
export DNSFILE=meoh_560.d.cube
export ESPFILE=meoh_560.p.cube
