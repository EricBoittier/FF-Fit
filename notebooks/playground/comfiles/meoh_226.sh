...
export INPFILE=meoh_226.com
export OUTFILE=meoh_226.out
export CHKFILE=meoh_226.chk
export FCKFILE=meoh_226.fchk
export DNSFILE=meoh_226.d.cube
export ESPFILE=meoh_226.p.cube
