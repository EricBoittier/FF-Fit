...
export INPFILE=meoh_568.com
export OUTFILE=meoh_568.out
export CHKFILE=meoh_568.chk
export FCKFILE=meoh_568.fchk
export DNSFILE=meoh_568.d.cube
export ESPFILE=meoh_568.p.cube
