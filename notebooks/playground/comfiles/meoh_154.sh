...
export INPFILE=meoh_154.com
export OUTFILE=meoh_154.out
export CHKFILE=meoh_154.chk
export FCKFILE=meoh_154.fchk
export DNSFILE=meoh_154.d.cube
export ESPFILE=meoh_154.p.cube
