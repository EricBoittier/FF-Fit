...
export INPFILE=meoh_556.com
export OUTFILE=meoh_556.out
export CHKFILE=meoh_556.chk
export FCKFILE=meoh_556.fchk
export DNSFILE=meoh_556.d.cube
export ESPFILE=meoh_556.p.cube
