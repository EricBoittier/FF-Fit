...
export INPFILE=meoh_436.com
export OUTFILE=meoh_436.out
export CHKFILE=meoh_436.chk
export FCKFILE=meoh_436.fchk
export DNSFILE=meoh_436.d.cube
export ESPFILE=meoh_436.p.cube
