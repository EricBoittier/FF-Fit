...
export INPFILE=meoh_184.com
export OUTFILE=meoh_184.out
export CHKFILE=meoh_184.chk
export FCKFILE=meoh_184.fchk
export DNSFILE=meoh_184.d.cube
export ESPFILE=meoh_184.p.cube
