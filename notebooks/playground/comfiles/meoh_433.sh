...
export INPFILE=meoh_433.com
export OUTFILE=meoh_433.out
export CHKFILE=meoh_433.chk
export FCKFILE=meoh_433.fchk
export DNSFILE=meoh_433.d.cube
export ESPFILE=meoh_433.p.cube
