...
export INPFILE=meoh_918.com
export OUTFILE=meoh_918.out
export CHKFILE=meoh_918.chk
export FCKFILE=meoh_918.fchk
export DNSFILE=meoh_918.d.cube
export ESPFILE=meoh_918.p.cube
