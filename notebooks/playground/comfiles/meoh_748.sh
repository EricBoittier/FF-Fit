...
export INPFILE=meoh_748.com
export OUTFILE=meoh_748.out
export CHKFILE=meoh_748.chk
export FCKFILE=meoh_748.fchk
export DNSFILE=meoh_748.d.cube
export ESPFILE=meoh_748.p.cube
