...
export INPFILE=meoh_35.com
export OUTFILE=meoh_35.out
export CHKFILE=meoh_35.chk
export FCKFILE=meoh_35.fchk
export DNSFILE=meoh_35.d.cube
export ESPFILE=meoh_35.p.cube
