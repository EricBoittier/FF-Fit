...
export INPFILE=meoh_882.com
export OUTFILE=meoh_882.out
export CHKFILE=meoh_882.chk
export FCKFILE=meoh_882.fchk
export DNSFILE=meoh_882.d.cube
export ESPFILE=meoh_882.p.cube
