...
export INPFILE=meoh_577.com
export OUTFILE=meoh_577.out
export CHKFILE=meoh_577.chk
export FCKFILE=meoh_577.fchk
export DNSFILE=meoh_577.d.cube
export ESPFILE=meoh_577.p.cube
