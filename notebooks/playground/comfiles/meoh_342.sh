...
export INPFILE=meoh_342.com
export OUTFILE=meoh_342.out
export CHKFILE=meoh_342.chk
export FCKFILE=meoh_342.fchk
export DNSFILE=meoh_342.d.cube
export ESPFILE=meoh_342.p.cube
