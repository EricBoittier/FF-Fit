...
export INPFILE=meoh_846.com
export OUTFILE=meoh_846.out
export CHKFILE=meoh_846.chk
export FCKFILE=meoh_846.fchk
export DNSFILE=meoh_846.d.cube
export ESPFILE=meoh_846.p.cube
