...
export INPFILE=meoh_939.com
export OUTFILE=meoh_939.out
export CHKFILE=meoh_939.chk
export FCKFILE=meoh_939.fchk
export DNSFILE=meoh_939.d.cube
export ESPFILE=meoh_939.p.cube
