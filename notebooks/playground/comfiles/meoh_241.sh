...
export INPFILE=meoh_241.com
export OUTFILE=meoh_241.out
export CHKFILE=meoh_241.chk
export FCKFILE=meoh_241.fchk
export DNSFILE=meoh_241.d.cube
export ESPFILE=meoh_241.p.cube
