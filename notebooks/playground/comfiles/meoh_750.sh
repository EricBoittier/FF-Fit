...
export INPFILE=meoh_750.com
export OUTFILE=meoh_750.out
export CHKFILE=meoh_750.chk
export FCKFILE=meoh_750.fchk
export DNSFILE=meoh_750.d.cube
export ESPFILE=meoh_750.p.cube
