...
export INPFILE=meoh_214.com
export OUTFILE=meoh_214.out
export CHKFILE=meoh_214.chk
export FCKFILE=meoh_214.fchk
export DNSFILE=meoh_214.d.cube
export ESPFILE=meoh_214.p.cube
