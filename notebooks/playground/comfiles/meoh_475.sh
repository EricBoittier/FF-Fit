...
export INPFILE=meoh_475.com
export OUTFILE=meoh_475.out
export CHKFILE=meoh_475.chk
export FCKFILE=meoh_475.fchk
export DNSFILE=meoh_475.d.cube
export ESPFILE=meoh_475.p.cube
