...
export INPFILE=meoh_602.com
export OUTFILE=meoh_602.out
export CHKFILE=meoh_602.chk
export FCKFILE=meoh_602.fchk
export DNSFILE=meoh_602.d.cube
export ESPFILE=meoh_602.p.cube
