...
export INPFILE=meoh_28.com
export OUTFILE=meoh_28.out
export CHKFILE=meoh_28.chk
export FCKFILE=meoh_28.fchk
export DNSFILE=meoh_28.d.cube
export ESPFILE=meoh_28.p.cube
