...
export INPFILE=meoh_39.com
export OUTFILE=meoh_39.out
export CHKFILE=meoh_39.chk
export FCKFILE=meoh_39.fchk
export DNSFILE=meoh_39.d.cube
export ESPFILE=meoh_39.p.cube
