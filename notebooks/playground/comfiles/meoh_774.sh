...
export INPFILE=meoh_774.com
export OUTFILE=meoh_774.out
export CHKFILE=meoh_774.chk
export FCKFILE=meoh_774.fchk
export DNSFILE=meoh_774.d.cube
export ESPFILE=meoh_774.p.cube
