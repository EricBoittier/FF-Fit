...
export INPFILE=meoh_196.com
export OUTFILE=meoh_196.out
export CHKFILE=meoh_196.chk
export FCKFILE=meoh_196.fchk
export DNSFILE=meoh_196.d.cube
export ESPFILE=meoh_196.p.cube
