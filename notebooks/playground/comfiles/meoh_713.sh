...
export INPFILE=meoh_713.com
export OUTFILE=meoh_713.out
export CHKFILE=meoh_713.chk
export FCKFILE=meoh_713.fchk
export DNSFILE=meoh_713.d.cube
export ESPFILE=meoh_713.p.cube
