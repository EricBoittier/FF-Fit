...
export INPFILE=meoh_137.com
export OUTFILE=meoh_137.out
export CHKFILE=meoh_137.chk
export FCKFILE=meoh_137.fchk
export DNSFILE=meoh_137.d.cube
export ESPFILE=meoh_137.p.cube
