...
export INPFILE=meoh_173.com
export OUTFILE=meoh_173.out
export CHKFILE=meoh_173.chk
export FCKFILE=meoh_173.fchk
export DNSFILE=meoh_173.d.cube
export ESPFILE=meoh_173.p.cube
