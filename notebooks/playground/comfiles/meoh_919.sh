...
export INPFILE=meoh_919.com
export OUTFILE=meoh_919.out
export CHKFILE=meoh_919.chk
export FCKFILE=meoh_919.fchk
export DNSFILE=meoh_919.d.cube
export ESPFILE=meoh_919.p.cube
