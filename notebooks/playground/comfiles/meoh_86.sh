...
export INPFILE=meoh_86.com
export OUTFILE=meoh_86.out
export CHKFILE=meoh_86.chk
export FCKFILE=meoh_86.fchk
export DNSFILE=meoh_86.d.cube
export ESPFILE=meoh_86.p.cube
