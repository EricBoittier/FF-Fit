...
export INPFILE=meoh_139.com
export OUTFILE=meoh_139.out
export CHKFILE=meoh_139.chk
export FCKFILE=meoh_139.fchk
export DNSFILE=meoh_139.d.cube
export ESPFILE=meoh_139.p.cube
