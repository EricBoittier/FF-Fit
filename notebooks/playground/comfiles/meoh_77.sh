...
export INPFILE=meoh_77.com
export OUTFILE=meoh_77.out
export CHKFILE=meoh_77.chk
export FCKFILE=meoh_77.fchk
export DNSFILE=meoh_77.d.cube
export ESPFILE=meoh_77.p.cube
