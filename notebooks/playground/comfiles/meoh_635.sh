...
export INPFILE=meoh_635.com
export OUTFILE=meoh_635.out
export CHKFILE=meoh_635.chk
export FCKFILE=meoh_635.fchk
export DNSFILE=meoh_635.d.cube
export ESPFILE=meoh_635.p.cube
