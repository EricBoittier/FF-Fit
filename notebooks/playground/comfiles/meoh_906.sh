...
export INPFILE=meoh_906.com
export OUTFILE=meoh_906.out
export CHKFILE=meoh_906.chk
export FCKFILE=meoh_906.fchk
export DNSFILE=meoh_906.d.cube
export ESPFILE=meoh_906.p.cube
