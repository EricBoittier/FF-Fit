...
export INPFILE=meoh_506.com
export OUTFILE=meoh_506.out
export CHKFILE=meoh_506.chk
export FCKFILE=meoh_506.fchk
export DNSFILE=meoh_506.d.cube
export ESPFILE=meoh_506.p.cube
