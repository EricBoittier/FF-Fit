...
export INPFILE=meoh_78.com
export OUTFILE=meoh_78.out
export CHKFILE=meoh_78.chk
export FCKFILE=meoh_78.fchk
export DNSFILE=meoh_78.d.cube
export ESPFILE=meoh_78.p.cube
