...
export INPFILE=meoh_953.com
export OUTFILE=meoh_953.out
export CHKFILE=meoh_953.chk
export FCKFILE=meoh_953.fchk
export DNSFILE=meoh_953.d.cube
export ESPFILE=meoh_953.p.cube
