...
export INPFILE=meoh_395.com
export OUTFILE=meoh_395.out
export CHKFILE=meoh_395.chk
export FCKFILE=meoh_395.fchk
export DNSFILE=meoh_395.d.cube
export ESPFILE=meoh_395.p.cube
