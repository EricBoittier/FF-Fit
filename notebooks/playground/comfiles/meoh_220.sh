...
export INPFILE=meoh_220.com
export OUTFILE=meoh_220.out
export CHKFILE=meoh_220.chk
export FCKFILE=meoh_220.fchk
export DNSFILE=meoh_220.d.cube
export ESPFILE=meoh_220.p.cube
