...
export INPFILE=meoh_344.com
export OUTFILE=meoh_344.out
export CHKFILE=meoh_344.chk
export FCKFILE=meoh_344.fchk
export DNSFILE=meoh_344.d.cube
export ESPFILE=meoh_344.p.cube
