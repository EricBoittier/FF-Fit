...
export INPFILE=meoh_491.com
export OUTFILE=meoh_491.out
export CHKFILE=meoh_491.chk
export FCKFILE=meoh_491.fchk
export DNSFILE=meoh_491.d.cube
export ESPFILE=meoh_491.p.cube
