...
export INPFILE=meoh_25.com
export OUTFILE=meoh_25.out
export CHKFILE=meoh_25.chk
export FCKFILE=meoh_25.fchk
export DNSFILE=meoh_25.d.cube
export ESPFILE=meoh_25.p.cube
