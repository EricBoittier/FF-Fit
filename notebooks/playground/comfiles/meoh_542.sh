...
export INPFILE=meoh_542.com
export OUTFILE=meoh_542.out
export CHKFILE=meoh_542.chk
export FCKFILE=meoh_542.fchk
export DNSFILE=meoh_542.d.cube
export ESPFILE=meoh_542.p.cube
