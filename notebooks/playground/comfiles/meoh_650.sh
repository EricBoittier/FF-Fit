...
export INPFILE=meoh_650.com
export OUTFILE=meoh_650.out
export CHKFILE=meoh_650.chk
export FCKFILE=meoh_650.fchk
export DNSFILE=meoh_650.d.cube
export ESPFILE=meoh_650.p.cube
