...
export INPFILE=meoh_559.com
export OUTFILE=meoh_559.out
export CHKFILE=meoh_559.chk
export FCKFILE=meoh_559.fchk
export DNSFILE=meoh_559.d.cube
export ESPFILE=meoh_559.p.cube
