...
export INPFILE=meoh_582.com
export OUTFILE=meoh_582.out
export CHKFILE=meoh_582.chk
export FCKFILE=meoh_582.fchk
export DNSFILE=meoh_582.d.cube
export ESPFILE=meoh_582.p.cube
