...
export INPFILE=meoh_377.com
export OUTFILE=meoh_377.out
export CHKFILE=meoh_377.chk
export FCKFILE=meoh_377.fchk
export DNSFILE=meoh_377.d.cube
export ESPFILE=meoh_377.p.cube
