...
export INPFILE=meoh_309.com
export OUTFILE=meoh_309.out
export CHKFILE=meoh_309.chk
export FCKFILE=meoh_309.fchk
export DNSFILE=meoh_309.d.cube
export ESPFILE=meoh_309.p.cube
