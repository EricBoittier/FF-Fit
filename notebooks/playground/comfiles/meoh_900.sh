...
export INPFILE=meoh_900.com
export OUTFILE=meoh_900.out
export CHKFILE=meoh_900.chk
export FCKFILE=meoh_900.fchk
export DNSFILE=meoh_900.d.cube
export ESPFILE=meoh_900.p.cube
