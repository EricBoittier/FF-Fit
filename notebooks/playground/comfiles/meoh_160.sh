...
export INPFILE=meoh_160.com
export OUTFILE=meoh_160.out
export CHKFILE=meoh_160.chk
export FCKFILE=meoh_160.fchk
export DNSFILE=meoh_160.d.cube
export ESPFILE=meoh_160.p.cube
