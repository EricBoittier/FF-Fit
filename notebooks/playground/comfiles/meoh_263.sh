...
export INPFILE=meoh_263.com
export OUTFILE=meoh_263.out
export CHKFILE=meoh_263.chk
export FCKFILE=meoh_263.fchk
export DNSFILE=meoh_263.d.cube
export ESPFILE=meoh_263.p.cube
