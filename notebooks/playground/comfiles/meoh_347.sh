...
export INPFILE=meoh_347.com
export OUTFILE=meoh_347.out
export CHKFILE=meoh_347.chk
export FCKFILE=meoh_347.fchk
export DNSFILE=meoh_347.d.cube
export ESPFILE=meoh_347.p.cube
