...
export INPFILE=meoh_275.com
export OUTFILE=meoh_275.out
export CHKFILE=meoh_275.chk
export FCKFILE=meoh_275.fchk
export DNSFILE=meoh_275.d.cube
export ESPFILE=meoh_275.p.cube
