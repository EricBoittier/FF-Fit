...
export INPFILE=meoh_307.com
export OUTFILE=meoh_307.out
export CHKFILE=meoh_307.chk
export FCKFILE=meoh_307.fchk
export DNSFILE=meoh_307.d.cube
export ESPFILE=meoh_307.p.cube
