...
export INPFILE=meoh_479.com
export OUTFILE=meoh_479.out
export CHKFILE=meoh_479.chk
export FCKFILE=meoh_479.fchk
export DNSFILE=meoh_479.d.cube
export ESPFILE=meoh_479.p.cube
