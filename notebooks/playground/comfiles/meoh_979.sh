...
export INPFILE=meoh_979.com
export OUTFILE=meoh_979.out
export CHKFILE=meoh_979.chk
export FCKFILE=meoh_979.fchk
export DNSFILE=meoh_979.d.cube
export ESPFILE=meoh_979.p.cube
