...
export INPFILE=meoh_509.com
export OUTFILE=meoh_509.out
export CHKFILE=meoh_509.chk
export FCKFILE=meoh_509.fchk
export DNSFILE=meoh_509.d.cube
export ESPFILE=meoh_509.p.cube
