...
export INPFILE=meoh_369.com
export OUTFILE=meoh_369.out
export CHKFILE=meoh_369.chk
export FCKFILE=meoh_369.fchk
export DNSFILE=meoh_369.d.cube
export ESPFILE=meoh_369.p.cube
