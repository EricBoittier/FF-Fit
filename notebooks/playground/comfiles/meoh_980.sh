...
export INPFILE=meoh_980.com
export OUTFILE=meoh_980.out
export CHKFILE=meoh_980.chk
export FCKFILE=meoh_980.fchk
export DNSFILE=meoh_980.d.cube
export ESPFILE=meoh_980.p.cube
