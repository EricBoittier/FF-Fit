...
export INPFILE=meoh_647.com
export OUTFILE=meoh_647.out
export CHKFILE=meoh_647.chk
export FCKFILE=meoh_647.fchk
export DNSFILE=meoh_647.d.cube
export ESPFILE=meoh_647.p.cube
