...
export INPFILE=meoh_322.com
export OUTFILE=meoh_322.out
export CHKFILE=meoh_322.chk
export FCKFILE=meoh_322.fchk
export DNSFILE=meoh_322.d.cube
export ESPFILE=meoh_322.p.cube
