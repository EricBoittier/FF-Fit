...
export INPFILE=meoh_986.com
export OUTFILE=meoh_986.out
export CHKFILE=meoh_986.chk
export FCKFILE=meoh_986.fchk
export DNSFILE=meoh_986.d.cube
export ESPFILE=meoh_986.p.cube
