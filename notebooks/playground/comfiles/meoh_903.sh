...
export INPFILE=meoh_903.com
export OUTFILE=meoh_903.out
export CHKFILE=meoh_903.chk
export FCKFILE=meoh_903.fchk
export DNSFILE=meoh_903.d.cube
export ESPFILE=meoh_903.p.cube
