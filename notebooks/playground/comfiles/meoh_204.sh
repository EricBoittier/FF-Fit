...
export INPFILE=meoh_204.com
export OUTFILE=meoh_204.out
export CHKFILE=meoh_204.chk
export FCKFILE=meoh_204.fchk
export DNSFILE=meoh_204.d.cube
export ESPFILE=meoh_204.p.cube
